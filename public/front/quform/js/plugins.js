...
(function ($) {
    var Quform = function ($form, options) {
        ...
        self.errorMessage = function (html, showTitle) {
            ...
            if (showTitle !== false) {
                $message.append(
                    $('<div class="quform-error-title"/>').html(
                        options.errorTitle
                    )
                );
            }
        ...
        self.scrollTo = function ($target) {
            if (
                ...
                $target.length &&
                $(window).scrollTop() >=
                    $target.offset().top - options.scrollThreshold
            ) {
        ...
        self.submit = function () {
            ...
            if (window.grecaptcha) {
                ...
                if (
                    $recaptcha.length &&
                    $recaptcha.data("size") === "invisible"
                ) {
                    if ($recaptcha.data("version") === "v3") {
                        grecaptcha
                            .execute($recaptcha.data("recaptcha-id"), {
                                action: "quform",
                            })
                            .then(function (token) {
                                $recaptcha
                    ...
                    if (response === null || typeof response === "undefined") {
                        ...
                        if (response.type === "success") {
                            ...
                            if (typeof options.success === "function") {
                                ...
                                var success = function () {
                                    ...
                                    var $successMessage = $(
                                        ...
                                        .show(0, function () {
                                            if (
                                                typeof options.successEnd ===
                                                "function"
                                            ) {
                                                options.successEnd.call(
                                                    self,
                                                    response,
                                                    $successMessage
                                                );
                            ...
                            if (typeof options.error === "function") {
                                ...
                                var $firstError;
                                $.each(
                                    response.elementErrors,
                                    function (index, info) {
                                        if (
                                            typeof info.errors === "object" &&
                                            ...
                                            if ($element.length) {
                                                var $errorList = $(
                                                    ...
                                                    $errorWrap = $(
                                                        '<div class="quform-errors-wrap"/>'
                                                    ).append($errorList);
                                                $errorList.append(
                                                    '<div class="quform-error">' +
                                                        info.errors[0] +
                                                        "</div>"
                                                );
                                                $element
                                                    .parents(".quform-input")
                                                    .append($errorWrap)
                                                    .end()
                                                ...
                                                alert(
                                                    "Element '" +
                                                        index +
                                                        "' does not exist in the HTML but failed validation, you must either add the HTML for this element into the form or remove the element configuration from the process file."
                                                );
                                            }
                                        }
                                    }
        ...
        var l,
            ...
            X = {
                ...
                show: function () {
                    ...
                    if ((it("onShow", [X], !1), !1 === X.props.onShow(X)))
                        return;
                    (X.state.isVisible = !0),
                    ...
                    (x = function () {
                        ...
                        (function () {
                            var t,
                                ...
                                n = Z();
                            t =
                                (X.props.interactive && e === L.appendTo) ||
                                "parent" === e
                                    ? n.parentNode
                                    : i(e, [n]);
                ...
                hide: function () {
                    ...
                    if (t || e || r) return;
                    if ((it("onHide", [X], !1), !1 === X.props.onHide(X)))
                        return;
                    (X.state.isVisible = !1),
                        (X.state.isShown = !1),
                        (N = !1),
    ...
    return (
                ...
                if (t.target && !i) {
                    ...
                    if (n) {
                        ...
                        if (
                            ...
                            !(
                                ("touchstart" === t.type &&
                                    "boolean" == typeof p.touch) ||
                                ("touchstart" !== t.type &&
                                    a.indexOf(_[t.type]) < 0)
                            )
                        ) {
                            var s = U(n, p);
                            s && (r = r.concat(s));
        ...
        (U.hideAll = function (t) {
            ...
            H.forEach(function (t) {
                ...
                if (
                    (n &&
                        (e = v(n) ? t.reference === n : t.popper === n.popper),
                    !e)
                ) {
