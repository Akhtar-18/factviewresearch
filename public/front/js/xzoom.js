...
(function ($) {
    ...
    function xobject(mObj, opts) {
        ...
        function lensOutput(x, y, sx, sy) {
            if (current.options.position == "lens") {
                ...
                if (current.options.bg) {
                    ...
                    if (sx && sy)
                        lens.css({ "background-size": sx + "px " + sy + "px" });
                }
            } else {
        ...
        function xremove() {
            ...
            if (typeof caption_container != "undefined")
                caption_container.remove();
        }
        ...
        function prepare_zoom(x, y) {
            ...
            if (
                ...
                mtop +=
                    (xzoomID.outerHeight() - mh - preview.outerHeight()) / 2;
        ...
        this.openzoom = function (event) {
            ...
            if (current.options.title && title != "") {
                ...
                if (current.options.fadeIn)
                    caption_container.css({ opacity: 0 });
            }
            ...
            imgObj.xon("load", function (e) {
                ...
                if (current.options.title && title != "") {
                    if (current.options.fadeIn)
                        caption_container.fadeTo(300, 1);
      ...
      if (dir) {
        ...
        this.init = function (options) {
            ...
            if (current.options.smoothScale < 1)
                current.options.smoothScale = 1;
