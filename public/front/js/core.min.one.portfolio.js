!(function (n) {
    ...
    n.scrollIt = function (t) {
        ...
        n(window)
            .on("scroll", function () {
                ...
                (t = t),
                    o.onPageChange && t && s != t && o.onPageChange(t),
                    (s = t),
                    n("[data-scroll-nav]").removeClass(o.activeClass),
                    n("[data-scroll-nav=" + t + "]").addClass(o.activeClass);
            })
            .scroll(),
            ...
            _reset: function () {
                ...
                for (s = this.backgrounds.length - 1; 0 <= s; s--)
                    (o = this.backgrounds[s]).$element
                        ...
                        f(o.$element, o.startingValueLeft, o.startingValueTop);
            },
            destroy: function () {
                this._reset(),
                    this.$scrollElement
                ...
                return e === m || "object" == typeof e
                    ? this.each(function () {
                          g.data(this, "plugin_" + o) ||
                              g.data(this, "plugin_" + o, new h(this, e));
                      })
    ...
    (function (t) {
        ...
        (t.prototype = {
            ...
            open: function (t) {
                ...
                if (!g.isOpen) {
                    ...
                    return (
                        ...
                        setTimeout(function () {
                            g.content
                                ? (g._addClassToMFP(_), g._setFocus())
                                : g.bgOverlay.addClass(_),
                                m.on("focusin" + w, g._onFocusIn);
                        }, 16),
                        (g.isOpen = !0),
                        g.updateSize(r),
                        u(b),
            ...
            updateItemHTML: function () {
                ...
                u("BeforeChange", [g.currItem ? g.currItem.type : "", e]),
                    ...
                    s &&
                        s !== t.type &&
                        g.container.removeClass("mfp-" + s + "-holder");
            ...
            parseEl: function (t) {
                ...
                if (
                    ...
                    for (var o = g.types, s = 0; s < o.length; s++)
            ...
            updateStatus: function (t, e) {
                var i;
                g.preloader &&
                    (o !== t && g.container.removeClass("mfp-s-" + o),
                    ...
                    if ((C(), t.src)) {
                        ...
                        return (
                            s.length
                                ...
                                : (g.updateStatus("error", o.tNotFound),
                                  (s = h("<div>"))),
                            (t.inlineElement = s)
                        );
                    }
                    ...
                    var t = h.extend(
                        {
                            ...
                            error: function () {
                                I(),
                                    ...
                                    g.updateStatus(
                                        "error",
                                        g.st.ajax.tError.replace("%url%", o.src)
                                    );
                            },
                        },
                        g.st.ajax.settings
        ...
        function M(t) {
            var e;
            !g.currTemplate[j] ||
                ((e = g.currTemplate[j].find("iframe")).length &&
            ...
            proto: {
                ...
                preloadNearbyImages: function () {
                    for (
                        ...
                        g._preloadItem(g.index + o);
                    for (o = 1; o <= (g.direction ? e : i); o++)
                        g._preloadItem(g.index - o);
                },
            ...
            proto: {
                initRetina: function () {
                    ...
                    1 < window.devicePixelRatio &&
                        ...
                        (o = i.ratio),
                        1 < (o = isNaN(o) ? o() : o) &&
                            (c("ImageHasSize." + A, function (t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / o,
                                    width: "100%",
                                });
                            }),
                            c("ElementParse." + A, function (t, e) {
        ...
        function m(t) {
            if (
                (b ||
                    ...
                    (c = g(u)),
                    (m.isBoxSizeOuter = f = 200 == p(c.width)),
                    d.removeChild(u)),
