                ...
                f(this).on("bind", "tabactivate", function (t, e) {
                    ...
                    this.each(function () {
                        ...
                        n
                            ...
                            "vertical" == h &&
                                n
                                    .addClass("resp-vtabs")
                                    .addClass(l.tabidentify),
                            1 == c && n.css({ width: "100%", margin: "0px" }),
                            "accordion" == h &&
                                (n
                        ...
                        n.find(".resp-accordion").each(function () {
                            i = f(this);
                            var t = n.find(".resp-tab-item:eq(" + o + ")"),
                                e = n.find(".resp-accordion:eq(" + o + ")");
                            e.append(t.html()),
                                e.data(t.data()),
                                i.attr(
                                    "aria-controls",
                                    l.tabidentify + "_tab_item-" + o
                                ),
                                o++;
                        });
                        var e = 0;
                        ...
                        "" == d ||
                            (null !==
                                (r = d.match(new RegExp(s + "([0-9]+)"))) &&
                                2 === r.length &&
                                ((a = parseInt(r[1], 10) - 1),
                                e < a && (a = 0))),
                            f(n.find(".resp-tab-item." + l.tabidentify)[a])
                            ...
                            !0 === l.closed ||
                                ...
                                (f(
                                    n.find(".resp-accordion." + l.tabidentify)[
                                        a
                                    ]
                                )
                                    .addClass("resp-tab-active")
                            ...
                            f(window).resize(function () {
                                n.find(".resp-accordion-closed").removeAttr(
                                    "style"
                                );
                            });
                    });
    ...
    (function (c, e) {
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if (
                    (e.wrap(
                        c("<div/>", { class: "owl-video-wrapper", style: o })
                    ),
                    this._core.settings.lazyLoad &&
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (s && (a = parseFloat((i / e) * r).toFixed(o)),
                                n)
                            )
        ...
        (h.prototype = {
                    ...
                    this.options.parallaxBackgrounds &&
                        ...
                        t.each(function () {
                            ...
                            if (o.data("stellar-backgroundIsActive")) {
                                if (
                                    o.data("stellar-backgroundIsActive") !==
                                    this
                                )
                                    return;
                            ...
                            o.data("stellar-backgroundStartingLeft")
                                ...
                                (t =
                                    o.data("stellar-horizontal-offset") !== m
                                        ...
                                        : u.horizontalOffset),
                                (e =
                                    o.data("stellar-vertical-offset") !== m
                                        ? o.data("stellar-vertical-offset")
                                        : s !== m &&
                                ...
                                u.backgrounds.push({
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        o.data("stellar-background-ratio") === m
                                            ? 1
                                            : o.data(
            ...
            _reset: function () {
                ...
                for (s = this.backgrounds.length - 1; 0 <= s; s--)
                    (n = this.backgrounds[s]).$element
                        ...
                        g(n.$element, n.startingValueLeft, n.startingValueTop);
            },
            destroy: function () {
                this._reset(),
                    this.$scrollElement
            ...
            (f.fn[n] = function (e) {
                ...
                return e === m || "object" == typeof e
                    ? this.each(function () {
                          f.data(this, "plugin_" + n) ||
                              f.data(this, "plugin_" + n, new h(this, e));
                      })
            ...
            (f[n].scrollProperty = a),
            (f[n].positionProperty = l),
            (s.Stellar = h);
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var n = 0, s = e.length; n < s; n += 1) {
                        var o = e[n];
                        (!o.options.continuous && n !== e.length - 1) ||
                            o.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
            ...
            return function () {
                ...
                return (
                    n.isFunction(arguments[0]) &&
                        ((i = n.extend({}, arguments[1])).handler =
                            arguments[0]),
                    this.each(function () {
    ...
    (function (t) {
        ...
        function u(t, e, i, n) {
            ...
            return (
                (s.className = "mfp-" + t),
                i && (s.innerHTML = i),
                n ? e && e.appendChild(s) : ((s = h(s)), e && s.appendTo(e)),
                s
            );
        }
        function d(t, e) {
        ...
        (t.prototype = {
            ...
            open: function (t) {
                if (!1 === t.isObj) {
                    ...
                    for (var e, i = t.items, n = 0; n < i.length; n++)
                        if (
                            ((e = i[n]).parsed && (e = e.el[0]), e === t.el[0])
                        ) {
                            f.index = n;
                            break;
                        }
            ...
            updateStatus: function (t, e) {
                ...
                f.preloader &&
                    ...
                    d("UpdateStatus", (i = { status: t, text: e })),
                    (t = i.status),
                    (e = i.text),
                    f.preloader.html(e),
        ...
        function C() {
            T && (S.after(T.addClass(z)).detach(), (T = null));
        }
        var z,
            S,
            T,
                            ...
                            s.length
                                ? ((i = s[0].parentNode) &&
                                      ...
                                      (S ||
                                          ...
                                          (S = u(z)),
                                          (z = "mfp-" + z)),
                                      (T = s.after(S).detach().removeClass(z))),
        ...
        function E() {
            L && h(document.body).removeClass(L);
        }
        function O() {
            E(), f.req && f.req.abort();
        }
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    n = {
                        width: e.width(),
                        height:
                            (a ? e.innerHeight() : e[0].offsetHeight) - t - n,
                    };
                    return (
                        void 0 === $ &&
                            ($ =
        ...
        var M = "iframe";
        h.magnificPopup.registerModule(M, {
            options: {
                ...
                initGallery: function () {
                    ...
                    return (
                        ...
                        !(!o || !o.enabled) &&
                            ...
                            c(v + t, function (t, e, i, n) {
                                var s = f.items.length;
                                i.counter =
                                    1 < s ? H(o.tCounter, n.index, s) : "";
                            }),
            ...
            proto: {
                initRetina: function () {
                    ...
                    1 < window.devicePixelRatio &&
                        ...
                        (n = i.ratio),
                        1 < (n = isNaN(n) ? n() : n) &&
                            (c("ImageHasSize." + j, function (t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / n,
                                    width: "100%",
                                });
                            }),
                            c("ElementParse." + j, function (t, e) {
        ...
        function m(t) {
            if (
                (_ ||
                    ...
                    (u = document.body || document.documentElement).appendChild(
                        d
                    ),
                    (c = f(d)),
                    (m.isBoxSizeOuter = g = 200 == p(c.width)),
                    u.removeChild(d)),
    ...
    (function (t, e) {
        ...
        (t.constructor = i),
            ...
            (t.layoutPosition = function () {
                ...
                (e[o] = this.getXValue(s)), (e[i] = "");
                (s = n ? "paddingTop" : "paddingBottom"),
                    (i = n ? "top" : "bottom"),
                    (n = n ? "bottom" : "top"),
            ...
            (t._transitionTo = function (t, e) {
                ...
                var i = this.position.x,
                    ...
                    s = parseInt(t, 10),
                    o = parseInt(e, 10),
                    o = s === this.position.x && o === this.position.y;
            ...
            (s.getSegmentSize = function (t, e) {
                ...
                this._getMeasurement(i, n),
                    this[i] ||
                        ...
                        (this[i] =
                            (t && t[n]) || this.isotope.size["inner" + e]));
            }),
        ...
        (c.prototype.extend = function (t, e) {
            ...
            (i =
                ...
                ((h.prototype.get = function (t) {
                    for (
                        var e, i, n = (e = 0), s = (i = this.keys).length;
                        e < s;
                        n = ++e
                    )
                ...
                (h.prototype.set = function (t, e) {
                    for (
                        var i, n, s = (i = 0), o = (n = this.keys).length;
                        i < o;
                        s = ++i
                    )
            ...
            (this.WOW =
                        ...
                        (this.boxes = function () {
                            for (
                                var t,
                                    e = [],
                                    i = 0,
                                    n = (t = this.element.querySelectorAll(
                ...
                (o.prototype.resetStyle = function () {
                    for (
                        var t, e, i = [], n = 0, s = (e = this.boxes).length;
                        n < s;
                        n++
                    )
                ...
                (o.prototype.vendorSet = function (s, t) {
                    var o,
                        r,
                        a,
                        e = [];
                ...
                (o.prototype.vendorCSS = function (t, e) {
                    for (
                        var i,
                            n,
                            s,
                            o = (n = l(t)).getPropertyCSSValue(e),
                            r = 0,
                            a = (i = this.vendors).length;
                        r < a;
                        r++
                    )
                        (s = i[r]),
                            (o = o || n.getPropertyCSSValue("-" + s + "-" + e));
                    return o;
                }),
