    ...
    class at extends R {
        ...
        _addTouchEventListeners() {
            ...
            Y.find(".carousel-item img", this._element).forEach((t) => {
                ...
                this._pointerEvent
                    ? ($.on(this._element, "pointerdown.bs.carousel", (t) =>
                          e(t)
                      ),
                      $.on(this._element, "pointerup.bs.carousel", (t) => s(t)),
                      this._element.classList.add("pointer-event"))
                    : ($.on(this._element, "touchstart.bs.carousel", (t) =>
                          e(t)
                      ),
    ...
    class he extends R {
        ...
        show(t) {
            this._isShown ||
                ...
                $.trigger(this._element, ie, { relatedTarget: t })
                    .defaultPrevented ||
                ((this._isShown = !0),
    ...
    const be = new Set([
        ...
        Ee = (t, e) => {
            ...
            if (e.includes(i))
                return (
                    !be.has(i) ||
                    Boolean(ve.test(t.nodeValue) || ye.test(t.nodeValue))
                );
            ...
            i.classList.add(Ke),
                i.classList.contains("dropdown-item")
                    ...
                    : Y.parents(i, ".nav, .list-group").forEach((t) => {
                          Y.prev(t, ".nav-link, .list-group-item").forEach(
