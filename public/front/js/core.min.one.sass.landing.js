    ...
    (function () {
        ...
        function i(t) {
            (this.element = t),
                ...
                (s += 1),
                d.windowContext ||
                    ((d.windowContext = !0), (d.windowContext = new i(window))),
        ...
        (i.prototype.add = function (t) {
            ...
            (i.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on("resize.waypoints", function () {
                    e.didResize ||
                        ((e.didResize = !0), d.requestAnimationFrame(t));
                });
            }),
            (i.prototype.createThrottledScrollHandler = function () {
                ...
                this.adapter.on("scroll.waypoints", function () {
                    (e.didScroll && !d.isTouch) ||
                        ((e.didScroll = !0), d.requestAnimationFrame(t));
                });
            }),
            ...
            _reset: function () {
                ...
                for (n = this.backgrounds.length - 1; 0 <= n; n--)
                    (s = this.backgrounds[n]).$element
                        ...
                        g(s.$element, s.startingValueLeft, s.startingValueTop);
            },
            destroy: function () {
                this._reset(),
                    this.$scrollElement
