!(function (r) {
    ...
    r.scrollIt = function (t) {
        function e(t) {
            t < 0 ||
                o < t ||
                ((t =
                    r("[data-scroll-index=" + t + "]").offset().top +
                    i.topOffset +
                    1),
                r("html,body").animate(
                    { scrollTop: t, easing: i.easing },
                    i.scrollTime
                ));
        }
        var i = r.extend(n, t),
            s = 0,
            o = r("[data-scroll-index]:last").attr("data-scroll-index");
        r(window)
            .on("scroll", function () {
                var o = r(window).scrollTop(),
                    t = r("[data-scroll-index]")
                        .filter(function (t, e) {
                            return (
                                o >= r(e).offset().top + i.topOffset &&
                                o <
                                    r(e).offset().top +
                                        i.topOffset +
                                        r(e).outerHeight()
                ...
                (t = t),
                    i.onPageChange && t && s != t && i.onPageChange(t),
                    (s = t),
                    r("[data-scroll-nav]").removeClass(i.activeClass),
                    r("[data-scroll-nav=" + t + "]").addClass(i.activeClass);
            })
            .scroll(),
            r(window).on("keydown", function (t) {
                t = t.which;
                return (
                    (!r("html,body").is(":animated") ||
                        (t != i.upKey && t != i.downKey)) &&
                    (t == i.upKey && 0 < s
                        ? (e(parseInt(s) - 1), !1)
                        : !(t == i.downKey && s < o) ||
                          (e(parseInt(s) + 1), !1))
    ...
    (function (t) {
        ...
        function u(t, e, o, i) {
            ...
            return (
                (s.className = "mfp-" + t),
                o && (s.innerHTML = o),
                i ? e && e.appendChild(s) : ((s = c(s)), e && s.appendTo(e)),
                s
            );
        }
        function h(t, e) {
            f.ev.triggerHandler(o + t, e),
                f.st.callbacks &&
        ...
        (t.prototype = {
            ...
            open: function (t) {
                if (!1 === t.isObj) {
                    ...
                    for (var e, o = t.items, i = 0; i < o.length; i++)
                        if (
                            ((e = o[i]).parsed && (e = e.el[0]), e === t.el[0])
                        ) {
                            f.index = i;
                            break;
                        }
                ...
                if (!f.isOpen) {
                    ...
                    for (i = 0; i < s.length; i++) {
                        var r = (r = s[i]).charAt(0).toUpperCase() + r.slice(1);
                        f["init" + r].call(f);
                    }
                    h("BeforeOpen"),
                        f.st.showCloseBtn &&
                            (f.st.closeBtnInside
                                ? (d(v, function (t, e, o, i) {
                                      o.close_replaceWith = p(i.type);
                                  }),
                                  (m += " mfp-close-btn-in"))
                                : f.wrap.append(p())),
            ...
            updateItemHTML: function () {
                ...
                var e = t.type;
                h("BeforeChange", [f.currItem ? f.currItem.type : "", e]),
                    (f.currItem = t),
                    f.currTemplate[e] ||
                        ((o = !!f.st[e] && f.st[e].markup),
                        h("FirstMarkupParse", o),
                        (f.currTemplate[e] = !o || c(o))),
                    s &&
                        s !== t.type &&
                        f.container.removeClass("mfp-" + s + "-holder");
                var o = f["get" + e.charAt(0).toUpperCase() + e.slice(1)](
                    t,
                    f.currTemplate[e]
                );
                f.appendContent(o, e),
            ...
            parseEl: function (t) {
                ...
                if (
                    (o = o.tagName
                        ? { el: c(o) }
                        : ((e = o.type), { data: o, src: o.src })).el
                ) {
                    for (var i = f.types, s = 0; s < i.length; s++)
            ...
            addGroup: function (e, o) {
                function t(t) {
                    (t.mfpEl = this), f._openClick(t, e, o);
                }
                var i = "click.magnificPopup";
                ((o = o || {}).mainEl = e),
                    o.items
                        ? ((o.isObj = !0), e.off(i).on(i, t))
                        : ((o.isObj = !1),
                          o.delegate
                              ? e.off(i).on(i, o.delegate, t)
                              : (o.items = e).off(i).on(i, t));
            },
            _openClick: function (t, e, o) {
                if (
                    (void 0 !== o.midClick ? o : c.magnificPopup.defaults)
                        .midClick ||
                    !(
                        2 === t.which ||
                        t.ctrlKey ||
                    ...
                    var i = (
                        void 0 !== o.disableOn ? o : c.magnificPopup.defaults
                    ).disableOn;
                    if (i)
                        if (c.isFunction(i)) {
                    ...
                    t.type &&
                        ...
                        (o.el = c(t.mfpEl)),
                        o.delegate && (o.items = e.find(o.delegate)),
                        f.open(o);
                }
            },
            updateStatus: function (t, e) {
                ...
                f.preloader &&
                    ...
                    h("UpdateStatus", (o = { status: t, text: e })),
                    (t = o.status),
                    (e = o.text),
                    f.preloader.html(e),
            ...
            _checkIfClose: function (t) {
                if (!c(t).hasClass($)) {
                    ...
                    if (t === f.content[0] || c.contains(f.content[0], t)) {
                        if (e) return !0;
                    } else if (o && c.contains(document, t)) return !0;
                    return !1;
                }
            },
                    ...
                    c.each(t, function (t, e) {
                        return (
                            ...
                            void (1 < (r = t.split("_")).length
                                ? 0 < (o = s.find(w + "-" + r[0])).length &&
                                  ("replaceWith" === (i = r[1])
                                      ? o[0] !== e[0] && o.replaceWith(e)
                                      : "img" === i
                                      ? o.is("img")
                                          ? o.attr("src", e)
                                          : o.replaceWith(
            ...
            (c.magnificPopup = {
                ...
                close: function () {
                    return (
                        c.magnificPopup.instance &&
                        c.magnificPopup.instance.close()
                    );
                },
                        ...
                        ? "open" === t
                            ? ((e = C
                              ...
                              (i = e.items
                                  ? e.items[o]
                                  : ((i = s),
                                    e.delegate && (i = i.find(e.delegate)),
                                    i.eq(o))),
                              f._openClick({ mfpEl: i }, s, e))
                            : f.isOpen &&
                              f[t].apply(
                                  f,
        ...
        function S() {
            O && (z.after(O.addClass(k)).detach(), (O = null));
        }
        var k,
            z,
            O,
                            ...
                            s.length
                                ? ((o = s[0].parentNode) &&
                                      ...
                                      (z ||
                                          ...
                                          (z = u(k)),
                                          (k = "mfp-" + k)),
                                      (O = s.after(z).detach().removeClass(k))),
        ...
        c.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    o.top -= c(window).scrollTop() - i;
                    i = {
                        width: e.width(),
                        height:
                            (C ? e.innerHeight() : e[0].offsetHeight) - t - i,
                    };
                    return (
                        void 0 === q &&
                            (q =
        ...
        function _(t) {
            var e;
            !f.currTemplate[j] ||
                ((e = f.currTemplate[j].find("iframe")).length &&
                ...
                initGallery: function () {
                    ...
                    return (
                        ...
                        !(!r || !r.enabled) &&
                            ...
                            d(v + t, function (t, e, o, i) {
                                var s = f.items.length;
                                o.counter =
                                    1 < s ? F(r.tCounter, i.index, s) : "";
                            }),
                ...
                preloadNearbyImages: function () {
                    for (
                        var t = f.st.gallery.preload,
                            ...
                            o = Math.min(t[1], f.items.length),
                            i = 1;
                        i <= (f.direction ? o : e);
                        i++
                    )
                        f._preloadItem(f.index + i);
                    for (i = 1; i <= (f.direction ? e : o); i++)
                        f._preloadItem(f.index - i);
                },
    ...
    (function (o) {
        "use strict";
        o.fn.counterUp = function (t) {
            var e = o.extend({ time: 400, delay: 10 }, t);
                        ...
                        for (
                            var t = [],
                                ...
                                s =
                                    (/^[0-9]+$/.test(o),
                                    /^[0-9]+\.[0-9]+$/.test(o)),
                                r = s ? (o.split(".")[1] || []).length : 0,
                                n = e;
                            1 <= n;
                            n--
                        ) {
                            var a = parseInt((o / e) * n);
                            if (
                                (s && (a = parseFloat((o / e) * n).toFixed(r)),
                                i)
                            )
    ...
    (function () {
        ...
        function o(t) {
            (this.element = t),
                ...
                (i += 1),
                p.windowContext ||
                    ((p.windowContext = !0), (p.windowContext = new o(window))),
        ...
        (o.prototype.add = function (t) {
            ...
            (o.prototype.handleScroll = function () {
                ...
                for (t in i) {
                    var s,
                        r = i[t],
                        n = r.newScroll > r.oldScroll ? r.forward : r.backward;
                    for (s in this.waypoints[t]) {
                        ...
                        null !== c.triggerPoint &&
                            ...
                            ((a && l) || (!a && !l)) &&
                                (c.queueTrigger(n), (o[c.group.id] = c.group)));
                    }
                }
                for (e in o) o[e].flushTriggers();
                this.oldScroll = {
            ...
            (o.prototype.destroy = function () {
                ...
                for (t in this.waypoints)
                    for (var o in this.waypoints[t])
                        e.push(this.waypoints[t][o]);
                for (var i = 0, s = e.length; i < s; i++) e[i].destroy();
            }),
                ...
                (t = {
                    ...
                    for (r in this.waypoints[e]) {
                        ...
                        l.element !== l.element.window &&
                            (u = l.adapter.offset()[n.offsetProp]),
                            "function" == typeof c
                                ? (c = c.apply(l))
                                : "string" == typeof c &&
                                  ((c = parseFloat(c)),
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var i = 0, s = e.length; i < s; i += 1) {
                        var r = e[i];
                        (!r.options.continuous && i !== e.length - 1) ||
                            r.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
            ...
            return function () {
                ...
                return (
                    i.isFunction(arguments[0]) &&
                        ((o = i.extend({}, arguments[1])).handler =
                            arguments[0]),
                    this.each(function () {
                        var t = i.extend({}, o, { element: this });
    ...
    (function (c) {
        ...
        c.fn.countdown = function (t, r) {
            ...
            function e() {
                ...
                var o = t - e,
                    i = Math.floor(o / 86400);
                o -= 60 * i * 60 * 24;
                var s = Math.floor(o / 3600);
                o -= 60 * s * 60;
                e = Math.floor(o / 60);
                (o -= 60 * e),
                    1 == i
                        ? n.find(".timeRefDays").text("day")
                        : n.find(".timeRefDays").text("days"),
                    1 == s
                        ? n.find(".timeRefHours").text("hour")
                        : n.find(".timeRefHours").text("hours"),
                    1 == e
                        ? n.find(".timeRefMinutes").text("minute")
                        : n.find(".timeRefMinutes").text("minutes"),
                    1 == o
                        ? n.find(".timeRefSeconds").text("second")
                        : n.find(".timeRefSeconds").text("seconds"),
                    "on" == a.format &&
                    ...
                    isNaN(t)
                        ...
                        : (n.find(".days").text(i),
                          n.find(".hours").text(s),
                          n.find(".minutes").text(e),
                          n.find(".seconds").text(o));
            }
            t && c.extend(a, t), e();
    ...
    (function (f, s, t, g) {
        var i = "stellar",
            ...
            l = {
                ...
                transform: {
                    setPosition: function (t, e, o, i, s) {
                        t[0].style[r] =
                            "translate3d(" +
                            (e - o) +
                            "px, " +
        ...
        (c.prototype = {
            init: function () {
                (this.options.name = i + "_" + Math.floor(1e9 * Math.random())),
            ...
            _defineSetters: function () {
                var r = this,
                    ...
                    n = l[r.options.positionProperty],
                    e = t.setLeft,
                    o = t.setTop;
                (this._setScrollLeft =
                    "function" == typeof e
                    ...
                    (this._setPosition =
                        n.setPosition ||
                        function (t, e, o, i, s) {
                            r.options.horizontalScrolling && n.setLeft(t, e, o),
                                r.options.verticalScrolling &&
                                    n.setTop(t, i, s);
                        });
            },
                    ...
                    this.options.parallaxBackgrounds &&
                        ...
                        t.each(function () {
                            ...
                            if (r.data("stellar-backgroundIsActive")) {
                                if (
                                    r.data("stellar-backgroundIsActive") !==
                                    this
                                )
                                    return;
                            ...
                            r.data("stellar-backgroundStartingLeft")
                                ...
                                r.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (a = c), (l = d), (s = t), !1;
                                    (c += t.position().left),
                                        (d += t.position().top);
                                }),
                                (t =
                                    r.data("stellar-horizontal-offset") !== g
                                        ...
                                        : u.horizontalOffset),
                                (e =
                                    r.data("stellar-vertical-offset") !== g
                                        ? r.data("stellar-vertical-offset")
                                        : s !== g &&
                                ...
                                u.backgrounds.push({
                                    ...
                                    isFixed:
                                        "fixed" ===
                                        r.css("background-attachment"),
                                    horizontalOffset: t,
                                    verticalOffset: e,
                                    startingValueLeft: n[0],
                                    startingValueTop: n[1],
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        r.data("stellar-background-ratio") === g
                                            ? 1
                                            : r.data(
            ...
            _reset: function () {
                for (var t, e, o, i, s = this.particles.length - 1; 0 <= s; s--)
                    (e = (t = this.particles[s]).$element.data(
                        "stellar-startingLeft"
                    )),
                        (o = t.$element.data("stellar-startingTop")),
                        this._setPosition(t.$element, e, e, o, o),
            ...
            _repositionElements: function () {
                ...
                if (
                    ...
                    for (c = this.backgrounds.length - 1; 0 <= c; c--)
                        (e = (o = this.backgrounds[c]).isFixed ? 0 : 1),
            ...
            _startAnimationLoop: function () {
                ...
                (this._animationLoop = function () {
                    n(t._animationLoop), t._repositionElements();
                }),
                    this._animationLoop();
            },
        }),
            (f.fn[i] = function (e) {
                ...
                return e === g || "object" == typeof e
                    ? this.each(function () {
                          f.data(this, "plugin_" + i) ||
                              f.data(this, "plugin_" + i, new c(this, e));
                      })
                    : "string" == typeof e && "_" !== e[0] && "init" !== e
                    ? this.each(function () {
                          var t = f.data(this, "plugin_" + i);
                          t instanceof c &&
                              "function" == typeof t[e] &&
                              t[e].apply(t, Array.prototype.slice.call(o, 1)),
                              "destroy" === e &&
                                  f.data(this, "plugin_" + i, null);
                      })
                    : void 0;
            }),
            (f[i] = function (t) {
            ...
            (f[i].scrollProperty = a),
            (f[i].positionProperty = l),
            (s.Stellar = c);
            ...
            (e.prototype.init = function () {
                ...
                (e.prototype.structure = function () {
                    ...
                    f("body").append(i),
                        ...
                        this.doCss() &&
                            ((i = this.$outer.find(".lg-inner")).css(
                ...
                (e.prototype.doCss = function () {
                    return !!(function () {
                        for (
                            ...
                            if (t[o] in e.style) return !0;
                    })();
                }),
                (e.prototype.isVideo = function (t, e) {
                    var o = this.s.dynamic
                ...
                (e.prototype.preload = function (t) {
                    ...
                    for (o = 1; o <= this.s.preload && !(t - o < 0); o++)
                        this.loadContent(t - o, !1, 0);
                }),
                (e.prototype.loadContent = function (e, t, o) {
                    var i,
                        a,
                        s,
                        r,
                        ...
                        u = function (t) {
                            ...
                            for (
                                var r = f(window).width(), n = 0;
                                n < e.length;
                                n++
                            )
                                if (parseInt(e[n], 10) > r) {
                                    a = o[n];
                                    break;
                                }
                        },
                        h = c.s.dynamic
                            ? (c.s.dynamicEl[e].poster &&
                                  ((d = !0), (s = c.s.dynamicEl[e].poster)),
                              (n = c.s.dynamicEl[e].html),
                              (a = c.s.dynamicEl[e].src),
                              (l = c.s.dynamicEl[e].alt),
                              c.s.dynamicEl[e].responsive &&
                                  u(c.s.dynamicEl[e].responsive.split(",")),
                              (r = c.s.dynamicEl[e].srcset),
                              c.s.dynamicEl[e].sizes)
                            : ((p = c.$items.eq(e)).attr("data-poster") &&
                                  ((d = !0), (s = p.attr("data-poster"))),
                              (n = p.attr("data-html")),
                              ...
                              p.attr("data-responsive") &&
                                  u(p.attr("data-responsive").split(",")),
                              (r = p.attr("data-srcset")),
                              p.attr("data-sizes")),
                        u = !1;
                    c.s.dynamic
                        ? c.s.dynamicEl[e].iframe && (u = !0)
                        : "true" === c.$items.eq(e).attr("data-iframe") &&
                          (u = !0);
                    var p = c.isVideo(a, e);
                    if (!c.$slide.eq(e).hasClass("lg-loaded")) {
                        if (
                            (u
                                ...
                                ? (c.$slide
                                  ...
                                  c.$el.trigger("hasVideo.lg", [e, a, n]))
                                : ((l = l ? 'alt="' + l + '"' : ""),
                                  c.$slide
                                      .eq(e)
                                      .prepend(
                            ...
                            c.$el.trigger("onAferAppendSlide.lg", [e]),
                            (i = c.$slide.eq(e).find(".lg-object")),
                            h && i.attr("sizes", h),
                            r &&
                                (i.attr("srcset", r),
                        ...
                        ".lg-sub-html" !== this.s.appendSubHtmlTo &&
                            c.addHtml(e),
                            c.$slide.eq(e).addClass("lg-loaded");
                    }
                    c.$slide
                        .eq(e)
                        .find(".lg-object")
                        .on("load.lg error.lg", function () {
                            var t = 0;
                            o && !f("body").hasClass("lg-from-hash") && (t = o),
                                setTimeout(function () {
                                    c.$slide.eq(e).addClass("lg-complete"),
                                        c.$el.trigger("onSlideItemLoad.lg", [
                                            e,
                                            o || 0,
                                        ]);
                                }, t);
                        ...
                        p &&
                            ...
                            c.$slide.eq(e).addClass("lg-complete"),
                        !0 === t &&
                            (c.$slide.eq(e).hasClass("lg-complete")
                                ? c.preload(e)
                                : c.$slide
                                      .eq(e)
                                      .find(".lg-object")
                ...
                (e.prototype.slide = function (t, e, o, i) {
                    var s,
                        r,
                        n,
                        a,
                ...
                (e.prototype.setTranslate = function (t, e, o) {
                    this.s.useLeft
                        ? t.css("left", e)
                        : t.css({
                              transform:
                                  "translate3d(" + e + "px, " + o + "px, 0px)",
                          });
                }),
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.progress = function () {
                    ...
                    o.$el.on("onBeforeSlide.lg.tm", function () {
                        o.core.s.progressBar &&
                            o.fromAuto &&
                            ((t = o.core.$outer.find(".lg-progress-bar")),
                            (e = o.core.$outer.find(".lg-progress")),
                            o.interval &&
                                (e.removeAttr("style"),
                ...
                (t.prototype.controls = function () {
                    ...
                    o(this.core.s.appendAutoplayControlsTo).append(
                        ...
                        t.core.$outer
                            ...
                            .on("click.lg", function () {
                                o(t.core.$outer).hasClass("lg-show-autoplay")
                                    ? (t.cancelAuto(),
                ...
                (o.fn.lightGallery.modules.autoplay = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (i.fn.lightGallery.modules.fullscreen = t);
        })();
    }),
    (function (t) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                if (
                    ...
                    o.core.$items.each(function () {
                        o.core.s.exThumbImage
                            ? (s +=
                                  '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                                  n(this).attr(o.core.s.exThumbImage) +
                                  '" /></div></span>')
                            : (s +=
                                  '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                ...
                (t = o.core.$outer.find(".lg-pager-outer")).html(s),
                    (i = o.core.$outer.find(".lg-pager-cont")).on(
                    ...
                    o.core.$el.on("onBeforeSlide.lg.tm", function (t, e, o) {
                        i.removeClass("lg-pager-active"),
                            i.eq(o).addClass("lg-pager-active");
                    });
            }),
                (t.prototype.destroy = function () {}),
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.build = function () {
                    ...
                    function e(t, e, o) {
                        var i,
                            t = s.core.isVideo(t, o) || {},
                            o = "";
                        t.youtube || t.vimeo || t.dailymotion
                            ? t.youtube
                                ? (i = s.core.s.loadYoutubeThumbnail
                                      ? "//img.youtube.com/vi/" +
                                        t.youtube[1] +
                                        "/" +
                                ...
                                ? s.core.s.loadVimeoThumbnail
                                    ...
                                    : (i = e)
                                : t.dailymotion &&
                                  (i = s.core.s.loadDailymotionThumbnail
                    ...
                    if (
                        ...
                        for (var o = 0; o < s.core.s.dynamicEl.length; o++)
                            e(
                                s.core.s.dynamicEl[o].src,
                                s.core.s.dynamicEl[o].thumb,
                                o
                            );
                    else
                    ...
                    s.core.$outer.find(".lg-thumb").html(r),
                ...
                (t.prototype.animateThumb = function (t) {
                    var e,
                        o = this.core.$outer.find(".lg-thumb");
                    ...
                    e.$thumbOuter.addClass("lg-grab"),
                        ...
                        a(window).on("mousemove.lg.thumb", function (t) {
                            s &&
                                ...
                                (n -= i - o) >
                                    e.thumbTotalWidth - e.thumbOuterWidth &&
                                    (n = e.thumbTotalWidth - e.thumbOuterWidth),
                                n < 0 && (n = 0),
                                e.setTranslate(n));
                        }),
                        a(window).on("mouseup.lg.thumb", function () {
                            r
                                ? ((r = !1),
                                  ...
                                  (e.left = n),
                                  Math.abs(i - o) < e.core.s.swipeThreshold &&
                                      (e.thumbClickable = !0))
                                : (e.thumbClickable = !0),
                                s &&
                                    ((s = !1),
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    (this.core = c(t).data("lightGallery")),
                    (this.$el = c(t)),
            ...
            (t.prototype.init = function () {
                ...
                i.core.$el.on(
                    ...
                    function (t, e, o, i) {
                        ...
                        if (
                            (s.core.$slide
                                .eq(e)
                                .find(".lg-video")
                                .append(s.loadVideo(o, "lg-object", !0, e, i)),
                            i)
                        )
                            if (s.core.s.videojs)
                                try {
                    ...
                    i.core.doCss() &&
                    1 < i.core.$items.length &&
                    (i.core.s.enableSwipe || i.core.s.enableDrag)
                    ...
                    i.core.$el.on(
                        ...
                        function (t, e, o) {
                            ...
                            o = i.core.isVideo(e, o) || {};
                            (o.youtube || o.vimeo || o.dailymotion || o.vk) &&
                                i.core.$outer.addClass("lg-hide-download");
                        }.bind(this)
                    ),
                    i.core.$el.on("onAfterSlide.lg.tm", function (t, e) {
                ...
                (t.prototype.loadVideo = function (t, e, o, i, s) {
                    var r = this,
                        n = "",
                        a = 1,
                        l = "",
                        i = this.core.isVideo(t, i) || {},
                        r = r.core.s.dynamic
                            ? r.core.s.dynamicEl[r.core.index].title
                            : r.core.$items.eq(r.core.index).attr("title") ||
                              r.core.$items
                                  .eq(r.core.index)
                                  .find("img")
                                  .first()
                            ...
                            ? ((l =
                              ...
                              this.core.s.youtubePlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      c.param(this.core.s.youtubePlayerParams)),
                              (n =
                            ...
                            ? ((l = "?autoplay=" + a + "&api=1"),
                              this.core.s.vimeoPlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      c.param(this.core.s.vimeoPlayerParams)),
                              (n =
                            ...
                            : i.vk &&
                              ...
                              this.core.s.vkPlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      c.param(this.core.s.vkPlayerParams)),
                              (n =
                ...
                (t.prototype.loadVideoOnclick = function (o) {
                    var i = this;
                    if (
                        ...
                        if (o.hasClass("lg-has-video")) {
                            var t = o.find(".lg-youtube").get(0),
                                e = o.find(".lg-vimeo").get(0),
                            ...
                            i.core.s.dynamic
                                ? s(
                                      i.core.s.dynamicEl[i.core.index].src,
                                      i.core.s.dynamicEl[i.core.index].html
                                  )
                                : s(
                                      i.core.$items
                                          .eq(i.core.index)
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    ...
                    (this.core.s = h.extend({}, i, this.core.s)),
                    this.core.s.zoom &&
                        this.core.doCss() &&
                        (this.init(),
                        (this.zoomabletimeout = !1),
                        (this.pageX = h(window).width() / 2),
                        (this.pageY =
                            h(window).height() / 2 + h(window).scrollTop())),
                    this
                );
            }
            var e,
            ...
            (t.prototype.init = function () {
                ...
                r.core.s.actualSize &&
                    ...
                    r.core.$el.on(
                        ...
                        function (t, e, o) {
                            ...
                            h("body").hasClass("lg-from-hash") && o
                                ? (i = 0)
                                : h("body").removeClass("lg-from-hash"),
                                (r.zoomabletimeout = setTimeout(function () {
                                    r.core.$slide.eq(e).addClass("lg-zoomable");
                                }, i + 30));
                        }
                    );
                function e(t) {
                    var e = r.core.$outer.find(".lg-current .lg-image"),
                        o = (h(window).width() - e.prop("offsetWidth")) / 2,
                        i =
                            (h(window).height() - e.prop("offsetHeight")) / 2 +
                            h(window).scrollTop(),
                        o = (t - 1) * (r.pageX - o),
                        i = (t - 1) * (r.pageY - i);
                    e
                ...
                var a = 1,
                    s = !1;
                r.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (t, e) {
                    var o = r.core.$slide.eq(e).find(".lg-image");
                    o.on("dblclick", function (t) {
                        i(t, o, e);
                    }),
                        o.on("touchstart", function (t) {
                            s
                                ? (clearTimeout(s), (s = null), i(t, o, e))
                ...
                (t.prototype.getModifier = function (t, e, o) {
                    var i = t;
                    t = Math.abs(t);
                ...
                (t.prototype.getImageSize = function (t, e, o) {
                    return (
                        90 === e && (o = "x" === o ? "y" : "x"),
                        t.prop({ y: "offsetHeight", x: "offsetWidth" }[o])
                    );
                }),
                ...
                (t.prototype.getSwipeCords = function (t, e) {
                    var o = t.originalEvent.targetTouches[0].pageX,
                        t = t.originalEvent.targetTouches[0].pageY;
                    return 90 === e ? { x: t, y: o } : { x: o, y: t };
                }),
                (t.prototype.getPossibleDragCords = function (t, e) {
                    ...
                    return 90 === e
                        ? { minY: s, maxY: t, minX: o, maxX: i }
                        : { minY: o, maxY: i, minX: s, maxX: t };
                }),
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    s.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        s.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            (d = s.getCurrentRotation(i)),
                            (e = s.getDragAllowedAxises(e, Math.abs(d))),
                            (c = e.allowY),
                            ((l = e.allowX) || c) &&
                                (t.preventDefault(),
                                (r = s.getSwipeCords(t, Math.abs(d)))));
                    }),
                        s.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            s.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                t.preventDefault(),
                                (a = !0),
                                (n = s.getSwipeCords(t, Math.abs(d))),
                                s.core.$outer.addClass("lg-zoom-dragging"),
                                (o = c
                                    ? -Math.abs(e.attr("data-y")) +
                                      (n.y - r.y) * s.getModifier(d, "Y", i)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = l
                                    ? -Math.abs(e.attr("data-x")) +
                                      (n.x - r.x) * s.getModifier(d, "X", i)
                                    : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(n.x - r.x) ||
                                    15 < Math.abs(n.y - r.y)) &&
                ...
                (t.prototype.zoomDrag = function () {
                    ...
                    s.core.$slide.on("mousedown.lg.zoom", function (t) {
                        ...
                        (d = e.allowY),
                            (c = e.allowX),
                            s.core.$outer.hasClass("lg-zoomed") &&
                                h(t.target).hasClass("lg-object") &&
                                (c || d) &&
                                (t.preventDefault(),
                                (r = s.getDragCords(t, Math.abs(u))),
                                (a = !0),
                        ...
                        h(window).on("mousemove.lg.zoom", function (t) {
                            ...
                            a &&
                                ((e = s.core.$slide
                                    ...
                                    .find(".lg-img-wrap")),
                                (l = !0),
                                (n = s.getDragCords(t, Math.abs(u))),
                                s.core.$outer.addClass("lg-zoom-dragging"),
                                (o = d
                                    ? -Math.abs(e.attr("data-y")) +
                                      (n.y - r.y) * s.getModifier(u, "Y", i)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = c
                                    ? -Math.abs(e.attr("data-x")) +
                                      (n.x - r.x) * s.getModifier(u, "X", i)
                                    : -Math.abs(e.attr("data-x"))),
                                s.core.s.useLeftForZoom
                                    ? e.css({ left: t + "px", top: o + "px" })
                                    : e.css(
                                          "transform",
                                          "translate3d(" +
                                              t +
                ...
                (t.prototype.touchendZoom = function (t, e, o, i, s) {
                    var r = this,
                        n = r.core.$slide.eq(r.core.index).find(".lg-img-wrap"),
                        a = r.core.$slide.eq(r.core.index).find(".lg-object"),
                        l = r.core.$slide
                            .eq(r.core.index)
                            .find(".lg-img-rotate")[0],
                        c =
                            -Math.abs(n.attr("data-x")) +
                            (e.x - t.x) * r.getModifier(s, "X", l),
                        l =
                            -Math.abs(n.attr("data-y")) +
                            (e.y - t.y) * r.getModifier(s, "Y", l),
                    ...
                    (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
                        ...
                        o &&
                            (c <= -s.maxX
                                ...
                                : c >= -s.minX && (c = -s.minX)),
                        i
                            ? n.attr("data-y", Math.abs(l))
                            : (l = -Math.abs(n.attr("data-y"))),
                        o
                            ? n.attr("data-x", Math.abs(c))
                            : (c = -Math.abs(n.attr("data-x"))),
                        r.core.s.useLeftForZoom
                            ? n.css({ left: c + "px", top: l + "px" })
                            : n.css(
                                  "transform",
            ...
            (t.prototype.init = function () {
                ...
                i.core.$el.on("onAfterSlide.lg.tm", function (t, e, o) {
                    ...
                    o(window).on("hashchange.lg.hash", function () {
                        ...
                        -1 < e.indexOf("lg=" + i.core.s.galleryId)
                            ? i.core.slide(t, !1, !1)
                ...
                (o.fn.lightGallery.modules.hash = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
            ...
            (t.prototype.init = function () {
                            ...
                            s("#lg-share-facebook").attr(
                                ...
                                s("#lg-share-pinterest").attr(
                                    ...
                                    "http://www.pinterest.com/pin/create/button/?url=" +
                                        ...
                                        "&media=" +
                                        encodeURIComponent(
                                            i.getSahreProps(o, "src")
                                        ) +
                                        "&description=" +
                                        i.getSahreProps(o, "pinterestText")
                                );
                        }, 100);
                    });
            }),
                (t.prototype.getSahreProps = function (t, e) {
                    ...
                    return this.core.s.dynamic
                        ...
                        : ((o = this.core.$items.eq(t).attr("href")),
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            (t.prototype.buildTemplates = function () {
                ...
                (o.fn.lightGallery.modules.rotate = t);
        })();
    }),
    (function (t) {
        "function" == typeof define && define.amd
        ...
        function e(t) {
            var e,
                ...
                c = 0;
            if (
                (((t = d.event.fix(o)).type = "mousewheel"),
                "detail" in o && (n = -1 * o.detail),
                "wheelDelta" in o && (n = o.wheelDelta),
                "wheelDeltaY" in o && (n = o.wheelDeltaY),
                "wheelDeltaX" in o && (r = -1 * o.wheelDeltaX),
                "axis" in o &&
                    o.axis === o.HORIZONTAL_AXIS &&
                    ((r = -1 * n), (n = 0)),
                (s = 0 === n ? r : n),
                "deltaY" in o && (s = n = -1 * o.deltaY),
                "deltaX" in o && ((r = o.deltaX), 0 === n && (s = -1 * r)),
                0 !== n || 0 !== r)
            ) {
                1 === o.deltaMode
                    ? ((s *= e = d.data(this, "mousewheel-line-height")),
                      (n *= e),
                      (r *= e))
                    : 2 === o.deltaMode &&
                      ((s *= e = d.data(this, "mousewheel-page-height")),
                      (n *= e),
                      (r *= e));
                var a = Math.max(Math.abs(n), Math.abs(r));
                return (
                    (f && !(a < f)) || (h(o, (f = a)) && (f /= 40)),
                    h(o, a) && ((s /= 40), (r /= 40), (n /= 40)),
