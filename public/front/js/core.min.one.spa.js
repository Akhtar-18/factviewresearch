                ...
                i.type === l.Type.Event
                    ...
                    : i.type === l.Type.State &&
                      ...
                      (this._states.tags[i.name] = h.grep(
                          ...
                          h.proxy(function (t, e) {
                              return (
                                  h.inArray(t, this._states.tags[i.name]) === e
                              );
                          }, this)
                      )));
            }),
        ...
        (l.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = n),
                    ...
                    (this.$element =
                        this.element === n ? g("body") : this.$scrollElement),
            ...
            _defineSetters: function () {
                var o = this,
                    ...
                    r = h[o.options.positionProperty],
                    e = t.setLeft,
                    i = t.setTop;
                (this._setScrollLeft =
                    "function" == typeof e
                                ...
                                u.options.showElement(h),
                                    ...
                                    (s =
                                        ...
                                        f
                                            ...
                                            : u.horizontalOffset),
                                    (n =
                                        h.data("stellar-vertical-offset") !== f
                                    ...
                                    u.particles.push({
                                        ...
                                        parentOffsetTop: c,
                                        stellarRatio:
                                            h.data("stellar-ratio") !== f
                                                ? h.data("stellar-ratio")
                                                : 1,
                            ...
                            o.data("stellar-backgroundStartingLeft")
                                ...
                                o.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (a = l), (h = c), (n = t), !1;
                                    (l += t.position().left),
                                        (c += t.position().top);
                                }),
                                (t =
                                    o.data("stellar-horizontal-offset") !== f
                                        ...
                                        : p.horizontalOffset),
                                (e =
                                    o.data("stellar-vertical-offset") !== f
                                        ? o.data("stellar-vertical-offset")
                                        : n !== f &&
                                ...
                                p.backgrounds.push({
                                    ...
                                    parentOffsetTop: h,
                                    stellarRatio:
                                        o.data("stellar-background-ratio") === f
                                            ? 1
                                            : o.data(
                ...
                if (
                    ...
                    for (
                        this.currentScrollLeft = c,
                            ...
                            this.currentWidth = this.viewportWidth,
                            this.currentHeight = this.viewportHeight,
                            l = this.particles.length - 1;
                        0 <= l;
                        l--
                    )
                        (e = (t = this.particles[l]).isFixed ? 1 : 0),
                            ...
                            u && d
                                ...
                                : t.isHidden ||
                                  ...
                                  (t.isHidden = !0));
                    for (l = this.backgrounds.length - 1; 0 <= l; l--)
                        (e = (i = this.backgrounds[l]).isFixed ? 0 : 1),
                ...
                return e === f || "object" == typeof e
                    ? this.each(function () {
                          g.data(this, "plugin_" + s) ||
                              g.data(this, "plugin_" + s, new l(this, e));
                      })
