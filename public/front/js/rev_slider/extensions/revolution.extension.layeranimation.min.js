    ...
    jQuery.extend(!0, A, {
                    ...
                    for (var s = 0; s < i.frames.length; s++)
                        void 0 !== i.frames[s].sfx_effect &&
                            ...
                            (0 === s
                                ...
                                : (i.frames[s].to = "o:0"),
                            (i._sfx = "block")),
                            void 0 === i.frames[0].from &&
                                (i.frames[0].from = "o:inherit"),
        ...
        animateTheCaptions: function (e) {
            ...
            if (
                ...
                (p.layers.static =
                    p.layers.static ||
                    p.c.find(".tp-static-layers").find(".tp-caption")),
            ...
            var g =
                -1 === p.nextSlide || void 0 === p.nextSlide ? 0 : p.nextSlide;
            void 0 !== p.rowzones &&
                ...
                r ||
                    (void 0 !== o &&
                        ...
                        p.timelines.staticlayers &&
                            jQuery.each(
                                p.timelines.staticlayers.layers,
                                function (e, t) {
                                    var i = t.layer.data(),
                                        a =
                                            g >= t.firstslide &&
                                        ...
                                        r = t.timeline.getLabelTime(
                                            "slide_" + t.firstslide
                                        ),
                                        o = t.timeline.getLabelTime(
                                            "slide_" + t.lastslide
                                        ),
        ...
        prepareSingleCaption: function (e) {
            ...
            if (
                ((i._pw =
                    void 0 === i._pw ? t.closest(".tp-parallax-wrap") : i._pw),
                ...
                (i._isgroup =
                    void 0 === i._isgroup
                        ? !!t.hasClass("rev_group")
                        : i._isgroup),
                (i._nctype = i.type || "none"),
                (i._cbgc_auto =
                    void 0 === i._cbgc_auto
                        ? "column" === i._nctype &&
                          i._pw.find(".rev_column_bg_auto_sized")
                        : i._cbgc_auto),
                (i._cbgc_man =
                    void 0 === i._cbgc_man
                        ? "column" === i._nctype &&
                          i._pw.find(".rev_column_bg_man_sized")
                        : i._cbgc_man),
                (i._slideid =
                    i._slideid ||
                    t.closest(".tp-revslider-slidesli").data("index")),
                (i._id =
                    void 0 === i._id ? t.data("id") || t.attr("id") : i._id),
                (i._slidelink =
                    void 0 === i._slidelink
                        ? void 0 !== t.hasClass("slidelink") &&
                          t.hasClass("slidelink")
                        : i._slidelink),
                void 0 === i._li &&
                ...
                "fullscreen" == a.sliderLayout &&
                    (e.offsety =
                        i._gh / 2 - (a.gridheight[a.curWinRange] * a.bh) / 2),
                ("on" == a.autoHeight ||
                    (null != a.minHeight && 0 < a.minHeight)) &&
                    (e.offsety =
                        a.conh / 2 - (a.gridheight[a.curWinRange] * a.bh) / 2),
            ...
            if ("slide" === i._ba) (e.offsetx = 0), (e.offsety = 0);
                ...
                switch (a.carousel.horizontal_align) {
                    case "center":
                        e.offsetx =
                            0 + (a.ulw - a.gridwidth[a.curWinRange] * a.bw) / 2;
                        break;
                    case "left":
                        break;
                    case "right":
            ...
            if (
                ...
                if (
                    ...
                    punchgs.TweenLite.set(t, {
                        ...
                        paddingBottom:
                            Math.round(w.paddingBottom * a.bh) + "px",
                        ...
                        borderTopWidth:
                            Math.round(w.borderTopWidth * a.bh) + "px",
                        borderBottomWidth:
                            Math.round(w.borderBottomWidth * a.bh) + "px",
                        borderLeftWidth:
                            Math.round(w.borderLeftWidth * a.bw) + "px",
                        borderRightWidth:
                            Math.round(w.borderRightWidth * a.bw) + "px",
                        width: l,
                        height: m,
                    });
                ((0 == b && !y) ||
                    (1 != i.forcecover &&
                        !t.hasClass("fullscreenvideo") &&
                        !y)) &&
            ...
            D(t, ".frontcorner", "left", "borderRight", "borderTopColor", T, k),
                ...
                (i.arrobj = new Object()),
                (i.arrobj.voa =
                    N(i.voffset, a)[a.curWinRange] || N(i.voffset, a)[0]),
                (i.arrobj.hoa =
                    N(i.hoffset, a)[a.curWinRange] || N(i.hoffset, a)[0]),
            ...
            if (
                ...
                punchgs.TweenLite.set(t, { y: 0 }),
                    punchgs.TweenLite.set(i._cbgc_man, {
                        y: parseInt(
                            P + i._column.offset().top - t.offset().top,
                            0
                        ),
                    }),
                ...
                s.c
                    ...
                    .each(function () {
                        ...
                        (s.timelines[o] = s.timelines[o] || {}),
                            (s.timelines[o].layers =
                                s.timelines[o].layers || new Object()),
                            e.find(".tp-caption").each(function (e) {
                                ...
                                (t = jQuery(this)),
                                    ...
                                    "staticlayers" === a &&
                                        ((i[t.attr("id")].firstslide =
                                            t.data("startslide")),
                                        (i[t.attr("id")].lastslide =
                                            t.data("endslide"))),
                                    t.data("slideid", a),
                                    (i[t.attr("id")].defclasses = n =
                                        t[0].className),
                                    (i[t.attr("id")].wrapper =
                                        0 <= n.indexOf("rev_layer_in_column")
                                            ...
                                            ? t.closest(".rev_row")
                                            : 0 <=
                                              n.indexOf("rev_layer_in_group")
                                            ? t.closest(".rev_group")
                                            : "none"),
                                    (i[t.attr("id")].timeline = r),
                                    (i[t.attr("id")].layer = t),
                                    (i[t.attr("id")].triggerstate =
                                        t.data("lasttriggerstate")),
            ...
            if (
                ...
                if (
                    ...
                    if (
                        ...
                        (n.hoveranim = v(
                            n.hoveranim,
                            n.frames[n.hoverframeindex].style
                        )),
                        o.svg)
                    ) {
        ...
        createFrameOnTimeline: function (e) {
            ...
            if (
                ...
                void 0 === n.vars.id &&
                    (n.vars.id = Math.round(1e5 * Math.random())),
                "column" === i._nctype &&
                    (n.add(
                        punchgs.TweenLite.set(i._cbgc_man, {
                            visibility: "visible",
            ...
            if (
                ...
                r === i.outframeindex &&
                    ...
                    (_.speed =
                        void 0 === i.frames[r].speed ||
                        "inherit" === i.frames[r].speed
                            ? i.frames[i.inframeindex].speed
                            : i.frames[r].speed),
                    (_.anim.ease =
                        void 0 === i.frames[r].ease ||
                        "inherit" === i.frames[r].ease
                    ...
                    for (var I in s) {
                        ...
                        for (var W in R.to)
                            (z[W] = parseInt(R.to[W].values[R.to[W].index], 0)),
                                (R.to[W].index =
                                    R.to[W].index < R.to[W].len
                                        ? R.to[W].index + 1
                                        : 0);
                        void 0 !== i.frames[r].color &&
                            (z.color = i.frames[r].color),
                            void 0 !== i.frames[r].bgcolor &&
                                (z.backgroundColor = i.frames[r].bgcolor),
                            n.add(
                                d.content.to(s[L[I]], _.speed / 1e3, z, y * I),
                                a
                            );
                    }
                } else
                    void 0 !== i.frames[r].color &&
                        (_.anim.color = i.frames[r].color),
                        void 0 !== i.frames[r].bgcolor &&
                            (_.anim.backgroundColor = i.frames[r].bgcolor),
                        n.add(
                            d.content.staggerTo(s, _.speed / 1e3, _.anim, y),
                            a
                        );
                ...
                for (var I in s) {
                    ...
                    (z.ease = C.ease),
                        ...
                        void 0 !== i.frames[r].bgcolor &&
                            ...
                            (z.backgroundColor =
                                i.cssobj.styleProps["background-color"])),
                        n.add(
                            d.content.fromTo(
                                s[L[I]],
                                b.speed / 1e3,
            ...
            return (
                ...
                (0 === r && e.ignorefirstframe)
                    ...
                    : 0 === r &&
                      n.add(d.mask.set(i._mw, { overflow: "visible" }), a),
        ...
        playAnimationFrame: function (e) {
            ...
            for (var r in a.frames)
                a.frames[r].framename === e.frame && (t = n), n++;
    ...
    var O = function (e, t, i, a, n, r, o, s, d) {
        ...
        S = function (e, t, i, a, n, r, o, s, d) {
            ...
            (l.layer = s),
                ...
                "column" === n._nctype &&
                    (punchgs.TweenLite.to(n._cbgc_man, 0.01, {
                        visibility: "hidden",
                    }),
                    punchgs.TweenLite.to(n._cbgc_auto, 0.01, {
                        visibility: "visible",
                    })),
        ...
        g = function (e) {
            ...
            return (
                (e.firstframe =
                    void 0 === e.firstframe ? "frame_0" : e.firstframe),
                (e.lastframe =
                    void 0 === e.lastframe ? "frame_999" : e.lastframe),
        ...
        B = function (e) {
            return (
                ...
                (e.anim.opacity =
                    void 0 === e.anim.opacity ? 1 : e.anim.opacity),
                        ...
                        r &&
                            ...
                            null != n &&
                                ...
                                ("transformPerspective" != a && "tP" != a) ||
                                    (d.anim.transformPerspective = parseInt(
                                        n,
                                        0
                                    )),
                                ("speed" != a && "s" != a) ||
                                    (d.speed = parseFloat(n)));
                    }),
                "" !== l &&
                    ((d.anim["-webkit-filter"] = l), (d.anim.filter = l)),
                d
            );
        },
        H = function (e) {
        ...
        N = function (i, e, t) {
            if (
                ...
                var a = (i = (i = i.replace("[", "")).replace("]", "")).match(
                    /'/g
                )
                    ? i.split("',")
                    : i.split(",");
        ...
        V = function (e, t) {
            ...
            if (
                ...
                (a.zIndex = n
                    ...
                    : e.data("zIndex")),
                -1 !==
                    jQuery.inArray(e.data("layertype"), [
                        "video",
                        "image",
                        "audio",
                    ]) || e.is("img")
                ...
                if (
                    ...
                    (a.minHeight =
                        void 0 === e.data("height")
                            ...
                            : e.data("height")),
                    null != e.data("videowidth") &&
                        null != e.data("videoheight"))
                ) {
                ...
                (a.maxWidth =
                    ...
                    (a.moan =
                        void 0 === e.data("moan")
                            ? parseInt(e.css("-moz-animation-transition"), 0) ||
                              "none"
                            : e.data("moan")),
                    (a.man =
                        void 0 === e.data("man")
                            ? parseInt(e.css("-ms-animation-transition"), 0) ||
                              "none"
                            : e.data("man")),
                    (a.ani =
                        void 0 === e.data("ani")
            ...
            return (
                ...
                ("" !== a.styleProps.background &&
                    ...
                    a.styleProps.background !==
                        a.styleProps["background-color"]) ||
                    delete a.styleProps.background,
                "" == a.styleProps.color &&
                    (a.styleProps.color = e.css("color")),
                a
            );
        },
        Z = function (a, n) {
            ...
            if (
                ...
                if (
                    ...
                    punchgs.TweenLite.set(e, {
                        ...
                        borderBottomWidth:
                            Math.round(r.borderBottomWidth * s) + "px",
                        borderLeftWidth:
                ...
                "column" === n._nctype &&
                    ...
                    n._cbgc_auto &&
                        ...
                        ((n._cbgc_auto[0].style.backgroundSize =
                            n._column_bg_image_size),
                        jQuery.isArray(r.marginLeft)
                            ? punchgs.TweenLite.set(n._cbgc_auto, {
                                  borderTopWidth:
                                      r.marginTop[t.curWinRange] * s + "px",
                                  borderLeftWidth:
                                      r.marginLeft[t.curWinRange] * o + "px",
                                  borderRightWidth:
                                      r.marginRight[t.curWinRange] * o + "px",
                                  borderBottomWidth:
                                      r.marginBottom[t.curWinRange] * s + "px",
        ...
        c = function (e, t) {
            ...
            if (e.hasClass("rs-wave") && null == i._loop_timeline) {
                ...
                var u =
                        null == e.data("angle")
                            ? 10
                            : parseInt(e.data("angle"), 0),
                    f =
                        null == e.data("radius")
                            ? 10
                            : parseInt(e.data("radius"), 0),
                    h =
