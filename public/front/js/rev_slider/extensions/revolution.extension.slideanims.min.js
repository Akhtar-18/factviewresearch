        ...
        d = function (a, t, e, o, i, n, r, s) {
            ...
            var f = (function (t, o, e, a) {
                    ...
                    (i.duringslidechange = !0),
                        ...
                        1 == i.testanims &&
                            ((i.nexttesttransform =
                                void 0 === i.nexttesttransform
                                    ? 34
                                    : i.nexttesttransform + 1),
                            (i.nexttesttransform =
                                70 < i.nexttesttransform
                                    ? 0
                                    : i.nexttesttransform),
                    ...
                    if (
                        ...
                        -1 !=
                            [
                                12, 13, 14, 15, 16, 28, 29, 30, 31, 32, 33, 34,
                    ...
                    var T = new Object();
                    return (
                        (T.nexttrans = g), (T.STA = y[m]), (T.specials = w), T
                    );
                })(e, t, 0, h),
                c = f.STA,
                u = f.specials;
            ...
            (g =
                ...
                (l.slots =
                    l.slots < 1
                        ...
                        : l.slots),
                (l.slots =
                    (4 == a || 5 == a || 6 == a) && l.slots < 3 ? 3 : l.slots),
                        ...
                        T.add(
                            punchgs.TweenLite.fromTo(
                                ...
                                },
                                {
                                    ...
                                    top: 0 - t * l.sloth + "px",
                                    width:
                                        n.find(".defaultimg").data("neww") +
                                        "px",
                                    height:
                                        n.find(".defaultimg").data("newh") +
                                        "px",
                                    opacity: 1,
                                    ease: m,
                                    rotation: 0,
                        ...
                        t.find(".slot-circle-wrapper").each(function (t) {
                            if (t < 6) {
                                var e = jQuery(this),
                                    ...
                                    h = f;
                                mtl.add(
                                    punchgs.TweenLite.fromTo(e, h, r, s),
                                    0
                                ),
                                    mtl.add(
                                        punchgs.TweenLite.fromTo(o, h, l, d),
                                        0
                                    ),
                                    mtl.add(
                                        punchgs.TweenLite.fromTo(
            ...
            if (12 == a || 13 == a || 14 == a || 15 == a) {
                ...
                var J = l.width,
                    ...
                    K = g / 1e3,
                    U = K;
                ("fullwidth" != l.sliderLayout &&
                    "fullscreen" != l.sliderLayout) ||
