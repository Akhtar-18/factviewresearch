    ...
    jQuery.extend(!0, b, {
        prepareCarousel: function (a, d, h, i) {
            return (
                ...
                ((h = a.carousel.lastdirection =
                    f(h, a.carousel.lastdirection)),
                e(a),
                ...
                "on" === e.infinity &&
                    ((j =
                        j > e.wrapwidth - e.inneroffset && "right" == b
                            ? e.slide_offset -
                              (e.slides.length - i) * e.slide_width
                            : j),
                    (j =
                ...
                jQuery.each(e.slides, function (d, h) {
                    ...
                    var l =
                            "center" === e.horizontal_align
                                ? (Math.abs(e.wrapwidth / 2) -
                                      (j.left + e.slide_width / 2)) /
                                  e.slide_width
                    ...
                    if (
                        ...
                        if ("on" === e.vary_fade)
                            j.autoAlpha =
                                1 -
                                Math.abs(
                                    (1 / Math.ceil(e.maxVisibleItems / n)) * l
                                );
                        else
                            switch (e.horizontal_align) {
                                case "center":
                                    j.autoAlpha =
                                        Math.abs(l) <
                                        Math.ceil(e.maxVisibleItems / n - 1)
                                            ? 1
                                            : 1 -
                                              (Math.abs(l) -
                        ...
                        j.autoAlpha =
                            Math.abs(l) < Math.ceil(e.maxVisibleItems / n)
                                ? 1
                                : 0;
                        ...
                        if ("on" === e.vary_scale) {
                            j.scale =
                                ...
                                Math.abs(
                                    (e.minScale /
                                        100 /
                                        Math.ceil(e.maxVisibleItems / n)) *
                                        l
                                );
                            var o =
                                (e.slide_width - e.slide_width * j.scale) *
                                Math.abs(l);
                        } else {
                            j.scale =
                                l >= 1 || l <= -1
                            ...
                            var o =
                                (e.slide_width -
                                    e.slide_width * (1 - e.minScale / 100)) *
                                Math.abs(l);
                        }
                    void 0 !== e.maxRotation &&
                        ...
                        ("on" === e.vary_rotation
                            ? ((j.rotationY =
                              ...
                              (j.autoAlpha =
                                  Math.abs(j.rotationY) > 90 ? 0 : j.autoAlpha))
                            : (j.rotationY =
                                  l >= 1 || l <= -1
                                      ? e.maxRotation
    ...
    var d = function (a) {
        ...
        i = function (a, b, c) {
            var c,
                ...
                e = b - c - a;
            return (
                (d = h(d, c)), (e = h(e, c)), Math.abs(d) > Math.abs(e) ? e : d
            );
        },
        j = function (a) {
            var c = 0,
            ...
            if (
                ...
                (f = b.simp(f, a.slideamount, !1)),
                    ...
                    (e = e >= 0 ? e : 0),
                    (c =
                        "off" === d.infinity ? f - e : -i(f, e, a.slideamount)),
                    (c *= d.slide_width);
            }
            return c;
        };
