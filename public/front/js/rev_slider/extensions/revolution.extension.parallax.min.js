!(function (a) {
    ...
    jQuery.extend(!0, b, {
            ...
            if (!f.done) {
                ...
                ("mouse" != f.type &&
                    ...
                    a.on(
                        ...
                        function (b, c) {
                            var d =
                                c && c.li ? c.li : a.find(".active-revslide");
                            if ("enterpoint" == f.origo) {
                                var g = a.offset().top,
                                    h = a.offset().left;
                                void 0 == d.data("enterx") &&
                                    d.data("enterx", b.pageX - h),
                                    void 0 == d.data("entery") &&
                                        d.data("entery", b.pageY - g);
                    ...
                    c &&
                        (window.ondeviceorientation = function (b) {
                            ...
                            if (
                                (g
                                    .find(".tp-parallax-container")
                                    .each(function (a) {
                                        n.push(jQuery(this));
                                    }),
                                a
                                    .find(
                                        ".tp-static-layers .tp-parallax-container"
                                    )
                                    .each(function () {
                                        n.push(jQuery(this));
                                    }),
                ...
                if (((i.bgs = new Array()), i.on)) {
                    ...
                    (i.multiplicator_layers = parseFloat(
                        i.multiplicator_layers
                    )),
        ...
        scrollHandling: function (a, d, f) {
            if (
                ((a.lastwindowheight =
                    a.lastwindowheight || window.innerHeight),
                (a.conh =
            ...
            if (
                ((a.scrollproc = j),
                b.callBackHandling &&
                    b.callBackHandling(a, "parallax", "start"),
                h.enable)
            ) {
                var k = 1 - Math.abs(j);
                (k = k < 0 ? 0 : k),
                    ...
                    1 - h.visible_area <= k
                        ? a.inviewport ||
                          ((a.inviewport = !0), b.enterInViewPort(a))
                        : a.inviewport &&
                          ((a.inviewport = !1), b.leaveViewPort(a));
            }
