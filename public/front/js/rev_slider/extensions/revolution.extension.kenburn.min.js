!(function (a) {
    ...
    jQuery.extend(!0, b, {
        ...
        startKenBurn: function (a, d, e) {
            ...
            var n = function (a, b, c, d, e, f, g) {
                ...
                p = function (a, b, c) {
                    var d = c.scalestart / 100,
                        ...
                        g =
                            void 0 != c.offsetend
                                ? c.offsetend.split(" ") || [0, 0]
                                : [0, 0];
                    c.bgposition =
                        "center center" == c.bgposition
                            ? "50% 50%"
                            : c.bgposition;
                    var h = new Object(),
                        i = a * d,
                    ...
                    if (
                        ...
                        (h.start.width = a),
                        (h.start.height =
                            (h.start.width / c.owidth) * c.oheight),
                        h.start.height < b)
                    ) {
                    ...
                    (h.start.transformOrigin = c.bgposition),
                        ...
                        (h.end.scale = e),
                        (c.rotatestart =
                            0 === c.rotatestart ? 0.01 : c.rotatestart),
            ...
            void 0 != a.data("kbtl") &&
                (a.data("kbtl").kill(), a.removeData("kbtl"));
