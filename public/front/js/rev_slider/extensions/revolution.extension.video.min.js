        ...
        preLoadAudio: function (e, a) {
            ...
            e.find(".tp-audiolayer").each(function () {
                ...
                0 === e.find("audio").length &&
                    ((t.src =
                        null != e.data("videomp4") ? e.data("videomp4") : ""),
                    (t.pre = e.data("videopreload") || ""),
                    void 0 === e.attr("id") &&
                        e.attr(
                            "audio-layer-" + Math.round(199999 * Math.random())
                        ),
                    (t.id = e.attr("id")),
                    (t.status = "prepared"),
                    (t.start = jQuery.now()),
                ...
                case "vimeo":
                    if (0 == a.find("iframe").length)
                        ...
                        a.data("vimeoplayer")
                            ...
                            : ((d = new Vimeo.Player(n)),
                              a.data("vimeoplayer", d)),
                            d.getPaused()
                                ? setTimeout(function () {
                        ...
                        A(
                            ...
                            (function (e) {
                                ...
                                1 == e.data("nextslideatend-triggered") &&
                                    ((a = -1),
                                    e.data("nextslideatend-triggered", 0)),
            ...
            var a = i.data(),
                ...
                h =
                    "html5" == y && 0 == i.find(f).length
                        ...
                        : "none";
            switch (
                ((g = !0 === a.nextslideatend ? "" : g), (a.videotype = y), h)
            ) {
                case "html5":
                    "controls" != c && (c = "");
                    f = "video";
                    "html5" == a.audio &&
                        ((f = "audio"), i.addClass("tp-audio-html5"));
                    var b = "";
                    "video" === f &&
                    ...
                    ("true" !== v && !0 !== v) ||
                        ...
                        i.append(w),
                        ((_ && 1 == i.data("disablevideoonmobile")) ||
                            I.isIE(8)) &&
                            i.find(f).remove(),
                    ...
                    0 == i.find("iframe").length &&
                        i.find(".tp-videoposter").click(function () {
                            if ((I.playVideo(i, o), _)) {
                                if (1 == i.data("disablevideoonmobile"))
                                    return !1;
                                punchgs.TweenLite.to(
                                    i.find(".tp-videoposter"),
                                    0.3,
                                    {
                                        autoAlpha: 0,
                                        force3D: "auto",
            ...
            "none" != i.data("dottedoverlay") &&
                ...
                i.append(
                    '<div class="tp-dottedoverlay ' +
                        i.data("dottedoverlay") +
                        '"></div>'
                ),
                i.addClass("HasListener"),
                1 == i.data("bgvideo") &&
                    (i.data("ytid")
                        ? punchgs.TweenLite.set(i.find("iframe"), {
                              opacity: 0,
                          })
                ...
                switch (l.videotype) {
                                    ...
                                    if (e.data == YT.PlayerState.PLAYING)
                                        ...
                                        a ||
                                            ...
                                            -1 != e.data &&
                                                ...
                                                (null !=
                                                    o.currentLayerVideoIsPlaying &&
                                                    o.currentLayerVideoIsPlaying.attr(
                                                        "id"
                                                    ) != r.attr("id")) ||
                                                    I.unToggleState(
                                                        l.videotoggledby
                    ...
                    case "vimeo":
                        for (
                            ...
                            p[decodeURIComponent(i[1])] = decodeURIComponent(
                                i[2]
                            );
                        u = (u =
                            null != p.player_id
                                ? u.replace(p.player_id, a)
                                : u + "&player_id=" + a).replace(
                            /&api=0|&api=1/g,
                            ""
                        );
                        var m = I.is_mobile(),
                        ...
                        if (
                            (r.data("vimeoplayer")
                                ...
                                : ((h = new Vimeo.Player(a)),
                                  r.data("vimeoplayer", h)),
