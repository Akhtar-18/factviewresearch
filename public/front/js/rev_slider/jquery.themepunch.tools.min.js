(function (a) {
    ...
    function D(a5, aw) {
        ...
        try {
            ...
            f.error(
                "events not supported " + K + "," + aE + " on jQuery.swipetp"
            );
        }
        ...
        this.option = function (bd, bc) {
            if (aw[bd] !== undefined) {
                ...
                f.error(
                    "Option " + bd + " does not exist on jQuery.swipetp.options"
                );
            }
            return null;
        };
            ...
            return (
                ...
                (d.add = function (r, n, a, o) {
                    ...
                    if (
                        ...
                        for (
                            c = this, p = c.rawTime() > r._startTime;
                            c._timeline;
                ...
                (d.render = function (t, e, i) {
                    ...
                    if ((this._time !== f && this._first) || i || h) {
                        ...
                        this._onUpdate &&
                            (e ||
                                (l.length && _(), this._callback("onUpdate"))),
                            o &&
                                (this._gc ||
                                    ((c === this._startTime ||
                                        p !== this._timeScale) &&
                    ...
                    if (
                        ...
                        if (16 === f.length) {
                            ...
                            m.zOrigin &&
                                ...
                                (m.scaleX =
                                    ((Math.sqrt(x * x + y * y) * p + 0.5) | 0) /
                                    p),
                                (m.scaleY =
                                    ((Math.sqrt(C * C + G * G) * p + 0.5) | 0) /
                                    p),
                                (m.scaleZ =
                                    ((Math.sqrt(D * D + H * H) * p + 0.5) | 0) /
                                    p),
...
!(function (a) {
    ...
    var b = a.GreenSockGlobals || a,
        ...
        u = function (a) {
            return (
                ((a.charCodeAt(0) - n) << 10) + (a.charCodeAt(1) - p) + 65536
            );
        },
                ...
                for (
                    ...
                    for (
                        ...
                        "BR" !== q[l].nodeName &&
                            ...
                            r &&
                                n._wordEnd &&
                                t.appendChild(f.createTextNode(" ")),
                            S &&
                                (0 === l &&
                                    ((t.style.top = n._y + "px"),
                                    (t.style.left = x + v + "px")),
        ...
        F = function (a, b, c, d) {
            ...
            for (
                ...
                if (
                    ((p = g.charAt(i)), p === D && g.charAt(i - 1) !== D && i)
                ) {
    ...
    (H.split = function (a) {
        ...
        for (
            var b,
                ...
                f = a.span ? "span" : "div",
                g =
                    ("absolute" === a.position || a.absolute === !0,
                    x(a.wordsClass, f)),
                h = x(a.charsClass, f);
            --e > -1;
