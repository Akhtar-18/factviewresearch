!(function (s) {
    ...
    (s.fn.menumaker = function (t) {
        var e = s(this),
            i = s.extend({ format: "dropdown", sticky: !1 }, t);
        return this.each(function () {
            s(this)
                ...
                .on("click", function () {
                    ...
                    t.hasClass("open")
                        ? t.slideToggle().removeClass("open")
                        : (t.slideToggle().addClass("open"),
            ...
            "multitoggle" === i.format
                ? (e
                  ...
                  e
                      ...
                      .on("click", function () {
                          s(this).next(".sub-menu").slideToggle(),
                              s(this)
                                  .siblings("ul")
                                  .addClass("open")
                                  .slideToggle(),
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (o && (r = parseFloat((i / e) * a).toFixed(n)),
                                s)
                            )
    ...
    (function (s) {
        ...
        var e = function (t) {
            (this.owl = t),
                ...
                (this.owl.options = s.extend({}, e.Defaults, this.owl.options)),
        ...
        (e.Defaults = {
            ...
            (e.prototype.listen = function () {
                ...
                i.thumbsPrerendered &&
                    (this._thumbcontent._thumbcontainer = s(
                        "." + i.thumbContainerClass
                    )),
                    s(this._thumbcontent._thumbcontainer).on(
                        "click",
                        this._thumbcontent._thumbcontainer.children(),
                        s.proxy(function (t) {
                            this._identifier = s(t.target)
            ...
            (e.prototype.render = function () {
                ...
                if (
                    (e.thumbsPrerendered
                        ...
                        : (this._thumbcontent._thumbcontainer = s("<div>")
            ...
            (e.prototype.setActive = function () {
                ...
                var t = this.owl.options,
                    t = t.thumbsPrerendered
                        ? s(
                              "." +
                                  t.thumbContainerClass +
                                  '[data-slider-id="' +
                                  this._identifier +
                                  '"]'
                          )
                        : this._thumbcontent._thumbcontainer;
                t.children().filter(".active").removeClass("active"),
                    t.children().eq(this.owl_currentitem).addClass("active");
            }),
            (e.prototype.destroy = function () {
                var t, e;
                for (t in this._handlers)
    ...
    (function (h) {
        "use strict";
        h.fn.countdown = function (t, n) {
            var a = h(this),
                r = { date: null, format: null };
            function e() {
                var t = Date.parse(r.date) / 1e3,
                    e = Math.floor(h.now() / 1e3);
                ...
                (i -= 60 * e),
                    1 == s
                        ? a.find(".timeRefDays").text("day")
                        : a.find(".timeRefDays").text("days"),
                    1 == o
                        ? a.find(".timeRefHours").text("hour")
                        : a.find(".timeRefHours").text("hours"),
                    1 == e
                        ? a.find(".timeRefMinutes").text("minute")
                        : a.find(".timeRefMinutes").text("minutes"),
                    1 == i
                        ? a.find(".timeRefSeconds").text("second")
                        : a.find(".timeRefSeconds").text("seconds"),
                    "on" == r.format &&
                        ((s = 2 <= String(s).length ? s : "0" + s),
                        (o = 2 <= String(o).length ? o : "0" + o),
                        (e = 2 <= String(e).length ? e : "0" + e),
    ...
    (function (t) {
        ...
        function E(t) {
            var e;
            !g.currTemplate[U] ||
                ((e = g.currTemplate[U].find("iframe")).length &&
                    (t || (e[0].src = "//about:blank"),
                    g.isIE8 && e.css("display", t ? "block" : "none")));
        }
        var U = "iframe";
        h.magnificPopup.registerModule(U, {
            options: {
        ...
        var H = "retina";
        h.magnificPopup.registerModule(H, {
            options: {
            ...
            proto: {
                initRetina: function () {
                    ...
                    1 < window.devicePixelRatio &&
                        ...
                        (s = i.ratio),
                        1 < (s = isNaN(s) ? s() : s) &&
                            (d("ImageHasSize." + H, function (t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / s,
                                    width: "100%",
                                });
                            }),
                            d("ElementParse." + H, function (t, e) {
    ...
    (function (t) {
        ...
        function y(t, n) {
            ...
            (this.element = T(t)),
                ...
                (this.formatType =
                    ...
                    "standard"),
                (this.format = M.parseFormat(
                    n.format ||
                        this.element.data("date-format") ||
                        k[this.language].format ||
                        M.getDefaultFormat(this.formatType, "input"),
                    this.formatType
                )),
                (this.isInline = !1),
                (this.isVisible = !1),
                ...
                (this.linkFormat = M.parseFormat(
                    n.linkFormat ||
                        this.element.data("link-format") ||
                        M.getDefaultFormat(this.formatType, "link"),
                    this.formatType
                )),
                (this.minuteStep =
                ...
                (this.minView = M.convertViewMode(this.minView)),
                (this.maxView = M.modes.length - 1),
                "maxView" in n
                    ? (this.maxView = n.maxView)
                    : "maxView" in this.element.data() &&
                      (this.maxView = this.element.data("max-view")),
                (this.maxView = M.convertViewMode(this.maxView)),
                ...
                (this.startViewMode = M.convertViewMode(this.startViewMode)),
                ...
                (this.viewSelect = M.convertViewMode(this.viewSelect)),
                (this.forceParse = !0),
                "forceParse" in n
            ...
            for (
                var i = 3 === this.bootcssVer ? M.templateV3 : M.template;
        ...
        y.prototype = {
            ...
            setFormat: function (t) {
                var e;
                (this.format = M.parseFormat(t, this.formatType)),
                    this.isInput
                        ? (e = this.element)
                ...
                if (this.date && this.viewDate) {
                    ...
                    this.setTitle(
                        ...
                        "time" === this.formatViewType
                            ? ((x = this.getFormattedDate()),
                              this.setTitle(".datetimepicker-hours", x),
                              this.setTitle(".datetimepicker-minutes", x))
                            : (this.setTitle(
                    ...
                    var x = this.date.getUTCFullYear(),
                        c = this.setTitle(".datetimepicker-months", t)
                            ...
                            .find(".month")
                            .removeClass("active");
                    x === t && c.eq(this.date.getUTCMonth()).addClass("active"),
            ...
            showMode: function (t) {
                !t ||
                    ((t = Math.max(
                        0,
                        Math.min(M.modes.length - 1, this.viewMode + t)
                    )) >= this.minView &&
                        t <= this.maxView &&
                        (this.element.trigger({
                            type: "changeMode",
                    ...
                    this.picker
                        ...
                        .hide()
                        .filter(
                            ".datetimepicker-" + M.modes[this.viewMode].clsName
                        )
                        .css("display", "block"),
                    this.updateNavArrows();
            },
        ...
        (M.template =
            ...
            (M.templateV3 =
                ...
                M.footTemplate +
                "</table></div></div>"),
            (T.fn.datetimepicker.DPGlobal = M),
