!(function (o) {
    ...
    (o.fn.menumaker = function (t) {
        var e = o(this),
            i = o.extend({ format: "dropdown", sticky: !1 }, t);
            ...
            "multitoggle" === i.format
                ? (e
                  ...
                  e
                      ...
                      .on("click", function () {
                          o(this).next(".sub-menu").slideToggle(),
                              o(this)
                                  .siblings("ul")
                                  .addClass("open")
                                  .slideToggle(),
                      ...
                      .on("click", function () {
                          o(this).next(".sub-menu").slideToggle(),
                              ...
                              o(this)
                                  ...
                                  .parents("li")
                                  .removeClass("active"),
                              o(this).siblings("ul").hasClass("open") &&
                                  o(this)
                                      .parents("li")
                                      .eq(1)
                                      .addClass("active");
        ...
        o(document).ready(function () {
            o("nav").menumaker({ format: "multitoggle" });
                ...
                f(this).on("bind", "tabactivate", function (t, e) {
                    ...
                    this.each(function () {
                        ...
                        o
                            ...
                            "vertical" == h &&
                                o
                                    .addClass("resp-vtabs")
                                    .addClass(l.tabidentify),
                            1 == c && o.css({ width: "100%", margin: "0px" }),
                            "accordion" == h &&
                                (o
                        ...
                        o.find(".resp-accordion").each(function () {
                            i = f(this);
                            var t = o.find(".resp-tab-item:eq(" + n + ")"),
                                e = o.find(".resp-accordion:eq(" + n + ")");
                            e.append(t.html()),
                                e.data(t.data()),
                                i.attr(
                                    "aria-controls",
                        ...
                        "" == u ||
                            (null !==
                                (r = u.match(new RegExp(s + "([0-9]+)"))) &&
                                2 === r.length &&
                                ((a = parseInt(r[1], 10) - 1),
                                e < a && (a = 0))),
                            f(o.find(".resp-tab-item." + l.tabidentify)[a])
                            ...
                            !0 === l.closed ||
                                ...
                                (f(
                                    o.find(".resp-accordion." + l.tabidentify)[
                                        a
                                    ]
                                )
                                    .addClass("resp-tab-active")
                            ...
                            f(window).resize(function () {
                                o.find(".resp-accordion-closed").removeAttr(
                                    "style"
                                );
                            });
                    });
    ...
    (function (l, i, o, a) {
        ...
        (h.Defaults = {
                    ...
                    run: function () {
                        for (
                            ...
                            (t = this._coordinates[a - 1] || 0),
                                (e = Math.abs(this._coordinates[a]) + o * i),
                                ((this.op(t, "<=", s) && this.op(t, ">", n)) ||
                                    (this.op(e, "<", s) &&
                                        this.op(e, ">", n))) &&
                                    r.push(a);
            ...
            (h.prototype.setup = function () {
                ...
                t
                    ? (l.each(t, function (t) {
                      ...
                      "function" ==
                          typeof (o = l.extend({}, this.options, t[i]))
                              .stagePadding &&
                ...
                this.is("dragging") &&
                    ...
                    this.settings.loop
                        ...
                        : ((i = this.settings.rtl
                          ...
                          (n.x = Math.max(Math.min(n.x, i + e), o + e))),
            ...
            (h.prototype.closest = function (i, o) {
                var s = -1,
                    n = this.width(),
                    r = this.coordinates();
                return (
            ...
            (h.prototype.on = function (t, e, i, o) {
                t.addEventListener
                    ? t.addEventListener(e, i, o)
                    : t.attachEvent && t.attachEvent("on" + e, i);
            }),
            (h.prototype.off = function (t, e, i, o) {
                t.removeEventListener
                    ? t.removeEventListener(e, i, o)
                    : t.detachEvent && t.detachEvent("on" + e, i);
            }),
            (h.prototype.trigger = function (t, e, i, o, s) {
                var n = {
                        item: {
                        ...
                        a.proxy(function (t) {
                            if (
                                ...
                                for (
                                    ...
                                    this.load(n / 2 + this._core.relative(s)),
                                        n &&
                                            a.each(
                                                this._core.clones(
    ...
    (function (c, e) {
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if (
                    (e.wrap(
                        c("<div/>", { class: "owl-video-wrapper", style: n })
                    ),
                    this._core.settings.lazyLoad &&
    ...
    (function (o, s) {
                ...
                (this._handlers = {
                    "initialized.owl.carousel": o.proxy(function (t) {
                        t.namespace &&
                            ...
                            o(s).trigger("hashchange.owl.navigation");
                    }, this),
        ...
        (e.Defaults = { URLhashListener: !1 }),
            (e.prototype.destroy = function () {
                var t, e;
                for (t in (o(s).off("hashchange.owl.navigation"),
                this._handlers))
                    this._core.$element.off(t, this._handlers[t]);
                for (e in Object.getOwnPropertyNames(this))
                    "function" != typeof this[e] && (this[e] = null);
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (s && (a = parseFloat((i / e) * r).toFixed(n)),
                                o)
                            )
        ...
        (h.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = s),
                    ...
                    (this.$element =
                        this.element === s ? f("body") : this.$scrollElement),
                    (this.$viewportElement =
                        this.options.viewportElement !== g
                            ? f(this.options.viewportElement)
            ...
            _defineSetters: function () {
                ...
                (this._setScrollLeft =
                    ...
                    (this._setPosition =
                        r.setPosition ||
                        function (t, e, i, o, s) {
                            n.options.horizontalScrolling && r.setLeft(t, e, i),
                                ...
                                p.options.showElement(l),
                                    ...
                                    (o =
                                        ...
                                        g
                                            ...
                                            : p.horizontalOffset),
                                    (s =
                                        l.data("stellar-vertical-offset") !== g
                            ...
                            n.data("stellar-backgroundStartingLeft")
                                ...
                                n.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (a = h), (l = c), (s = t), !1;
                                    (h += t.position().left),
                                        (c += t.position().top);
                                }),
                                (t =
                                    n.data("stellar-horizontal-offset") !== g
                                        ...
                                        : d.horizontalOffset),
                                (e =
                                    n.data("stellar-vertical-offset") !== g
                                        ? n.data("stellar-vertical-offset")
                                        : s !== g &&
                                ...
                                d.backgrounds.push({
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        n.data("stellar-background-ratio") === g
                                            ? 1
                                            : n.data(
            ...
            _reset: function () {
                for (var t, e, i, o, s = this.particles.length - 1; 0 <= s; s--)
                    (e = (t = this.particles[s]).$element.data(
                        "stellar-startingLeft"
                    )),
            ...
            (f.fn[o] = function (e) {
                var i = arguments;
                return e === g || "object" == typeof e
                    ? this.each(function () {
                          f.data(this, "plugin_" + o) ||
                              f.data(this, "plugin_" + o, new h(this, e));
                      })
            ...
            (f[o].scrollProperty = a),
            (f[o].positionProperty = l),
            (s.Stellar = h);
        ...
        (i.prototype.add = function (t) {
            ...
            (i.prototype.checkEmpty = function () {
                ...
                t &&
                    e &&
                    !i &&
                    (this.adapter.off(".waypoints"), delete s[this.key]);
            }),
            (i.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on("resize.waypoints", function () {
                    e.didResize ||
                        ((e.didResize = !0), p.requestAnimationFrame(t));
                });
            }),
            ...
            (i.prototype.handleScroll = function () {
                ...
                for (t in o) {
                    ...
                    for (s in this.waypoints[t]) {
                        var a,
                            l,
                            h = this.waypoints[t][s];
                        null !== h.triggerPoint &&
                            ((a = n.oldScroll < h.triggerPoint),
                            (l = n.newScroll >= h.triggerPoint),
                            ((a && l) || (!a && !l)) &&
            ...
            (i.prototype.refresh = function () {
                ...
                (t = {
                    ...
                    for (n in this.waypoints[e]) {
                        var a,
                            l = this.waypoints[e][n],
                            h = l.options.offset,
                            c = l.triggerPoint,
                            d = 0,
                            u = null == c;
                        l.element !== l.element.window &&
                            (d = l.adapter.offset()[r.offsetProp]),
                            "function" == typeof h
                                ? (h = h.apply(l))
                                : "string" == typeof h &&
                                  ((h = parseFloat(h)),
                                  -1 < l.options.offset.indexOf("%") &&
                                      (h = Math.ceil(
                                          (r.contextDimension * h) / 100
                                      ))),
                            (a = r.contextScroll - r.contextOffset),
                            (l.triggerPoint = Math.floor(d + a - h)),
                            (a = c < r.oldScroll),
                            (h = l.triggerPoint >= r.oldScroll),
                            (c = !a && !h),
                            !u && a && h
                                ? (l.queueTrigger(r.backward),
                                  (s[l.group.id] = l.group))
                                : ((!u && c) ||
                                      (u && r.oldScroll >= l.triggerPoint)) &&
                                  (l.queueTrigger(r.forward),
                                  (s[l.group.id] = l.group));
                    }
                }
                return (
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var o = 0, s = e.length; o < s; o += 1) {
                        var n = e[o];
                        (!n.options.continuous && o !== e.length - 1) ||
                            n.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
            ...
            return function () {
                ...
                return (
                    o.isFunction(arguments[0]) &&
                        ((i = o.extend({}, arguments[1])).handler =
                            arguments[0]),
                    this.each(function () {
    ...
    (function (h) {
        ...
        h.fn.countdown = function (t, n) {
            ...
            function e() {
                ...
                (i -= 60 * e),
                    1 == o
                        ? r.find(".timeRefDays").text("day")
                        : r.find(".timeRefDays").text("days"),
                    1 == s
                        ? r.find(".timeRefHours").text("hour")
                        : r.find(".timeRefHours").text("hours"),
                    1 == e
                        ? r.find(".timeRefMinutes").text("minute")
                        : r.find(".timeRefMinutes").text("minutes"),
                    1 == i
                        ? r.find(".timeRefSeconds").text("second")
                        : r.find(".timeRefSeconds").text("seconds"),
                    "on" == a.format &&
                    ...
                    isNaN(t)
                        ...
                        : (r.find(".days").text(o),
                          r.find(".hours").text(s),
                          r.find(".minutes").text(e),
                          r.find(".seconds").text(i));
            }
            t && h.extend(a, t), e();
    ...
    (function (t) {
        ...
        function d(t, e, i, o) {
            ...
            return (
                (s.className = "mfp-" + t),
                i && (s.innerHTML = i),
                o ? e && e.appendChild(s) : ((s = h(s)), e && s.appendTo(e)),
                s
            );
        }
        function u(t, e) {
            f.ev.triggerHandler("mfp" + t, e),
                f.st.callbacks &&
                    ...
                    f.st.callbacks[t] &&
                        f.st.callbacks[t].apply(f, h.isArray(e) ? e : [e]));
        }
        function p(t) {
            return (
                (t === e && f.currTemplate.closeBtn) ||
                    ((f.currTemplate.closeBtn = h(
        ...
        function n() {
            h.magnificPopup.instance ||
                ((f = new t()).init(), (h.magnificPopup.instance = f));
        }
        var f,
            o,
            g,
        ...
        (t.prototype = {
            ...
            open: function (t) {
                if (!1 === t.isObj) {
                    ...
                    for (var e, i = t.items, o = 0; o < i.length; o++)
                        if (
                            ((e = i[o]).parsed && (e = e.el[0]), e === t.el[0])
                        ) {
                            f.index = o;
                            break;
                        }
                ...
                if (!f.isOpen) {
                    ...
                    return (
                        ...
                        f.bgOverlay
                            .add(f.wrap)
                            .prependTo(f.st.prependTo || h(document.body)),
                        (f._lastFocusedEl = document.activeElement),
                        setTimeout(function () {
                            f.content
                                ? (f._addClassToMFP(_), f._setFocus())
                                : f.bgOverlay.addClass(_),
            ...
            addGroup: function (e, i) {
                ...
                ((i = i || {}).mainEl = e),
                    i.items
                        ? ((i.isObj = !0), e.off(o).on(o, t))
                        : ((i.isObj = !1),
                          i.delegate
                              ? e.off(o).on(o, i.delegate, t)
                              : (i.items = e).off(o).on(o, t));
            },
            _openClick: function (t, e, i) {
                if (
                    ...
                    t.type &&
                        (t.preventDefault(), f.isOpen && t.stopPropagation()),
                        (i.el = h(t.mfpEl)),
            ...
            updateStatus: function (t, e) {
                var i;
                f.preloader &&
                    (o !== t && f.container.removeClass("mfp-s-" + o),
            ...
            _setFocus: function () {
                (f.st.focus
                    ? f.content.find(f.st.focus).eq(0)
                    : f.wrap
                ).focus();
            },
            _onFocusIn: function (t) {
                return t.target === f.wrap[0] || h.contains(f.wrap[0], t.target)
                    ? void 0
                    : (f._setFocus(), !1);
            },
            ...
            (h.fn.magnificPopup = function (t) {
                ...
                return (
                    "string" == typeof t
                        ? "open" === t
                            ? ((e = a
                                  ? s.data("magnificPopup")
                                  : s[0].magnificPopup),
                              (i = parseInt(arguments[1], 10) || 0),
                              (o = e.items
                                  ? e.items[i]
                                  : ((o = s),
                                    e.delegate && (o = o.find(e.delegate)),
                                    o.eq(i))),
                              f._openClick({ mfpEl: o }, s, e))
                            : f.isOpen &&
                              f[t].apply(
                                  f,
        ...
        function C() {
            z && (T.after(z.addClass($)).detach(), (z = null));
        }
        var $,
            T,
            z,
                            ...
                            s.length
                                ? ((i = s[0].parentNode) &&
                                      ...
                                      (T ||
                                          ...
                                          (T = d($)),
                                          ($ = "mfp-" + $)),
                                      (z = s.after(T).detach().removeClass($))),
        ...
        function I() {
            k && h(document.body).removeClass(k);
        }
        function E() {
            I(), f.req && f.req.abort();
        }
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    o = {
                        width: e.width(),
                        height:
                            (a ? e.innerHeight() : e[0].offsetHeight) - t - o,
                    };
                    return (
                        void 0 === P &&
                            (P =
        ...
        function M(t) {
            var e;
            !f.currTemplate[A] ||
                ((e = f.currTemplate[A].find("iframe")).length &&
                ...
                initGallery: function () {
                    ...
                    return (
                        ...
                        !(!n || !n.enabled) &&
                            ...
                            c(v + t, function (t, e, i, o) {
                                var s = f.items.length;
                                i.counter =
                                    1 < s ? q(n.tCounter, o.index, s) : "";
                            }),
            ...
            proto: {
                initRetina: function () {
                    ...
                    1 < window.devicePixelRatio &&
                        ...
                        (o = i.ratio),
                        1 < (o = isNaN(o) ? o() : o) &&
                            (c("ImageHasSize." + D, function (t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / o,
                                    width: "100%",
                                });
                            }),
                            c("ElementParse." + D, function (t, e) {
        ...
        !(function () {
            ...
            function e(t, e) {
                ...
                return (
                    ...
                    this.s.dynamic
                        ...
                        : "" !== this.s.selector
                        ? this.s.selectWithin
                            ? (this.$items = f(this.s.selectWithin).find(
                                  this.s.selector
                              ))
                            : (this.$items = this.$el.find(f(this.s.selector)))
            ...
            (e.prototype.init = function () {
                ...
                0 < e.indexOf("lg=" + this.s.galleryId) &&
                    ...
                    f("body").addClass("lg-from-hash"),
                    f("body").hasClass("lg-on") ||
                        (setTimeout(function () {
                            t.build(t.index);
                        }),
                        f("body").addClass("lg-on"))),
                    t.s.dynamic
                ...
                (e.prototype.build = function (t) {
                    var e = this;
                    e.structure(),
                        f.each(f.fn.lightGallery.modules, function (t) {
                            e.modules[t] = new f.fn.lightGallery.modules[t](
                                e.el
                            );
                        }),
                        e.slide(t, !1, !1, !1),
                ...
                (e.prototype.structure = function () {
                    var t = "",
                        ...
                        s = this;
                    for (
                        f("body").append('<div class="lg-backdrop"></div>'),
                            f(".lg-backdrop").css(
                                "transition-duration",
                    ...
                    f("body").append(o),
                        ...
                        this.doCss() &&
                            ((o = this.$outer.find(".lg-inner")).css(
                                "transition-timing-function",
                                this.s.cssEasing
                            ),
                            o.css("transition-duration", this.s.speed + "ms")),
                        setTimeout(function () {
                ...
                (e.prototype.counter = function () {
                    this.s.counter &&
                        f(this.s.appendCounterTo).append(
                ...
                (e.prototype.loadContent = function (e, t, i) {
                        ...
                        if (
                            (d
                                ...
                                ? (h.$slide
                                  ...
                                  h.$el.trigger("hasVideo.lg", [e, a, r]))
                                : ((l = l ? 'alt="' + l + '"' : ""),
                                  h.$slide
                                      .eq(e)
                                      .prepend(
                    ...
                    h.$slide
                        ...
                        .on("load.lg error.lg", function () {
                            var t = 0;
                            i && !f("body").hasClass("lg-from-hash") && (t = i),
                                setTimeout(function () {
                ...
                (e.prototype.slide = function (t, e, i, o) {
                    ...
                    (c.lGalleryOn && h === t) ||
                        ((s = this.$slide.length),
                        (n = c.lGalleryOn ? this.s.speed : 0),
                        c.lgBusy ||
                            (this.s.download &&
                                ((r = c.s.dynamic
                                    ? !1 !== c.s.dynamicEl[t].downloadUrl &&
                                      (c.s.dynamicEl[t].downloadUrl ||
                                          c.s.dynamicEl[t].src)
                                    : "false" !==
                                          c.$items
                                              .eq(t)
                                      ...
                                      (c.$items
                                          .eq(t)
                                          .attr("data-download-url") ||
                                          c.$items.eq(t).attr("href") ||
                                          c.$items.eq(t).attr("data-src")))
                                    ? (f("#lg-download").attr("href", r),
                                      c.$outer.removeClass("lg-hide-download"))
                                    : c.$outer.addClass("lg-hide-download")),
                            ...
                            e
                                ? (this.$slide.removeClass(
                                  ...
                                  2 < s
                                      ...
                                      : ((a = 0), (l = 1)),
                                  "prev" === o
                                      ? c.$slide.eq(l).addClass("lg-next-slide")
                                      : c.$slide
                                            .eq(a)
                                            .addClass("lg-prev-slide"),
                                  c.$slide.eq(t).addClass("lg-current"))
                                : (c.$outer.addClass("lg-no-trans"),
                                  this.$slide.removeClass(
                                  ...
                                  "prev" === o
                                      ...
                                      : (this.$slide
                                        ...
                                        this.$slide
                                            ...
                                            .addClass("lg-prev-slide")),
                                  setTimeout(function () {
                                      c.$slide.removeClass("lg-current"),
                                          c.$slide.eq(t).addClass("lg-current"),
                                          c.$outer.removeClass("lg-no-trans");
                                  }, 50)),
                            c.lGalleryOn
                                ? (setTimeout(function () {
                                      c.loadContent(t, !0, 0);
                                ...
                                : (c.loadContent(t, !0, c.s.backdropDuration),
                                  (c.lgBusy = !1),
                                  c.$el.trigger("onAfterSlide.lg", [
                                      h,
                                      t,
                ...
                (e.prototype.keyPress = function () {
                    var e = this;
                    1 < this.$items.length &&
                        f(window).on("keyup.lg", function (t) {
                            1 < e.$items.length &&
                                (37 === t.keyCode &&
                ...
                (e.prototype.enableSwipe = function () {
                    ...
                    e.s.enableSwipe &&
                        ...
                        e.$slide.on("touchmove.lg", function (t) {
                            e.$outer.hasClass("lg-zoomed") ||
                                (t.preventDefault(),
                                (o = t.originalEvent.targetTouches[0].pageX),
                                e.touchMove(i, o),
                                (s = !0));
                        }),
                    ...
                    e.s.enableDrag &&
                        ...
                        f(window).on("mouseup.lg", function (t) {
                            n
                                ...
                                : (f(t.target).hasClass("lg-object") ||
                                      f(t.target).hasClass("lg-video-play")) &&
                                  e.$el.trigger("onSlideClick.lg"),
                                s &&
                                    ((s = !1),
                                    e.$outer
                    ...
                    this.$outer.find(".lg-close").on("click.lg", function () {
                        ...
                        e.s.closable &&
                            (e.$outer.on("mousedown.lg", function (t) {
                                i = !!(
                                    f(t.target).is(".lg-outer") ||
                                    f(t.target).is(".lg-item ") ||
                                    f(t.target).is(".lg-img-wrap")
                                );
                            }),
                ...
                (e.prototype.destroy = function (t) {
                    ...
                    t ||
                        ...
                        f(window).scrollTop(e.prevScrollTop)),
                        t &&
                            (e.s.dynamic ||
                                this.$items.off("click.lg click.lgcustom"),
                            f.removeData(e.el, "lightGallery")),
                        this.$el.off(".lg.tm"),
                        f.each(f.fn.lightGallery.modules, function (t) {
                        ...
                        (this.hideBarTimeout = !1),
                        f(window).off(".lg"),
                        f("body").removeClass("lg-on lg-from-hash"),
                        e.$outer && e.$outer.removeClass("lg-visible"),
                        f(".lg-backdrop").removeClass("in"),
                        setTimeout(function () {
                            e.$outer && e.$outer.remove(),
                                f(".lg-backdrop").remove(),
    ...
    (function (t) {
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t = i.core.$outer.find(".lg-pager-outer")).html(s),
                    (o = i.core.$outer.find(".lg-pager-cont")).on(
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.build = function () {
                    ...
                    function e(t, e, i) {
                        var o,
                            t = s.core.isVideo(t, i) || {},
                            i = "";
                        t.youtube || t.vimeo || t.dailymotion
                            ? t.youtube
                                ? (o = s.core.s.loadYoutubeThumbnail
                                      ? "//img.youtube.com/vi/" +
                                        t.youtube[1] +
                                        "/" +
                                ...
                                ? s.core.s.loadVimeoThumbnail
                                    ...
                                    : (o = e)
                                : t.dailymotion &&
                                  (o = s.core.s.loadDailymotionThumbnail
                    ...
                    if (
                        ...
                        this.core.s.animateThumb &&
                            s.$thumbOuter.css(
                                "height",
                                s.core.s.thumbContHeight + "px"
                            ),
                        s.core.s.dynamic)
                    )
                        for (var i = 0; i < s.core.s.dynamicEl.length; i++)
                            e(
                                s.core.s.dynamicEl[i].src,
                                s.core.s.dynamicEl[i].thumb,
                                i
                            );
                    else
                        s.core.$items.each(function (t) {
                            s.core.s.exThumbImage
                                ? e(
                                      a(this).attr("href") ||
                                          a(this).attr("data-src"),
                                      a(this).attr(s.core.s.exThumbImage),
                                      t
                                  )
                                : e(
                                      a(this).attr("href") ||
                    ...
                    s.core.$outer.find(".lg-thumb").html(n),
                        (t = s.core.$outer.find(".lg-thumb-item")).each(
                            function () {
                                var e = a(this),
                                ...
                                t &&
                                    a.getJSON(
                                        ...
                                        function (t) {
                                            e.find("img").attr(
                                                "src",
                                                t[0][s.core.s.vimeoThumbSize]
                                            );
                                        }
                                    );
                            }
                        ),
                        t.eq(s.core.index).addClass("active"),
                        ...
                        t.on("click.lg touchend.lg", function () {
                            var t = a(this);
                            setTimeout(function () {
                                ((!s.thumbClickable || s.core.lgBusy) &&
                                    s.core.doCss()) ||
                    ...
                    e.$thumbOuter.addClass("lg-grab"),
                        ...
                        a(window).on("mousemove.lg.thumb", function (t) {
                            s &&
                                ...
                                (r -= o - i) >
                                    e.thumbTotalWidth - e.thumbOuterWidth &&
                                    (r = e.thumbTotalWidth - e.thumbOuterWidth),
                                r < 0 && (r = 0),
                                e.setTranslate(r));
                        }),
                        a(window).on("mouseup.lg.thumb", function () {
                            n
                                ? ((n = !1),
                                  ...
                                  (e.left = r),
                                  Math.abs(o - i) < e.core.s.swipeThreshold &&
                                      (e.thumbClickable = !0))
                                : (e.thumbClickable = !0),
                                s &&
                                    ((s = !1),
                    ...
                    function (t, e, i, o) {
                        ...
                        if (
                            (s.core.$slide
                                .eq(e)
                                .find(".lg-video")
                                .append(s.loadVideo(i, "lg-object", !0, e, o)),
                            o)
                        )
                            if (s.core.s.videojs)
                                try {
                    ...
                    o.core.$el.on(
                        ...
                        function (t, e, i) {
                            ...
                            if (n)
                                ...
                                a.contentWindow.postMessage("pause", "*");
                            else if (l)
                                if (o.core.s.videojs)
                                    try {
                                        videojs(l).pause();
                            ...
                            e = o.core.s.dynamic
                                ...
                                : o.core.$items.eq(i).attr("href") ||
                                  o.core.$items.eq(i).attr("data-src");
                            i = o.core.isVideo(e, i) || {};
                            (i.youtube || i.vimeo || i.dailymotion || i.vk) &&
                                o.core.$outer.addClass("lg-hide-download");
                        }.bind(this)
                    ),
                    o.core.$el.on("onAfterSlide.lg.tm", function (t, e) {
                ...
                (t.prototype.loadVideoOnclick = function (i) {
                    ...
                    if (
                        ...
                        if (i.hasClass("lg-has-video")) {
                            ...
                            o.core.s.dynamic
                                ? s(
                                      o.core.s.dynamicEl[o.core.index].src,
                                      o.core.s.dynamicEl[o.core.index].html
                                  )
                                : s(
                                      o.core.$items
                                          .eq(o.core.index)
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                function r() {
                    1 < a ? n.core.$outer.addClass("lg-zoomed") : n.resetZoom(),
                        a < 1 && (a = 1),
                        e(a);
                }
                function o(t, e, i, o) {
                ...
                (t.prototype.getPossibleDragCords = function (t, e) {
                    ...
                    return 90 === e
                        ? { minY: s, maxY: t, minX: i, maxX: o }
                        : { minY: i, maxY: o, minX: s, maxX: t };
                }),
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    s.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        s.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            (c = s.getCurrentRotation(o)),
                            (e = s.getDragAllowedAxises(e, Math.abs(c))),
                            (h = e.allowY),
                            ((l = e.allowX) || h) &&
                                (t.preventDefault(),
                                (n = s.getSwipeCords(t, Math.abs(c)))));
                    }),
                        s.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            s.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                t.preventDefault(),
                                (a = !0),
                                (r = s.getSwipeCords(t, Math.abs(c))),
                                s.core.$outer.addClass("lg-zoom-dragging"),
                                (i = h
                                    ? -Math.abs(e.attr("data-y")) +
                                      (r.y - n.y) * s.getModifier(c, "Y", o)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = l
                                    ? -Math.abs(e.attr("data-x")) +
                                      (r.x - n.x) * s.getModifier(c, "X", o)
                                    : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(r.x - n.x) ||
                                    15 < Math.abs(r.y - n.y)) &&
                ...
                (t.prototype.zoomDrag = function () {
                    ...
                    s.core.$slide.on("mousedown.lg.zoom", function (t) {
                        (o = s.core.$slide
                            .eq(s.core.index)
                            .find(".lg-img-rotate")[0]),
                            (d = s.getCurrentRotation(o));
                        var e = s.core.$slide
                                .eq(s.core.index)
                                .find(".lg-object"),
                            e = s.getDragAllowedAxises(e, Math.abs(d));
                        (c = e.allowY),
                            (h = e.allowX),
                            s.core.$outer.hasClass("lg-zoomed") &&
                        ...
                        u(window).on("mousemove.lg.zoom", function (t) {
                            ...
                            a &&
                                ((e = s.core.$slide
                                    ...
                                    .find(".lg-img-wrap")),
                                (l = !0),
                                (r = s.getDragCords(t, Math.abs(d))),
                                s.core.$outer.addClass("lg-zoom-dragging"),
                                (i = c
                                    ? -Math.abs(e.attr("data-y")) +
                                      (r.y - n.y) * s.getModifier(d, "Y", o)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = h
                                    ? -Math.abs(e.attr("data-x")) +
                                      (r.x - n.x) * s.getModifier(d, "X", o)
                                    : -Math.abs(e.attr("data-x"))),
                                s.core.s.useLeftForZoom
                ...
                (t.prototype.touchendZoom = function (t, e, i, o, s) {
                    var n = this,
                        ...
                        h =
                            ...
                            (e.x - t.x) * n.getModifier(s, "X", l),
                        l =
                            -Math.abs(r.attr("data-y")) +
                            (e.y - t.y) * n.getModifier(s, "Y", l),
                    ...
                    (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
                        ...
                        i &&
                            (h <= -s.maxX
                                ...
                                : h >= -s.minX && (h = -s.minX)),
                        o
                            ? r.attr("data-y", Math.abs(l))
                            : (l = -Math.abs(r.attr("data-y"))),
                        i
                            ? r.attr("data-x", Math.abs(h))
                            : (h = -Math.abs(r.attr("data-x"))),
                        n.core.s.useLeftForZoom
                            ? r.css({ left: h + "px", top: l + "px" })
                            : r.css(
                                  "transform",
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t += o.core.s.facebook
                    ...
                    s("#lg-dropdown-overlay").on("click.lg", function () {
                        o.core.$outer.removeClass("lg-dropdown-active"),
                            s("#lg-share").attr("aria-expanded", !1);
                    }),
                    o.core.$el.on("onAfterSlide.lg.tm", function (t, e, i) {
                        setTimeout(function () {
                            s("#lg-share-facebook").attr(
                                "href",
                                ...
                                s("#lg-share-twitter").attr(
                                    "href",
                                    "https://twitter.com/intent/tweet?text=" +
                                        o.getSahreProps(i, "tweetText") +
                                        "&url=" +
                                        encodeURIComponent(
                                            o.getSahreProps(
                                                i,
                                ...
                                s("#lg-share-pinterest").attr(
                                    ...
                                    "http://www.pinterest.com/pin/create/button/?url=" +
                                        ...
                                        "&media=" +
                                        encodeURIComponent(
                                            o.getSahreProps(i, "src")
                                        ) +
                                        "&description=" +
                                        o.getSahreProps(i, "pinterestText")
                                );
                        }, 100);
                    });
            }),
                ...
                (t.prototype.destroy = function () {}),
                (s.fn.lightGallery.modules.share = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
    ...
    (function (t) {
        ...
        function e(t) {
            ...
            if (
                ...
                "deltaX" in i && ((n = i.deltaX), 0 === r && (s = -1 * n)),
                0 !== r || 0 !== n)
            ) {
                1 === i.deltaMode
                    ? ((s *= e = c.data(this, "mousewheel-line-height")),
                      (r *= e),
                      (n *= e))
                    : 2 === i.deltaMode &&
                      ((s *= e = c.data(this, "mousewheel-page-height")),
                      (r *= e),
                      (n *= e));
                var a = Math.max(Math.abs(r), Math.abs(n));
                return (
                    (f && !(a < f)) || (u(i, (f = a)) && (f /= 40)),
                    u(i, a) && ((s /= 40), (n /= 40), (r /= 40)),
                    ...
                    p && clearTimeout(p),
                    (p = setTimeout(d, 200)),
                    (c.event.dispatch || c.event.handle).apply(this, o)
                );
            }
        }
        function d() {
        ...
        if (c.event.fixHooks)
            for (var o = t.length; o; )
                c.event.fixHooks[t[--o]] = c.event.mouseHooks;
        ...
        function g(t) {
            if (
                (b ||
                    ...
                    (c = f(u)),
                    (g.isBoxSizeOuter = m = 200 == p(c.width)),
                    d.removeChild(u)),
                ...
                for (
                    var o = (i.isBorderBox = "border-box" == e.boxSizing),
                        s = 0;
                    s < v;
                    s++
                ) {
                        ...
                        t.forEach(function (t) {
                            if (t instanceof HTMLElement)
                                if (o) {
                                    n(t, o) && s.push(t);
                                    for (
                                        var e = t.querySelectorAll(o), i = 0;
                                        i < e.length;
                                        i++
                                    )
                                        s.push(e[i]);
            ...
            (h.htmlInit = function (a, l) {
                h.docReady(function () {
                    var t = h.toDashed(l),
                        ...
                        t = h.makeArray(e).concat(h.makeArray(t)),
                        n = s + "-options",
                        r = i.jQuery;
    ...
    (function (t, e) {
        ...
        (t.constructor = i),
            ...
            (t.layoutPosition = function () {
                ...
                (e[n] = this.getXValue(s)), (e[i] = "");
                (s = o ? "paddingTop" : "paddingBottom"),
                    (i = o ? "top" : "bottom"),
                    (o = o ? "bottom" : "top"),
                    (s = this.position.y + t[s]);
                (e[i] = this.getYValue(s)),
                    (e[o] = ""),
                    this.css(e),
            ...
            (t._transitionTo = function (t, e) {
                ...
                this.setPosition(t, e),
                    !n || this.isTransitioning
                        ? ((i = t - i),
                          (e -= o),
                          ((o = {}).transform = this.getTranslate(i, e)),
                          this.transition({
                              to: o,
                              onTransitionEnd: {
            ...
            (s.getSegmentSize = function (t, e) {
                ...
                this._getMeasurement(i, o),
                    this[i] ||
                        ...
                        (this[i] =
                            (t && t[o]) || this.isotope.size["inner" + e]));
            }),
        ...
        return (
            ...
            (t.measureColumns = function () {
                this.getContainerWidth(),
                    this.columnWidth ||
                        ...
                        (this.columnWidth =
                            (i && a(i).outerWidth) || this.containerWidth));
            ...
            (t._getItemLayoutPosition = function (t) {
                ...
                for (
                    var e = t.size.outerWidth % this.columnWidth,
                        ...
                        e = { x: this.columnWidth * o.col, y: o.y },
            ...
            (t._manageStamp = function (t) {
                ...
                for (
                    ...
                    this.colYs[r] = Math.max(n, this.colYs[r]);
            }),
            ...
            (s._bindArrangeComplete = function () {
                function t() {
                    e &&
                        i &&
                        o &&
                        s.dispatchEvent("arrangeComplete", null, [
                            s.filteredItems,
                        ]);
                }
                var e,
            ...
            (s.insert = function (t) {
                ...
                if (e.length) {
                    for (var i, o = e.length, s = 0; s < o; s++)
                        (i = e[s]), this.element.appendChild(i.element);
                    t = this._filter(e).matches;
                    for (s = 0; s < o; s++) e[s].isLayoutInstant = !0;
                    for (this.arrange(), s = 0; s < o; s++)
