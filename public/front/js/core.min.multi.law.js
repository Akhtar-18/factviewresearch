    ...
    (function (h, e) {
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if (
                    (e.wrap(
                        h("<div/>", { class: "owl-video-wrapper", style: n })
                    ),
                    this._core.settings.lazyLoad &&
                ...
                (t = {
                    ...
                    for (n in this.waypoints[e]) {
                        ...
                        l.element !== l.element.window &&
                            ...
                            (l.triggerPoint = Math.floor(d + a - c)),
                            (a = h < r.oldScroll),
            ...
            proto: {
                initRetina: function () {
                    ...
                    1 < window.devicePixelRatio &&
                        ...
                        (s = i.ratio),
                        1 < (s = isNaN(s) ? s() : s) &&
                            (h("ImageHasSize." + D, function (t, e) {
                                e.img.css({
                                    "max-width": e.img[0].naturalWidth / s,
                                    width: "100%",
                                });
                            }),
                            h("ElementParse." + D, function (t, e) {
        ...
        !(function () {
            ...
            (e.prototype.init = function () {
                ...
                (e.prototype.slide = function (t, e, i, s) {
                    ...
                    (h.lGalleryOn && c === t) ||
                        ((o = this.$slide.length),
                        (n = h.lGalleryOn ? this.s.speed : 0),
                        h.lgBusy ||
                            (this.s.download &&
                                ((r = h.s.dynamic
                                    ? !1 !== h.s.dynamicEl[t].downloadUrl &&
                                      (h.s.dynamicEl[t].downloadUrl ||
                                          h.s.dynamicEl[t].src)
                                    : "false" !==
                                          h.$items
                                              .eq(t)
                                    ...
                                    : h.$outer.addClass("lg-hide-download")),
                            ...
                            e
                                ? (this.$slide.removeClass(
                                  ...
                                  2 < o
                                      ...
                                      : ((a = 0), (l = 1)),
                                  "prev" === s
                                      ? h.$slide.eq(l).addClass("lg-next-slide")
                                      : h.$slide
                                            .eq(a)
                                            .addClass("lg-prev-slide"),
                                  h.$slide.eq(t).addClass("lg-current"))
                                : (h.$outer.addClass("lg-no-trans"),
                                  this.$slide.removeClass(
                                  ...
                                  "prev" === s
                                      ...
                                      : (this.$slide
                                        ...
                                        this.$slide
                                            ...
                                            .addClass("lg-prev-slide")),
                                  setTimeout(function () {
                                      h.$slide.removeClass("lg-current"),
                                          h.$slide.eq(t).addClass("lg-current"),
                            ...
                            h.lGalleryOn
                                ...
                                : (h.loadContent(t, !0, h.s.backdropDuration),
                                  (h.lgBusy = !1),
                                  h.$el.trigger("onAfterSlide.lg", [
                                      c,
                                      t,
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    o.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        o.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            ((l = e.allowX) || c) &&
                                (t.preventDefault(),
                                (n = o.getSwipeCords(t, Math.abs(h)))));
                    }),
                        o.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            o.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                t.preventDefault(),
                                (a = !0),
                                (r = o.getSwipeCords(t, Math.abs(h))),
    ...
    (function (t) {
        ...
        function e(t) {
            ...
            if (
                ...
                1 === i.deltaMode
                    ? ((o *= e = h.data(this, "mousewheel-line-height")),
                      (r *= e),
                      (n *= e))
                    : 2 === i.deltaMode &&
                      ((o *= e = h.data(this, "mousewheel-page-height")),
                      (r *= e),
                      (n *= e));
        ...
        var m = (h.event.special.mousewheel = {
            ...
            setup: function () {
                ...
                h.data(this, "mousewheel-line-height", m.getLineHeight(this)),
                    h.data(
                        this,
