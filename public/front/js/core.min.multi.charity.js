!(function (s) {
            ...
            easyResponsiveTabs: function (l) {
                ...
                g(this).on("bind", "tabactivate", function (t, e) {
                    ...
                    this.each(function () {
                        ...
                        "" == u ||
                            (null !==
                                (r = u.match(new RegExp(o + "([0-9]+)"))) &&
                                2 === r.length &&
                                ((a = parseInt(r[1], 10) - 1),
                                e < a && (a = 0))),
                            g(s.find(".resp-tab-item." + l.tabidentify)[a])
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (o && (a = parseFloat((i / e) * r).toFixed(n)),
                                s)
                            )
    ...
    (function (g, o, t, f) {
        ...
        (c.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = o),
                    ...
                    (this.$viewportElement =
                        this.options.viewportElement !== f
                                ...
                                p.options.showElement(l),
                                    ...
                                    (s =
                                        ...
                                        f
                                            ...
                                            : p.horizontalOffset),
                                    (o =
                                        l.data("stellar-vertical-offset") !== f
                            ...
                            n.data("stellar-backgroundStartingLeft")
                                ...
                                n.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (a = c), (l = d), (o = t), !1;
                                    (c += t.position().left),
                                        (d += t.position().top);
                                }),
                                (t =
                                    n.data("stellar-horizontal-offset") !== f
                                        ...
                                        : h.horizontalOffset),
                                (e =
                                    n.data("stellar-vertical-offset") !== f
                                        ? n.data("stellar-vertical-offset")
                                        : o !== f &&
                                ...
                                h.backgrounds.push({
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        n.data("stellar-background-ratio") === f
                                            ? 1
                                            : n.data(
            ...
            _reset: function () {
                ...
                for (o = this.backgrounds.length - 1; 0 <= o; o--)
                    (s = this.backgrounds[o]).$element
                        ...
                        m(s.$element, s.startingValueLeft, s.startingValueTop);
            },
            destroy: function () {
                this._reset(),
                    this.$scrollElement
            ...
            (g.fn[s] = function (e) {
                var i = arguments;
                return e === f || "object" == typeof e
                    ? this.each(function () {
                          g.data(this, "plugin_" + s) ||
                              g.data(this, "plugin_" + s, new c(this, e));
                      })
            ...
            (i.prototype.handleScroll = function () {
                ...
                for (t in s) {
                    ...
                    for (o in this.waypoints[t]) {
                        ...
                        null !== c.triggerPoint &&
                            ((a = n.oldScroll < c.triggerPoint),
                            (l = n.newScroll >= c.triggerPoint),
                            ((a && l) || (!a && !l)) &&
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var s = 0, o = e.length; s < o; s += 1) {
                        var n = e[s];
                        (!n.options.continuous && s !== e.length - 1) ||
                            n.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
            ...
            return function () {
                ...
                return (
                    s.isFunction(arguments[0]) &&
                        ((i = s.extend({}, arguments[1])).handler =
                            arguments[0]),
                    this.each(function () {
    ...
    (function (t) {
        ...
        function h(t, e, i, s) {
            ...
            return (
                (o.className = "mfp-" + t),
                i && (o.innerHTML = i),
                s ? e && e.appendChild(o) : ((o = c(o)), e && o.appendTo(e)),
                o
            );
        }
        function u(t, e) {
            g.ev.triggerHandler("mfp" + t, e),
                g.st.callbacks &&
                    ...
                    g.st.callbacks[t] &&
                        g.st.callbacks[t].apply(g, c.isArray(e) ? e : [e]));
        }
        function p(t) {
            return (
        ...
        function n() {
            c.magnificPopup.instance ||
                ((g = new t()).init(), (c.magnificPopup.instance = g));
        }
        var g,
            s,
            f,
        ...
        (t.prototype = {
            ...
            open: function (t) {
                if (!1 === t.isObj) {
                    ...
                    (g.items = c.isArray(t.items) ? t.items : [t.items]),
                        (g.index = t.index || 0);
                if (!g.isOpen) {
                    (g.types = []),
                        (m = ""),
                        ...
                        t.key
                            ...
                            : (g.currTemplate = {}),
                        (g.st = c.extend(!0, {}, c.magnificPopup.defaults, t)),
                        (g.fixedContentPos =
                        ...
                        g.bgOverlay ||
                            ...
                            (g.container = h("container", g.wrap))),
                        (g.contentContainer = h("content")),
                        g.st.preloader &&
                            (g.preloader = h(
                                "preloader",
                                g.container,
                    ...
                    u("BeforeOpen"),
                        ...
                        g.st.enableEscapeKey &&
                            f.on("keyup" + w, function (t) {
                                27 === t.keyCode && g.close();
                            }),
                        _.on("resize" + w, function () {
                            g.updateSize();
                        }),
                        g.st.closeOnContentClick || (m += " mfp-auto-cursor"),
                        m && g.wrap.addClass(m);
                    var r = (g.wH = _.height()),
                        a = {};
                    g.fixedContentPos &&
                    ...
                    return (
                        ...
                        g.bgOverlay
                            .add(g.wrap)
                            .prependTo(g.st.prependTo || c(document.body)),
                        (g._lastFocusedEl = document.activeElement),
                        setTimeout(function () {
                            g.content
                                ? (g._addClassToMFP(x), g._setFocus())
                                : g.bgOverlay.addClass(x),
                                f.on("focusin" + w, g._onFocusIn);
                        }, 16),
                        (g.isOpen = !0),
                        g.updateSize(r),
                        u(b),
            ...
            _openClick: function (t, e, i) {
                if (
                    (void 0 !== i.midClick ? i : c.magnificPopup.defaults)
                        .midClick ||
                    !(
                        2 === t.which ||
                        t.ctrlKey ||
                    ...
                    var s = (
                        void 0 !== i.disableOn ? i : c.magnificPopup.defaults
                    ).disableOn;
                    if (s)
                        if (c.isFunction(s)) {
            ...
            _hasScrollBar: function (t) {
                return (
                    (g.isIE7 ? f.height() : document.body.scrollHeight) >
                    (t || _.height())
                );
            },
            _setFocus: function () {
            ...
            _onFocusIn: function (t) {
                return t.target === g.wrap[0] || c.contains(g.wrap[0], t.target)
                    ? void 0
                    : (g._setFocus(), !1);
            },
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    ...
                    s = {
                        width: e.width(),
                        height:
                            (a ? e.innerHeight() : e[0].offsetHeight) - t - s,
                    };
                    return (
                        void 0 === A &&
                            (A =
        ...
        function M(t) {
            var e;
            !g.currTemplate[L] ||
                ((e = g.currTemplate[L].find("iframe")).length &&
                    ...
                    var s,
                        ...
                        u = c.s.dynamic
                            ? (c.s.dynamicEl[e].poster &&
                                  ((d = !0), (o = c.s.dynamicEl[e].poster)),
                              (r = c.s.dynamicEl[e].html),
                              (a = c.s.dynamicEl[e].src),
                              (l = c.s.dynamicEl[e].alt),
                              c.s.dynamicEl[e].responsive &&
                                  h(c.s.dynamicEl[e].responsive.split(",")),
                              (n = c.s.dynamicEl[e].srcset),
                            ...
                            : ((p = c.$items.eq(e)).attr("data-poster") &&
                              ...
                              p.attr("data-responsive") &&
                                  h(p.attr("data-responsive").split(",")),
                        ...
                        if (
                            (h
                                ...
                                ? (c.$slide
                                  ...
                                  c.$el.trigger("hasVideo.lg", [e, a, r]))
                                : ((l = l ? 'alt="' + l + '"' : ""),
                                  c.$slide
                                      .eq(e)
                                      .prepend(
                        ...
                        o.core.$items.each(function (t) {
                            o.core.s.exThumbImage
                                ? e(
                                      ...
                                      a(this).attr(o.core.s.exThumbImage),
                                      t
                                  )
                                : e(
                                      a(this).attr("href") ||
            ...
            (t.prototype.init = function () {
                    ...
                    o.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        o.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            o.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                t.preventDefault(),
                                (a = !0),
                                (r = o.getSwipeCords(t, Math.abs(d))),
                                o.core.$outer.addClass("lg-zoom-dragging"),
                                (i = c
                                    ? -Math.abs(e.attr("data-y")) +
                                      (r.y - n.y) * o.getModifier(d, "Y", s)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = l
                                    ? -Math.abs(e.attr("data-x")) +
                                      (r.x - n.x) * o.getModifier(d, "X", s)
                                    : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(r.x - n.x) ||
                                    15 < Math.abs(r.y - n.y)) &&
                ...
                (t.prototype.zoomDrag = function () {
                    ...
                    o.core.$slide.on("mousedown.lg.zoom", function (t) {
                        (s = o.core.$slide
                            .eq(o.core.index)
                            .find(".lg-img-rotate")[0]),
                            (h = o.getCurrentRotation(s));
                        var e = o.core.$slide
                                .eq(o.core.index)
                                .find(".lg-object"),
                            e = o.getDragAllowedAxises(e, Math.abs(h));
                        (d = e.allowY),
                            (c = e.allowX),
                            o.core.$outer.hasClass("lg-zoomed") &&
                        ...
                        u(window).on("mousemove.lg.zoom", function (t) {
                            ...
                            a &&
                                ((e = o.core.$slide
                                    ...
                                    .find(".lg-img-wrap")),
                                (l = !0),
                                (r = o.getDragCords(t, Math.abs(h))),
                                o.core.$outer.addClass("lg-zoom-dragging"),
                                (i = d
                                    ? -Math.abs(e.attr("data-y")) +
                                      (r.y - n.y) * o.getModifier(h, "Y", s)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = c
                                    ? -Math.abs(e.attr("data-x")) +
                                      (r.x - n.x) * o.getModifier(h, "X", s)
                                    : -Math.abs(e.attr("data-x"))),
                                o.core.s.useLeftForZoom
                ...
                (t.prototype.touchendZoom = function (t, e, i, s, o) {
                    ...
                    (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
                        ...
                        i
                            ? r.attr("data-x", Math.abs(c))
                            : (c = -Math.abs(r.attr("data-x"))),
                        n.core.s.useLeftForZoom
                            ? r.css({ left: c + "px", top: l + "px" })
                            : r.css(
                                  "transform",
    ...
    (function (t) {
        ...
        function e(t) {
            ...
            if (
                ...
                "deltaX" in i && ((n = i.deltaX), 0 === r && (o = -1 * n)),
                0 !== r || 0 !== n)
            ) {
                1 === i.deltaMode
