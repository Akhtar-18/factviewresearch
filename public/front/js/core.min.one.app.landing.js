!(function (o) {
    ...
    o.scrollIt = function (t) {
        function e(t) {
            t < 0 ||
                i < t ||
                ((t =
                    o("[data-scroll-index=" + t + "]").offset().top +
                    s.topOffset +
                    1),
                o("html,body").animate(
        ...
        var s = o.extend(r, t),
            n = 0,
            i = o("[data-scroll-index]:last").attr("data-scroll-index");
        o(window)
            .on("scroll", function () {
                var i = o(window).scrollTop(),
                    t = o("[data-scroll-index]")
                        .filter(function (t, e) {
                            return (
                                i >= o(e).offset().top + s.topOffset &&
                                i <
                                    o(e).offset().top +
                                        s.topOffset +
                                        o(e).outerHeight()
                ...
                (t = t),
                    s.onPageChange && t && n != t && s.onPageChange(t),
                    (n = t),
                    o("[data-scroll-nav]").removeClass(s.activeClass),
                    o("[data-scroll-nav=" + t + "]").addClass(s.activeClass);
            })
            .scroll(),
            o(window).on("keydown", function (t) {
                t = t.which;
                return (
                    (!o("html,body").is(":animated") ||
    ...
    jQuery(document).ready(function (r) {
        ...
        function u(t) {
            var e,
                i,
                s = m(t);
            t.parents(".banner-headline").hasClass("type")
                ? ((e = t.parent(".banner-words-wrapper"))
                      .addClass("selected")
                      .removeClass("waiting"),
                  setTimeout(function () {
                ...
                : t.parents(".banner-headline").hasClass("letters")
                ? ((i = t.children("i").length >= s.children("i").length),
                  (function t(e, i, s, n) {
                  ...
                  g(s.find("i").eq(0), s, i, n))
                : t.parents(".banner-headline").hasClass("clip")
                ? t
                      .parents(".banner-words-wrapper")
                      .animate({ width: "2px" }, d, function () {
                          v(t, s), f(s);
                      })
                : t.parents(".banner-headline").hasClass("loading-bar")
                ? (t.parents(".banner-words-wrapper").removeClass("is-loading"),
                  v(t, s),
                  setTimeout(function () {
                      u(s);
                  }, o),
                  setTimeout(function () {
                      t.parents(".banner-words-wrapper").addClass("is-loading");
                  }, l))
                : (v(t, s),
                  setTimeout(function () {
                      u(s);
        ...
        function g(t, e, i, s) {
            t.addClass("in").removeClass("out"),
                t.is(":last-child")
                    ? (e.parents(".banner-headline").hasClass("type") &&
                          setTimeout(function () {
                              e.parents(".banner-words-wrapper").addClass(
                                  "waiting"
                              );
                          }, 200),
                      i ||
            ...
            (function (t) {
                ...
                t.each(function () {
                    var t,
                        ...
                        i,
                        s = r(this);
                    s.hasClass("loading-bar")
                        ? ((n = o),
                          setTimeout(function () {
                              s.find(".banner-words-wrapper").addClass(
                                  "is-loading"
                              );
                          }, l))
                        : s.hasClass("clip")
                        ? ((e =
                              (t = s.find(".banner-words-wrapper")).width() +
                              10),
                          t.css("width", e))
                        : s.hasClass("type") ||
                          ((e = s.find(".banner-words-wrapper b")),
                          (i = 0),
                          e.each(function () {
                              var t = r(this).width();
                              i < t && (i = t);
                          }),
                          s.find(".banner-words-wrapper").css("width", i)),
                        setTimeout(function () {
                            u(s.find(".is-visible").eq(0));
                        }, n);
                });
            })(r(".banner-headline"));
    }),
        ...
        (c.prototype.extend = function (t, e) {
            ...
            (i =
                ...
                ((h.prototype.get = function (t) {
                    for (
                        var e, i, s = (e = 0), n = (i = this.keys).length;
                        e < n;
                        s = ++e
                    )
                ...
                (h.prototype.set = function (t, e) {
                    for (
                        var i, s, n = (i = 0), o = (s = this.keys).length;
                        i < o;
                        n = ++i
                    )
            ...
            (this.WOW =
                ...
                (o.prototype.resetStyle = function () {
                    for (
                        var t, e, i = [], s = 0, n = (e = this.boxes).length;
                        s < n;
                        s++
                    )
    ...
    (function (t) {
        ...
        function p(t, e, i, s) {
            ...
            return (
                (n.className = "mfp-" + t),
                i && (n.innerHTML = i),
                s ? e && e.appendChild(n) : ((n = h(n)), e && n.appendTo(e)),
                n
            );
        }
        function d(t, e) {
        ...
        (t.prototype = {
                ...
                if (!f.isOpen) {
                    (f.types = []),
                        ...
                        f.bgOverlay ||
                            ...
                            (f.container = p("container", f.wrap))),
                        (f.contentContainer = p("content")),
                        f.st.preloader &&
                            (f.preloader = p(
                                "preloader",
                                f.container,
            ...
            updateItemHTML: function () {
                ...
                d("BeforeChange", [f.currItem ? f.currItem.type : "", e]),
                    ...
                    n &&
                        n !== t.type &&
                        f.container.removeClass("mfp-" + n + "-holder");
                            ...
                            n.length
                                ? ((i = n[0].parentNode) &&
                                      ...
                                      (S ||
                                          ...
                                          (S = p(T)),
                                          (T = "mfp-" + T)),
                                      (z = n.after(S).detach().removeClass(T))),
                                  f.updateStatus("ready"))
                                : (f.updateStatus("error", s.tNotFound),
                                  (n = h("<div>"))),
                            (t.inlineElement = n)
                        );
                    }
                ...
                l.waypoint(
                    function () {
                        for (
                            ...
                            if (
                                (n && (a = parseFloat((i / e) * r).toFixed(o)),
                                s)
                            )
        ...
        (h.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = n),
                    ...
                    (this.$element =
                        this.element === n ? f("body") : this.$scrollElement),
                            ...
                            o.data("stellar-backgroundStartingLeft")
                                ...
                                o.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (a = h), (l = c), (n = t), !1;
                                    (h += t.position().left),
                                        (c += t.position().top);
                                }),
                                (t =
                                    o.data("stellar-horizontal-offset") !== g
                                        ...
                                        : p.horizontalOffset),
                                (e =
                                    o.data("stellar-vertical-offset") !== g
                                        ? o.data("stellar-vertical-offset")
                                        : n !== g &&
                                ...
                                p.backgrounds.push({
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        o.data("stellar-background-ratio") === g
                                            ? 1
                                            : o.data(
            ...
            _reset: function () {
                for (var t, e, i, s, n = this.particles.length - 1; 0 <= n; n--)
                    (e = (t = this.particles[n]).$element.data(
                        "stellar-startingLeft"
                    )),
            ...
            (f.fn[s] = function (e) {
                ...
                return e === g || "object" == typeof e
                    ? this.each(function () {
                          f.data(this, "plugin_" + s) ||
                              f.data(this, "plugin_" + s, new h(this, e));
                      })
                    : "string" == typeof e && "_" !== e[0] && "init" !== e
                    ? this.each(function () {
                          var t = f.data(this, "plugin_" + s);
                          t instanceof h &&
                              "function" == typeof t[e] &&
                              t[e].apply(t, Array.prototype.slice.call(i, 1)),
                              "destroy" === e &&
                                  f.data(this, "plugin_" + s, null);
                      })
                    : void 0;
            }),
            (f[s] = function (t) {
            ...
            (f[s].scrollProperty = a),
            (f[s].positionProperty = l),
            (n.Stellar = h);
    ...
    (function () {
        ...
        function i(t) {
            (this.element = t),
                ...
                (s += 1),
                u.windowContext ||
                    ((u.windowContext = !0), (u.windowContext = new i(window))),
        ...
        (i.prototype.add = function (t) {
            ...
            (i.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on("resize.waypoints", function () {
                    e.didResize ||
                        ((e.didResize = !0), u.requestAnimationFrame(t));
                });
            }),
            (i.prototype.createThrottledScrollHandler = function () {
                ...
                this.adapter.on("scroll.waypoints", function () {
                    (e.didScroll && !u.isTouch) ||
                        ((e.didScroll = !0), u.requestAnimationFrame(t));
                });
            }),
                ...
                (t = {
                    ...
                    for (o in this.waypoints[e]) {
                        ...
                        l.element !== l.element.window &&
                            (p = l.adapter.offset()[r.offsetProp]),
                            "function" == typeof h
                                ? (h = h.apply(l))
                                : "string" == typeof h &&
                                  ((h = parseFloat(h)),
            ...
            (e.prototype.flushTriggers = function () {
                for (var t in this.triggerQueues) {
                    ...
                    for (var s = 0, n = e.length; s < n; s += 1) {
                        var o = e[s];
                        (!o.options.continuous && s !== e.length - 1) ||
                            o.trigger([t]);
                    }
                }
                this.clearTriggerQueues();
    ...
    (function (n, o) {
        ...
        !(function () {
            ...
            (n.support.transition.end =
                t.transition.end[n.support.transition])),
            s() &&
                ((n.support.animation = new String(h("animation"))),
                (n.support.animation.end =
                    t.animation.end[n.support.animation])),
            e() &&
