!(function (n) {
    ...
    n.scrollIt = function (t) {
        function e(t) {
            t < 0 ||
                i < t ||
                ((t =
                    n("[data-scroll-index=" + t + "]").offset().top +
                    s.topOffset +
                    1),
                n("html,body").animate(
                    { scrollTop: t, easing: s.easing },
                    s.scrollTime
                ));
        }
        var s = n.extend(a, t),
            o = 0,
            i = n("[data-scroll-index]:last").attr("data-scroll-index");
        n(window)
            .on("scroll", function () {
                var i = n(window).scrollTop(),
                    t = n("[data-scroll-index]")
                        .filter(function (t, e) {
                            return (
                                i >= n(e).offset().top + s.topOffset &&
                                i <
                                    n(e).offset().top +
                                        s.topOffset +
                                        n(e).outerHeight()
                        ...
                        .first()
                        .attr("data-scroll-index");
                (t = t),
                    s.onPageChange && t && o != t && s.onPageChange(t),
                    (o = t),
                    n("[data-scroll-nav]").removeClass(s.activeClass),
                    n("[data-scroll-nav=" + t + "]").addClass(s.activeClass);
            })
            .scroll(),
            n(window).on("keydown", function (t) {
                t = t.which;
                return (
                    (!n("html,body").is(":animated") ||
                        (t != s.upKey && t != s.downKey)) &&
                    (t == s.upKey && 0 < o
                        ? (e(parseInt(o) - 1), !1)
                        : !(t == s.downKey && o < i) ||
                          (e(parseInt(o) + 1), !1))
            ...
            easyResponsiveTabs: function (l) {
                ...
                g(this).on("bind", "tabactivate", function (t, e) {
                    ...
                    this.each(function () {
                        var i,
                            s = g(this),
                            t = s.find("ul.resp-tabs-list." + l.tabidentify),
                            o = s.attr("id");
                        s
                            .find("ul.resp-tabs-list." + l.tabidentify + " li")
                            .addClass("resp-tab-item")
                            .addClass(l.tabidentify),
                            s.css({ display: "block", width: c }),
                            "vertical" == l.type && t.css("margin-top", "3px"),
                            s
                                .find(".resp-tabs-container." + l.tabidentify)
                                .css(
                                    "border-color",
                                    l.active_content_border_color
                                ),
                            s
                                .find(
                                    ".resp-tabs-container." +
                            ...
                            "vertical" == h &&
                                s
                                    .addClass("resp-vtabs")
                                    .addClass(l.tabidentify),
                            1 == d && s.css({ width: "100%", margin: "0px" }),
                            "accordion" == h &&
                                (s
                            ...
                            s
                                ...
                                .each(function () {
                                    g(this)
                                        .attr(
                                            "aria-labelledby",
                                            l.tabidentify + "_tab_item-" + t
                                        )
                                        .css({
                                            "border-color":
                                                l.active_border_color,
                                        }),
                                        t++;
                                }),
                                e++;
                        ...
                        "" == u ||
                            (null !==
                                (a = u.match(new RegExp(o + "([0-9]+)"))) &&
                                2 === a.length &&
                                ((r = parseInt(a[1], 10) - 1),
                                e < r && (r = 0))),
                            g(s.find(".resp-tab-item." + l.tabidentify)[r])
                            ...
                            !0 === l.closed ||
                                ...
                                (g(
                                    s.find(".resp-accordion." + l.tabidentify)[
                                        r
                                    ]
                                )
                                    .addClass("resp-tab-active")
                                    .css({
                                        "background-color":
                                            l.activetab_bg + " !important",
                                        "border-color": l.active_border_color,
                                        background: "none",
                                    }),
                                g(
                                    s.find(
                                        ".resp-tab-content." + l.tabidentify
                                    )[r]
                                )
                            ...
                            g(window).resize(function () {
                                s.find(".resp-accordion-closed").removeAttr(
                                    "style"
                                );
                            });
                    });
                    ...
                    run: function () {
                        for (
                            ...
                            (t = this._coordinates[r - 1] || 0),
                                ...
                                ((this.op(t, "<=", o) && this.op(t, ">", n)) ||
                                    (this.op(e, "<", o) &&
                                        this.op(e, ">", n))) &&
                                    a.push(r);
                        this.$stage.children(".active").removeClass("active"),
                            this.$stage
                                .children(":eq(" + a.join("), :eq(") + ")")
                                .addClass("active"),
                            this.$stage
                                .children(".center")
                                .removeClass("center"),
            ...
            (h.prototype.setup = function () {
                ...
                t
                    ? (l.each(t, function (t) {
                      ...
                      "function" ==
                          typeof (s = l.extend({}, this.options, t[i]))
                              .stagePadding &&
                ...
                i.type === h.Type.Event
                    ...
                    : i.type === h.Type.State &&
                      ...
                      (this._states.tags[i.name] = l.grep(
                          ...
                          l.proxy(function (t, e) {
                              return (
                                  l.inArray(t, this._states.tags[i.name]) === e
                              );
                          }, this)
                      )));
            }),
                        ...
                        r.proxy(function (t) {
                            if (
                                ...
                                for (
                                    ...
                                    this.load(n / 2 + this._core.relative(o)),
                                        n &&
                                            r.each(
                                                this._core.clones(
    ...
    (function (d, e) {
            ...
            (this._core = t),
                ...
                (this._handlers = {
                    ...
                    "prepared.owl.carousel": d.proxy(function (t) {
                        var e;
                        !t.namespace ||
                            ((e = d(t.content).find(".owl-video")).length &&
                                (e.css("display", "none"),
                                this.fetch(e, d(t.content))));
                    }, this),
                }),
                (this._core.options = d.extend(
                    {},
                    i.Defaults,
                    this._core.options
                )),
        ...
        (i.Defaults = { video: !1, videoHeight: !1, videoWidth: !1 }),
            (i.prototype.fetch = function (t, e) {
                ...
                (s = s[6]),
                    (this._videos[a] = { type: i, id: s, width: o, height: n }),
                    e.attr("data-video", a),
            ...
            (i.prototype.thumbnail = function (e, t) {
                ...
                if (
                    (e.wrap(
                        d("<div/>", { class: "owl-video-wrapper", style: n })
                    ),
                    this._core.settings.lazyLoad &&
                ...
                "youtube" === t.type
                    ? ((o = "//img.youtube.com/vi/" + t.id + "/hqdefault.jpg"),
                      i(o))
                    : "vimeo" === t.type
                    ? d.ajax({
                          type: "GET",
    ...
    (function (s, o) {
                ...
                (this._handlers = {
                    "initialized.owl.carousel": s.proxy(function (t) {
                        t.namespace &&
                            ...
                            s(o).trigger("hashchange.owl.navigation");
                    }, this),
        ...
        (e.Defaults = { URLhashListener: !1 }),
            (e.prototype.destroy = function () {
                var t, e;
                for (t in (s(o).off("hashchange.owl.navigation"),
                this._handlers))
                    this._core.$element.off(t, this._handlers[t]);
                for (e in Object.getOwnPropertyNames(this))
                    "function" != typeof this[e] && (this[e] = null);
    ...
    (function (o, n) {
        ...
        !(function () {
            ...
            ((o.support.transition = new String(h("transition"))),
            (o.support.transition.end =
                t.transition.end[o.support.transition])),
            s() &&
                ((o.support.animation = new String(h("animation"))),
                (o.support.animation.end =
                    t.animation.end[o.support.animation])),
            e() &&
                ((o.support.transform = new String(h("transform"))),
    ...
    (function (t) {
        ...
        function c(t, e, i, s) {
            ...
            return (
                (o.className = "mfp-" + t),
                i && (o.innerHTML = i),
                s ? e && e.appendChild(o) : ((o = h(o)), e && o.appendTo(e)),
                o
            );
        }
        function u(t, e) {
            g.ev.triggerHandler("mfp" + t, e),
                g.st.callbacks &&
                    ((t = t.charAt(0).toLowerCase() + t.slice(1)),
                    g.st.callbacks[t] &&
                        g.st.callbacks[t].apply(g, h.isArray(e) ? e : [e]));
        }
        function p(t) {
            return (
                (t === e && g.currTemplate.closeBtn) ||
                    ((g.currTemplate.closeBtn = h(
        ...
        function n() {
            h.magnificPopup.instance ||
                ((g = new t()).init(), (h.magnificPopup.instance = g));
        }
        var g,
            s,
            m,
        ...
        (t.prototype = {
            ...
            open: function (t) {
                if (!1 === t.isObj) {
                    ...
                    for (var e, i = t.items, s = 0; s < i.length; s++)
                        if (
                            ((e = i[s]).parsed && (e = e.el[0]), e === t.el[0])
                        ) {
                            g.index = s;
                            break;
                        }
                } else
                    (g.items = h.isArray(t.items) ? t.items : [t.items]),
                        (g.index = t.index || 0);
                if (!g.isOpen) {
                    (g.types = []),
                        (f = ""),
                        ...
                        t.key
                            ? (g.popupsCache[t.key] ||
                                  (g.popupsCache[t.key] = {}),
                              (g.currTemplate = g.popupsCache[t.key]))
                            : (g.currTemplate = {}),
                        ...
                        g.bgOverlay ||
                            ...
                            (g.container = c("container", g.wrap))),
                        (g.contentContainer = c("content")),
                        g.st.preloader &&
                            (g.preloader = c(
                                "preloader",
                                g.container,
                    ...
                    g.fixedContentPos &&
                        g._hasScrollBar(a) &&
                        (l = g._getScrollbarSize()) &&
                        (r.marginRight = l),
                        g.fixedContentPos &&
                            (g.isIE7
                                ? h("body, html").css("overflow", "hidden")
                                : (r.overflow = "hidden"));
                    var l = g.st.mainClass;
                    return (
                        g.isIE7 && (l += " mfp-ie7"),
                        l && g._addClassToMFP(l),
                        g.updateItemHTML(),
                        u("BuildControls"),
                        h("html").css(r),
                        g.bgOverlay
                            .add(g.wrap)
                            .prependTo(g.st.prependTo || h(document.body)),
                        (g._lastFocusedEl = document.activeElement),
                        setTimeout(function () {
                            g.content
                                ? (g._addClassToMFP(C), g._setFocus())
                                : g.bgOverlay.addClass(C),
                                m.on("focusin" + b, g._onFocusIn);
                        }, 16),
                        (g.isOpen = !0),
                        g.updateSize(a),
                        u(w),
            ...
            _close: function () {
                ...
                g.bgOverlay.detach(),
                    g.wrap.detach(),
                    g.container.empty(),
                    g.st.mainClass && (t += g.st.mainClass + " "),
                    g._removeClassFromMFP(t),
                    g.fixedContentPos &&
                        ((t = { marginRight: "" }),
                        g.isIE7
                            ? h("body, html").css("overflow", "")
                            : (t.overflow = ""),
                        h("html").css(t)),
                    ...
                    !g.st.showCloseBtn ||
                        (g.st.closeBtnInside &&
                            !0 !== g.currTemplate[g.currItem.type]) ||
                        (g.currTemplate.closeBtn &&
                            g.currTemplate.closeBtn.detach()),
                    g.st.autoFocusLast &&
                        g._lastFocusedEl &&
                        h(g._lastFocusedEl).focus(),
                    (g.currItem = null),
                    (g.content = null),
                    (g.currTemplate = null),
                    (g.prevHeight = 0),
            ...
            updateItemHTML: function () {
                ...
                g.contentContainer.detach(),
                    ...
                    t.parsed || (t = g.parseEl(g.index));
                var e = t.type;
                u("BeforeChange", [g.currItem ? g.currItem.type : "", e]),
                    (g.currItem = t),
                    g.currTemplate[e] ||
                        ((i = !!g.st[e] && g.st[e].markup),
                        u("FirstMarkupParse", i),
                        (g.currTemplate[e] = !i || h(i))),
                    o &&
                        o !== t.type &&
                        g.container.removeClass("mfp-" + o + "-holder");
                var i = g["get" + e.charAt(0).toUpperCase() + e.slice(1)](
                    t,
                    g.currTemplate[e]
                );
                g.appendContent(i, e),
            ...
            appendContent: function (t, e) {
                (g.content = t)
                    ? g.st.showCloseBtn &&
                      g.st.closeBtnInside &&
                      !0 === g.currTemplate[e]
                        ? g.content.find(".mfp-close").length ||
                          g.content.append(p())
                        : (g.content = t)
                    : (g.content = ""),
                    u("BeforeAppend"),
            ...
            _openClick: function (t, e, i) {
                if (
                    (void 0 !== i.midClick ? i : h.magnificPopup.defaults)
                        .midClick ||
                    !(
                        2 === t.which ||
                        t.ctrlKey ||
                    ...
                    var s = (
                        void 0 !== i.disableOn ? i : h.magnificPopup.defaults
                    ).disableOn;
                    if (s)
                        if (h.isFunction(s)) {
                    ...
                    t.type &&
                        (t.preventDefault(), g.isOpen && t.stopPropagation()),
                        (i.el = h(t.mfpEl)),
            ...
            _checkIfClose: function (t) {
                if (!h(t).hasClass(a)) {
                    ...
                    if (
                        !g.content ||
                        h(t).hasClass("mfp-close") ||
                        (g.preloader && t === g.preloader[0])
                    )
                        return !0;
            ...
            _hasScrollBar: function (t) {
                return (
                    (g.isIE7 ? m.height() : document.body.scrollHeight) >
                    (t || x.height())
                );
            },
            _setFocus: function () {
                (g.st.focus
                    ? g.content.find(g.st.focus).eq(0)
                    : g.wrap
                ).focus();
            },
            _onFocusIn: function (t) {
                return t.target === g.wrap[0] || h.contains(g.wrap[0], t.target)
                    ? void 0
                    : (g._setFocus(), !1);
            },
            ...
            (h.magnificPopup = {
                ...
                close: function () {
                    return (
                        h.magnificPopup.instance &&
                        h.magnificPopup.instance.close()
                    );
                },
                        ...
                        ? "open" === t
                            ? ((e = r
                              ...
                              (s = e.items
                                  ? e.items[i]
                                  : ((s = o),
                                    e.delegate && (s = s.find(e.delegate)),
                                    s.eq(i))),
        ...
        function _() {
            D && ($.after(D.addClass(T)).detach(), (D = null));
        }
        var T,
            $,
            D,
                            ...
                            o.length
                                ? ((i = o[0].parentNode) &&
                                      ...
                                      ($ ||
                                          ...
                                          ($ = c(T)),
                                          (T = "mfp-" + T)),
                                      (D = o.after($).detach().removeClass(T))),
                                  g.updateStatus("ready"))
                                : (g.updateStatus("error", s.tNotFound),
                                  (o = h("<div>"))),
                            (t.inlineElement = o)
                        );
                    }
        ...
        function S() {
            z && h(document.body).removeClass(z);
        }
        function M() {
            S(), g.req && g.req.abort();
        }
                    ...
                    var t = h.extend(
                        {
                            ...
                            error: function () {
                                S(),
                                    ...
                                    g.updateStatus(
                                        "error",
                                        g.st.ajax.tError.replace("%url%", s.src)
                                    );
                            },
                        },
                        g.st.ajax.settings
        ...
        h.magnificPopup.registerModule("image", {
            ...
            proto: {
                initImage: function () {
                    ...
                    g.types.push("image"),
                        d(w + e, function () {
                            "image" === g.currItem.type &&
                                t.cursor &&
                                h(document.body).addClass(t.cursor);
                        }),
                        d(l + e, function () {
                ...
                _onImageHasSize: function (t) {
                    t.img &&
                        ...
                        u("ImageHasSize", t),
                        t.imgHidden &&
                            (g.content && g.content.removeClass("mfp-loading"),
                            (t.imgHidden = !1)));
                },
        ...
        h.magnificPopup.registerModule("zoom", {
            ...
            proto: {
                ...
                _getOffset: function (t) {
                    var e = t
                            ? g.currItem.img
                            : g.st.zoom.opener(g.currItem.el || g.currItem),
                        i = e.offset(),
                    ...
                    s = {
                        width: e.width(),
                        height:
                            (r ? e.innerHeight() : e[0].offsetHeight) - t - s,
                    };
                    return (
                        void 0 === I &&
                            (I =
        ...
        function P(t) {
            var e;
            !g.currTemplate[A] ||
                ((e = g.currTemplate[A].find("iframe")).length &&
                    (t || (e[0].src = "//about:blank"),
                    g.isIE8 && e.css("display", t ? "block" : "none")));
        }
        var A = "iframe";
        h.magnificPopup.registerModule(A, {
            ...
            proto: {
                ...
                getIframe: function (t, e) {
                    ...
                    var o = {};
                    return (
                        s.srcAction && (o[s.srcAction] = i),
                        g._parseMarkup(e, o, t),
                        g.updateStatus("ready"),
                        e
                    );
                },
        ...
        h.magnificPopup.registerModule("gallery", {
            ...
            proto: {
                initGallery: function () {
                    ...
                    return (
                        ...
                        !(!n || !n.enabled) &&
                            ...
                            d("Change" + t, function () {
                                g._preloadTimeout &&
                                    clearTimeout(g._preloadTimeout),
                                    (g._preloadTimeout = setTimeout(
                                        function () {
                ...
                goTo: function (t) {
                    (g.direction = t >= g.index),
                        (g.index = t),
                        g.updateItemHTML();
                },
                preloadNearbyImages: function () {
                    for (
                        var t = g.st.gallery.preload,
                            e = Math.min(t[0], g.items.length),
                            i = Math.min(t[1], g.items.length),
                            s = 1;
                        s <= (g.direction ? i : e);
                        s++
                    )
                        g._preloadItem(g.index + s);
                    for (s = 1; s <= (g.direction ? e : i); s++)
                        g._preloadItem(g.index - s);
                },
    ...
    (function (t) {
        ...
        function y(t, n) {
            ...
            (this.element = T(t)),
                ...
                (this.language =
                    n.language || this.element.data("date-language") || "en"),
                (this.language =
                    this.language in k
                        ? this.language
                        : this.language.split("-")[0]),
                (this.language = this.language in k ? this.language : "en"),
                (this.isRTL = k[this.language].rtl || !1),
                (this.formatType =
                    n.formatType ||
                    this.element.data("format-type") ||
                    "standard"),
                (this.format = S.parseFormat(
                    n.format ||
                        this.element.data("date-format") ||
                        k[this.language].format ||
                        S.getDefaultFormat(this.formatType, "input"),
                    this.formatType
                )),
                (this.isInline = !1),
                (this.isVisible = !1),
                ...
                (this.fontAwesome =
                    n.fontAwesome || this.element.data("font-awesome") || !1),
                (this.bootcssVer =
                    n.bootcssVer ||
                    (this.isInput
                        ? this.element.is(".form-control")
                            ? 3
                            : 2
                        : (this.bootcssVer = this.element.is(".input-group")
                              ? 3
                              : 2))),
                (this.component =
                    ...
                    (3 === this.bootcssVer
                        ? this.element.find(
                              ".input-group-addon .glyphicon-th, .input-group-addon .fa-times, .input-group-addon .fa-times, .input-group-addon .fa-calendar-alt, .input-group-addon .fa-calendar-alt, .input-group-addon .fa-times"
                          )
                        : this.element.find(
                              ".add-on .icon-th, .add-on .icon-time, .add-on .icon-calendar, .add-on .fa-calendar-alt, .add-on .fa-times"
                          )
                    ).parent()),
                (this.componentReset =
                    !!this.element.is(".date") &&
                    (3 === this.bootcssVer
                        ? this.element.find(
                              ".input-group-addon .fa-times, .input-group-addon .fa-times"
                          )
                        : this.element.find(
                ...
                this.component &&
                    ...
                    (this.component = !1),
                (this.linkField =
                    n.linkField || this.element.data("link-field") || !1),
                (this.linkFormat = S.parseFormat(
                    n.linkFormat ||
                        this.element.data("link-format") ||
                        S.getDefaultFormat(this.formatType, "link"),
                    this.formatType
                )),
                (this.minuteStep =
                    n.minuteStep || this.element.data("minute-step") || 5),
                (this.pickerPosition =
                    n.pickerPosition ||
                    this.element.data("picker-position") ||
                    "bottom-right"),
                (this.showMeridian =
                    n.showMeridian || this.element.data("show-meridian") || !1),
                (this.initialDate = n.initialDate || new Date()),
                (this.zIndex = n.zIndex || this.element.data("z-index") || a),
                (this.title = void 0 !== n.title && n.title),
                (this.timezone =
                    n.timezone ||
                    (function () {
                        var t,
                ...
                (this.icons = {
                    leftArrow:
                        this.fontAwesome || 3 === this.bootcssVer
                            ? "fa-arrow-left"
                            : "icon-arrow-left",
                ...
                "wheelViewModeNavigationInverseDirection" in n
                    ? (this.wheelViewModeNavigationInverseDirection =
                          n.wheelViewModeNavigationInverseDirection)
                ...
                "wheelViewModeNavigationDelay" in n
                    ? (this.wheelViewModeNavigationDelay =
                          n.wheelViewModeNavigationDelay)
                ...
                "startView" in n
                    ? (this.startViewMode = n.startView)
            ...
            for (
                var i = 3 === this.bootcssVer ? S.templateV3 : S.template;
                -1 !== i.indexOf("{iconType}");

            )
                i = i.replace("{iconType}", this.icontype);
            for (; -1 !== i.indexOf("{leftArrow}"); )
                i = i.replace("{leftArrow}", this.icons.leftArrow);
            for (; -1 !== i.indexOf("{rightArrow}"); )
                i = i.replace("{rightArrow}", this.icons.rightArrow);
            (this.picker = T(i)
                ...
                T(document).on("mousedown touchend", this.clickedOutside),
                (this.autoclose = !1),
                "autoclose" in n
                ...
                (this.todayBtn =
                    n.todayBtn || this.element.data("date-today-btn") || !1),
                (this.clearBtn =
                    n.clearBtn || this.element.data("date-clear-btn") || !1),
                (this.todayHighlight =
                    n.todayHighlight ||
                    this.element.data("date-today-highlight") ||
                    !1),
                void (this.weekStart = 0) !== n.weekStart
                    ? (this.weekStart = n.weekStart)
                    : void 0 !== this.element.data("date-weekstart")
                    ? (this.weekStart = this.element.data("date-weekstart"))
                    : void 0 !== k[this.language].weekStart &&
                      (this.weekStart = k[this.language].weekStart),
                ...
                (this.onRenderMinute = function (t) {
                    ...
                    return (
                        "string" == typeof e && (e = [e]),
                        t < this.startDate || t > this.endDate
                            ? i.push("disabled")
                            : Math.floor(
                                  this.date.getUTCMinutes() / this.minuteStep
                              ) ===
                                  Math.floor(
                                      t.getUTCMinutes() / this.minuteStep
                                  ) && i.push("active"),
                        i.concat(e || [])
                    );
                }),
                (this.onRenderYear = function (t) {
                    var e = (
                        ...
                        i = ["year"];
                    "string" == typeof e && (e = [e]),
                        this.date.getUTCFullYear() === t.getUTCFullYear() &&
                            i.push("active");
                    var s = t.getUTCFullYear(),
                        o = this.endDate.getUTCFullYear();
                    return (
                        (t < this.startDate || o < s) && i.push("disabled"),
                        i.concat(e || [])
                    );
                }),
                ...
                this.setStartDate(
                    n.startDate || this.element.data("date-startdate")
                ),
                this.setEndDate(n.endDate || this.element.data("date-enddate")),
                this.setDatesDisabled(
                    n.datesDisabled || this.element.data("date-dates-disabled")
                ),
                ...
                this.setHoursDisabled(
                    n.hoursDisabled || this.element.data("date-hour-disabled")
                ),
                this.fillDow(),
                this.fillMonths(),
                this.update(),
        ...
        y.prototype = {
            ...
            _attachEvents: function () {
                ...
                for (var t, e, i = 0; i < this._events.length; i++)
                    (t = this._events[i][0]), (e = this._events[i][1]), t.on(e);
            },
            ...
            remove: function () {
                this._detachEvents(),
                    T(document).off("mousedown", this.clickedOutside),
                    this.picker.remove(),
                    delete this.picker,
            ...
            getDate: function () {
                ...
                return null === t
                    ? null
                    : new Date(t.getTime() + 6e4 * t.getTimezoneOffset());
            },
            getUTCDate: function () {
                return this.date;
            },
            ...
            setFormat: function (t) {
                ...
                (this.format = S.parseFormat(t, this.formatType)),
                    this.isInput
                        ? (e = this.element)
                        : this.component && (e = this.element.find("input")),
            ...
            setTitle: function (t, e) {
                return this.picker
                    .find(t)
                    .find("th:eq(1)")
                    .text(!1 === this.title ? e : this.title);
            },
            setDaysOfWeekDisabled: function (t) {
                (this.daysOfWeekDisabled = t || []),
                    T.isArray(this.daysOfWeekDisabled) ||
                        (this.daysOfWeekDisabled =
                            this.daysOfWeekDisabled.split(/,\s*/)),
                    (this.daysOfWeekDisabled = T.map(
                        this.daysOfWeekDisabled,
                        function (t) {
            ...
            setMinutesDisabled: function (t) {
                (this.minutesDisabled = t || []),
                    T.isArray(this.minutesDisabled) ||
                        (this.minutesDisabled =
                            this.minutesDisabled.split(/,\s*/)),
                    (this.minutesDisabled = T.map(
                        this.minutesDisabled,
                        function (t) {
                            return parseInt(t, 10);
                        }
            ...
            setHoursDisabled: function (t) {
                (this.hoursDisabled = t || []),
                    T.isArray(this.hoursDisabled) ||
                        (this.hoursDisabled = this.hoursDisabled.split(/,\s*/)),
                    (this.hoursDisabled = T.map(
                        this.hoursDisabled,
                        function (t) {
                            return parseInt(t, 10);
                        }
            ...
            place: function () {
                ...
                this.isInline ||
                    (this.zIndex ||
                        ((e = 0),
                        T("div").each(function () {
                            var t = parseInt(T(this).css("zIndex"), 10);
                            e < t && (e = t);
                        }),
                        (this.zIndex = e + 10)),
                    (s = (
                        this.container instanceof T
                            ? this.container
                            : T(this.container)
                    ).offset()),
                    this.component
                        ? ((i = (t = this.component.offset()).left),
                          ("bottom-left" !== this.pickerPosition &&
                              "top-left" !== this.pickerPosition) ||
                              (i +=
                                  this.component.outerWidth() -
                                  this.picker.outerWidth()))
                        : ((i = (t = this.element.offset()).left),
                          ("bottom-left" !== this.pickerPosition &&
                              "top-left" !== this.pickerPosition) ||
                              (i +=
                                  this.element.outerWidth() -
                                  this.picker.outerWidth())),
                    (o = document.body.clientWidth || window.innerWidth) <
                        i + 220 && (i = o - 220),
                    (t =
                        "top-left" === this.pickerPosition ||
                        "top-right" === this.pickerPosition
                            ? t.top - this.picker.outerHeight()
                            : t.top + this.height),
                    (t -= s.top),
                    (i -= s.left),
                    this.picker.css({ top: t, left: i, zIndex: this.zIndex }));
            },
            ...
            update: function () {
                ...
                ("string" == typeof arguments[0] ||
                    ...
                    t || ((t = new Date()), (e = !1)),
                    "string" == typeof t &&
                        (new RegExp(this.hour_minute).test(t) ||
                            new RegExp(this.hour_minute + ":[0-5][0-9]").test(
                                t
                            )) &&
                        (t = this.getDate()),
                    (this.date = S.parseDate(
                        t,
                        this.format,
                        this.language,
                        this.formatType,
            ...
            fillDow: function () {
                for (
                    var t = this.weekStart, e = "<tr>";
                    t < this.weekStart + 7;

                )
                    e +=
                        '<th class="dow">' +
                        k[this.language].daysMin[t++ % 7] +
                        "</th>";
                (e += "</tr>"),
            ...
            fillMonths: function () {
                for (
                    var t = "", e = new Date(this.viewDate), i = 0;
                    i < 12;
                    i++
                )
                    e.setUTCMonth(i),
                        (t +=
                            '<span class="' +
                            this.onRenderMonth(e).join(" ") +
                            '">' +
                            k[this.language].monthsShort[i] +
                            "</span>");
                this.picker.find(".datetimepicker-months td").html(t);
            },
            fill: function () {
                if (this.date && this.viewDate) {
                    var t = (w = new Date(this.viewDate)).getUTCFullYear(),
                        e = w.getUTCMonth(),
                        i = w.getUTCDate(),
                        s = w.getUTCHours(),
                        o = this.startDate.getUTCFullYear(),
                        n = this.startDate.getUTCMonth(),
                        a = this.endDate.getUTCFullYear(),
                        r = this.endDate.getUTCMonth() + 1,
                        l = new $(
                    ...
                    this.setTitle(
                        ".datetimepicker-days",
                        k[this.language].months[e] + " " + t
                    ),
                        "time" === this.formatViewType
                            ? ((_ = this.getFormattedDate()),
                              this.setTitle(".datetimepicker-hours", _),
                              this.setTitle(".datetimepicker-minutes", _))
                            : (this.setTitle(
                                  ".datetimepicker-hours",
                                  i + " " + k[this.language].months[e] + " " + t
                              ),
                              this.setTitle(
                        ...
                        this.picker
                            .find("tfoot th.today")
                            .text(k[this.language].today || k.en.today)
                            .toggle(!1 !== this.todayBtn),
                        this.picker
                            .find("tfoot th.clear")
                            .text(k[this.language].clear || k.en.clear)
                            .toggle(!1 !== this.clearBtn),
                        this.updateNavArrows(),
                        this.fillMonths();
                    var d = $(t, e - 1, 28, 0, 0, 0, 0),
                        c = S.getDaysInMonth(
                            d.getUTCFullYear(),
                            d.getUTCMonth()
                        );
                    d.setUTCDate(c),
                        d.setUTCDate(
                            c - ((d.getUTCDay() - this.weekStart + 7) % 7)
                        );
                    var u = new Date(d);
                    u.setUTCDate(u.getUTCDate() + 42), (u = u.valueOf());
                    for (var p, g = []; d.valueOf() < u; )
                        d.getUTCDay() === this.weekStart && g.push("<tr>"),
                            (p = this.onRenderDay(d)),
                            d.getUTCFullYear() < t ||
                            (d.getUTCFullYear() === t && d.getUTCMonth() < e)
                                ? p.push("old")
                                : (d.getUTCFullYear() > t ||
                                      (d.getUTCFullYear() === t &&
                                          d.getUTCMonth() > e)) &&
                                  p.push("new"),
                            this.todayHighlight &&
                                d.getUTCFullYear() === h.getFullYear() &&
                                d.getUTCMonth() === h.getMonth() &&
                                d.getUTCDate() === h.getDate() &&
                                p.push("today"),
                            d.valueOf() === l && p.push("active"),
                            (d.valueOf() + 864e5 <= this.startDate ||
                                d.valueOf() > this.endDate ||
                                -1 !==
                                    T.inArray(
                                        d.getUTCDay(),
                                        this.daysOfWeekDisabled
                            ...
                            d.getUTCDay() === this.weekEnd && g.push("</tr>"),
                    ...
                    for (
                        ...
                        w.setUTCHours(b),
                            (p = this.onRenderHour(w)),
                            -1 !== y.indexOf(b) && p.push("disabled");
                        var C = $(t, e, i, b);
                        C.valueOf() + 36e5 <= this.startDate ||
                        C.valueOf() > this.endDate
                            ? p.push("disabled")
                            : s === b && p.push("active"),
                            this.showMeridian &&
                            2 === k[this.language].meridiem.length
                                ? ((f =
                                      b < 12
                                          ? k[this.language].meridiem[0]
                                          : k[this.language].meridiem[1]) !==
                                      v &&
                                      ("" !== v && g.push("</fieldset>"),
                                      g.push(
                    ...
                    this.picker
                        .find(".datetimepicker-hours td")
                        .html(g.join("")),
                        (g = []),
                        (v = f = m = "");
                    var x = this.minutesDisabled || [];
                    w = new Date(this.viewDate);
                    for (b = 0; b < 60; b += this.minuteStep)
                        -1 === x.indexOf(b) &&
                            (w.setUTCMinutes(b),
                            w.setUTCSeconds(0),
                            (p = this.onRenderMinute(w)),
                            this.showMeridian &&
                            2 === k[this.language].meridiem.length
                                ? ((f =
                                      s < 12
                    ...
                    this.picker
                        .find(".datetimepicker-minutes td")
                        .html(g.join(""));
                    var _ = this.date.getUTCFullYear(),
                        c = this.setTitle(".datetimepicker-months", t)
                            .end()
                            .find(".month")
                            .removeClass("active");
                    _ === t && c.eq(this.date.getUTCMonth()).addClass("active"),
                        (t < o || a < t) && c.addClass("disabled"),
                        t === o && c.slice(0, n).addClass("disabled"),
                        t === a && c.slice(r).addClass("disabled"),
                        (g = ""),
                    ...
                    r = this.setTitle(
                        ...
                        .end()
                        .find("td");
                    --t, (w = new Date(this.viewDate));
                    for (b = -1; b < 11; b++)
                        w.setUTCFullYear(t),
                            (p = this.onRenderYear(w)),
                            (-1 !== b && 10 !== b) || p.push(D),
                            (g +=
                                '<span class="' +
                                p.join(" ") +
            ...
            updateNavArrows: function () {
                ...
                switch (this.viewMode) {
                    case 0:
                        e <= this.startDate.getUTCFullYear() &&
                        i <= this.startDate.getUTCMonth() &&
                        s <= this.startDate.getUTCDate() &&
                        o <= this.startDate.getUTCHours()
                            ? this.picker
                                  .find(".prev")
                            ...
                            e >= this.endDate.getUTCFullYear() &&
                            i >= this.endDate.getUTCMonth() &&
                            s >= this.endDate.getUTCDate() &&
                            o >= this.endDate.getUTCHours()
                                ? this.picker
                                      .find(".next")
                                      .css({ visibility: "hidden" })
                                : this.picker
            ...
            mousewheel: function (t) {
                t.preventDefault(),
                    ...
                    this.wheelPause ||
                        ((this.wheelPause = !0),
                        (t =
                            0 < (t = t.originalEvent.wheelDelta)
                                ? 1
                                : 0 === t
                                ? 0
                                : -1),
            ...
            click: function (t) {
                ...
                var e,
                    ...
                    n,
                    a,
                    r = T(t.target).closest("span, td, th, legend");
                if (
                    (r.is("." + this.icontype) &&
                        (r = T(r).parent().closest("span, td, th, legend")),
                    1 === r.length)
                )
                    if (r.is(".disabled"))
                        this.element.trigger({
                        ...
                        switch (r[0].nodeName.toLowerCase()) {
                            ...
                            case "span":
                                r.is(".disabled") ||
                                    ...
                                    (e = this.viewDate.getUTCDate()),
                                    (o = this.viewDate.getUTCHours()),
                                    (n = this.viewDate.getUTCMinutes()),
                                    ...
                                    r.is(".month")
                                        ...
                                        ? ((o = parseInt(r.text(), 10) || 0),
                                          (r.hasClass("hour_am") ||
                                              r.hasClass("hour_pm")) &&
                                              (12 === o && r.hasClass("hour_am")
                                                  ? (o = 0)
                                                  : 12 !== o &&
                                                    r.hasClass("hour_pm") &&
                                                    (o += 12)),
                                          this.viewDate.setUTCHours(o),
                                          this.element.trigger({
                                              type: "changeHour",
                                              date: this.viewDate,
                                          }),
                                    ...
                                    r.is(".old")
                                        ...
                                        : r.is(".new") &&
                                          (11 === s
                                              ...
                                              : (s += 1)),
                                    this.viewDate.setUTCFullYear(i),
                                    this.viewDate.setUTCMonth(s, e),
                                    this.element.trigger({
                                        type: "changeDay",
                                        date: this.viewDate,
                                    }),
                                    2 <= this.viewSelect &&
                                        this._setDate($(i, s, e, o, n, a, 0)));
                                var d = this.viewMode;
                                this.showMode(-1),
                                    this.fill(),
                                    d === this.viewMode &&
            ...
            moveMinute: function (t, e) {
                ...
                return (
                    t.setUTCMinutes(t.getUTCMinutes() + e * this.minuteStep), t
                );
            },
            moveHour: function (t, e) {
                if (!e) return t;
                t = new Date(t.valueOf());
                return t.setUTCHours(t.getUTCHours() + e), t;
            },
            moveDate: function (t, e) {
                if (!e) return t;
                t = new Date(t.valueOf());
                return t.setUTCDate(t.getUTCDate() + e), t;
            },
                ...
                if (this.picker.is(":not(:visible)"))
                    ...
                    switch (t.keyCode) {
                        ...
                        case 39:
                            ...
                            e = 37 === t.keyCode ? -1 : 1;
                            var a = this.viewMode;
                            t.ctrlKey ? (a += 2) : t.shiftKey && (a += 1),
                                4 === a
                                    ? ((i = this.moveYear(this.date, e)),
                                      (s = this.moveYear(this.viewDate, e)))
                                    : 3 === a
                                    ? ((i = this.moveMonth(this.date, e)),
                                      (s = this.moveMonth(this.viewDate, e)))
                                    : 2 === a
                                    ? ((i = this.moveDate(this.date, e)),
                                      (s = this.moveDate(this.viewDate, e)))
                                    : 1 === a
                                    ? ((i = this.moveHour(this.date, e)),
                                      (s = this.moveHour(this.viewDate, e)))
                                    : 0 === a &&
                                      ((i = this.moveMinute(this.date, e)),
                                      (s = this.moveMinute(this.viewDate, e))),
                            ...
                            (e = 38 === t.keyCode ? -1 : 1),
                                ...
                                4 === a
                                    ...
                                    ? ((i = this.moveMonth(this.date, e)),
                                      (s = this.moveMonth(this.viewDate, e)))
                                    : 2 === a
                                    ? ((i = this.moveDate(this.date, 7 * e)),
                                      (s = this.moveDate(this.viewDate, 7 * e)))
                                    : 1 === a
                                    ? (s = this.showMeridian
                                          ? ((i = this.moveHour(
                                                this.date,
                                            ...
                                            this.moveHour(this.viewDate, 6 * e))
                                          : ((i = this.moveHour(
                                                this.date,
                                                4 * e
                                            )),
                                    ...
                                    : 0 === a &&
                                      ((i = this.moveMinute(this.date, 4 * e)),
                                      (s = this.moveMinute(
                                          this.viewDate,
                                          4 * e
                                      ))),
            ...
            showMode: function (t) {
                !t ||
                    ((t = Math.max(
                        0,
                        Math.min(S.modes.length - 1, this.viewMode + t)
                    )) >= this.minView &&
                        t <= this.maxView &&
                        (this.element.trigger({
                            type: "changeMode",
                    ...
                    this.picker
                        ...
                        .hide()
                        .filter(
                            ".datetimepicker-" + S.modes[this.viewMode].clsName
                        )
                        .css("display", "block"),
                    this.updateNavArrows();
            },
        ...
        var D = T.fn.datetimepicker;
        (T.fn.datetimepicker = function (s) {
            var o,
            ...
            (T.fn.datetimepicker.defaults = {}),
            (T.fn.datetimepicker.Constructor = y);
        var k = (T.fn.datetimepicker.dates = {
                en: {
                    days: [
                        "Sunday",
                        "Monday",
            ...
            S = {
                ...
                parseFormat: function (t, e) {
                    var i = t.replace(this.validParts(e), "\0").split("\0"),
                        e = t.match(this.validParts(e));
                    if (!i || !i.length || !e || 0 === e.length)
                        throw new Error("Invalid date format.");
                    return { separators: i, parts: e };
                },
                parseDate: function (t, e, i, s, o) {
                    if (t instanceof Date) {
                        var n = new Date(
                            t.valueOf() - 6e4 * t.getTimezoneOffset()
                        );
                        return n.setMilliseconds(0), n;
                    }
                    if (
                        (/^\d{4}\-\d{1,2}\-\d{1,2}$/.test(t) &&
                            (e = this.parseFormat("yyyy-mm-dd", s)),
                        /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}$/.test(
                            t
                        ) && (e = this.parseFormat("yyyy-mm-dd hh:ii", s)),
                        /^\d{4}\-\d{1,2}\-\d{1,2}[T ]\d{1,2}\:\d{1,2}\:\d{1,2}[Z]{0,1}$/.test(
                            t
                        ) && (e = this.parseFormat("yyyy-mm-dd hh:ii:ss", s)),
                        ...
                        for (var h = 0; h < l.length; h++)
                            switch (
                                ((u = r.exec(l[h])), (a = parseInt(u[1])), u[2])
                            ) {
                                case "d":
                                    t.setUTCDate(t.getUTCDate() + a);
                                    break;
                                case "m":
                                    t = y.prototype.moveMonth.call(
                                        y.prototype,
                                        t,
                                        a
                                    );
                    ...
                    var d,
                        ...
                        u,
                        l =
                            (t && t.toString().match(this.nonpunctuation)) ||
                            [],
                    ...
                    if (
                        ...
                        for (var h = 0, f = e.parts.length; h < f; h++) {
                            if (
                                ((d = parseInt(l[h], 10)),
                                (u = e.parts[h]),
                                isNaN(d))
                                ...
                                switch (u) {
                                    case "MM":
                                        (c = T(k[i].months).filter(function () {
                                            var t = this.slice(0, l[h].length);
                                            return (
                                                t === l[h].slice(0, t.length)
                                            );
                                        })),
                                            (d =
                                                T.inArray(c[0], k[i].months) +
                                                1);
                                        break;
                                    case "M":
                                        (c = T(k[i].monthsShort).filter(
                                            function () {
                                                var t = this.slice(
                                                        0,
                                                        l[h].length
                        ...
                        for (var v, h = 0; h < g.length; h++)
                            (v = g[h]) in p && !isNaN(p[v]) && m[v](t, p[v]);
                    }
                    return t;
                },
                formatDate: function (t, e, i, s, o) {
                    if (null === t) return "";
                    var n;
                    if ("standard" === s)
                        (n = {
                            ...
                            m: t.getUTCMonth() + 1,
                            M: k[i].monthsShort[t.getUTCMonth()],
                            MM: k[i].months[t.getUTCMonth()],
                            d: t.getUTCDate(),
                            D: k[i].daysShort[t.getUTCDay()],
                            DD: k[i].days[t.getUTCDay()],
                            p:
                                2 === k[i].meridiem.length
                                    ? k[i].meridiem[
                                          t.getUTCHours() < 12 ? 0 : 1
                                      ]
                                    : "",
                            h: t.getUTCHours(),
                            i: t.getUTCMinutes(),
                        ...
                        ((n = {
                            ...
                            j: t.getUTCDate(),
                            l: k[i].days[t.getUTCDay()],
                            D: k[i].daysShort[t.getUTCDay()],
                            w: t.getUTCDay(),
                            N: 0 === t.getUTCDay() ? 7 : t.getUTCDay(),
                            S:
                                t.getUTCDate() % 10 <= k[i].suffix.length
                                    ? k[i].suffix[(t.getUTCDate() % 10) - 1]
                                    : "",
                            a:
                                2 === k[i].meridiem.length
                                    ? k[i].meridiem[
                    ...
                    for (
                        var t = [],
                            a = T.extend([], e.separators),
                            r = 0,
                            l = e.parts.length;
                        r < l;
                        r++
                    )
                        a.length && t.push(a.shift()), t.push(n[e.parts[r]]);
        ...
        (S.template =
            ...
            (T.fn.datetimepicker.noConflict = function () {
                return (T.fn.datetimepicker = D), this;
            }),
            T(document).on(
                ...
                function (t) {
                    ...
                    e.data("datetimepicker") ||
                        (t.preventDefault(), e.datetimepicker("show"));
                }
            ),
            T(function () {
        ...
        (h.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = o),
                    ...
                    (this.$element =
                        this.element === o ? g("body") : this.$scrollElement),
                    (this.$viewportElement =
                        this.options.viewportElement !== m
                            ? g(this.options.viewportElement)
                            : this.$scrollElement[0] === o ||
                              "scroll" === this.options.scrollProperty
                            ? this.$scrollElement
            ...
            _defineSetters: function () {
                ...
                (this._setScrollLeft =
                    ...
                    (this._setPosition =
                        a.setPosition ||
                        function (t, e, i, s, o) {
                            n.options.horizontalScrolling && a.setLeft(t, e, i),
                                n.options.verticalScrolling &&
                                    a.setTop(t, s, o);
                        });
            },
                    ...
                    this.options.parallaxElements &&
                        this.$element
                            ...
                            .each(function (t) {
                                ...
                                p.options.showElement(l),
                                    l.data("stellar-startingLeft")
                                        ? (l.css(
                                              "left",
                                              l.data("stellar-startingLeft")
                                          ),
                                    ...
                                    (s =
                                        ...
                                        m
                                            ...
                                            : p.horizontalOffset),
                                    (o =
                                        l.data("stellar-vertical-offset") !== m
                                    ...
                                    p.particles.push({
                                        ...
                                        parentOffsetTop: d,
                                        stellarRatio:
                                            l.data("stellar-ratio") !== m
                                                ? l.data("stellar-ratio")
                                                : 1,
                    ...
                    this.options.parallaxBackgrounds &&
                        ...
                        t.each(function () {
                            ...
                            if (n.data("stellar-backgroundIsActive")) {
                                if (
                                    n.data("stellar-backgroundIsActive") !==
                                    this
                                )
                                    return;
                            } else n.data("stellar-backgroundIsActive", this);
                            n.data("stellar-backgroundStartingLeft")
                                ? f(
                                      n,
                                      n.data("stellar-backgroundStartingLeft"),
                                      n.data("stellar-backgroundStartingTop")
                                  )
                                : (n.data(
                                ...
                                n.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (r = h), (l = d), (o = t), !1;
                                    (h += t.position().left),
                                        (d += t.position().top);
                                }),
                                (t =
                                    n.data("stellar-horizontal-offset") !== m
                                        ...
                                        : c.horizontalOffset),
                                (e =
                                    n.data("stellar-vertical-offset") !== m
                                        ? n.data("stellar-vertical-offset")
                                        : o !== m &&
                                ...
                                c.backgrounds.push({
                                    ...
                                    parentOffsetTop: l,
                                    stellarRatio:
                                        n.data("stellar-background-ratio") === m
                                            ? 1
                                            : n.data(
            ...
            _reset: function () {
                for (var t, e, i, s, o = this.particles.length - 1; 0 <= o; o--)
                    (e = (t = this.particles[o]).$element.data(
                        "stellar-startingLeft"
                    )),
            ...
            (g.fn[s] = function (e) {
                var i = arguments;
                return e === m || "object" == typeof e
                    ? this.each(function () {
                          g.data(this, "plugin_" + s) ||
                              g.data(this, "plugin_" + s, new h(this, e));
                      })
                    ...
                    ? this.each(function () {
                          ...
                          t instanceof h &&
                              ...
                              "destroy" === e &&
                                  g.data(this, "plugin_" + s, null);
                      })
                    : void 0;
            }),
            (g[s] = function (t) {
                var e = g(o);
                return e.stellar.apply(
                    e,
                    Array.prototype.slice.call(arguments, 0)
                );
            }),
            (g[s].scrollProperty = r),
        ...
        !(function () {
            ...
            function e(t, e) {
                ...
                return (
                    ...
                    this.s.dynamic
                        ...
                        : "" !== this.s.selector
                        ? this.s.selectWithin
                            ? (this.$items = g(this.s.selectWithin).find(
                                  this.s.selector
                              ))
            ...
            (e.prototype.init = function () {
                ...
                (e.prototype.build = function (t) {
                    var e = this;
                    e.structure(),
                        g.each(g.fn.lightGallery.modules, function (t) {
                            e.modules[t] = new g.fn.lightGallery.modules[t](
                                e.el
                            );
                        }),
                        e.slide(t, !1, !1, !1),
                ...
                (e.prototype.loadContent = function (e, t, i) {
                    var s,
                        ...
                        c = function (t) {
                            ...
                            for (
                                var n = g(window).width(), a = 0;
                                a < e.length;
                                a++
                            )
                                if (parseInt(e[a], 10) > n) {
                                    r = i[a];
                                    break;
                                }
                        },
                        u = h.s.dynamic
                            ? (h.s.dynamicEl[e].poster &&
                                  ((d = !0), (o = h.s.dynamicEl[e].poster)),
                              (a = h.s.dynamicEl[e].html),
                              (r = h.s.dynamicEl[e].src),
                              (l = h.s.dynamicEl[e].alt),
                              h.s.dynamicEl[e].responsive &&
                                  c(h.s.dynamicEl[e].responsive.split(",")),
                              (n = h.s.dynamicEl[e].srcset),
                              h.s.dynamicEl[e].sizes)
                            : ((p = h.$items.eq(e)).attr("data-poster") &&
                                  ((d = !0), (o = p.attr("data-poster"))),
                              (a = p.attr("data-html")),
                              (r = p.attr("href") || p.attr("data-src")),
                              (l =
                                  p.attr("title") ||
                                  p.find("img").first().attr("alt")),
                              p.attr("data-responsive") &&
                                  c(p.attr("data-responsive").split(",")),
                              (n = p.attr("data-srcset")),
                              p.attr("data-sizes")),
                        c = !1;
                    h.s.dynamic
                        ? h.s.dynamicEl[e].iframe && (c = !0)
                        : "true" === h.$items.eq(e).attr("data-iframe") &&
                          (c = !0);
                    var p = h.isVideo(r, e);
                    if (!h.$slide.eq(e).hasClass("lg-loaded")) {
                        if (
                            (c
                                ? h.$slide
                                      .eq(e)
                                ...
                                ? (h.$slide
                                  ...
                                  h.$el.trigger("hasVideo.lg", [e, r, a]))
                                : ((l = l ? 'alt="' + l + '"' : ""),
                                  h.$slide
                                      .eq(e)
                                      .prepend(
                            ...
                            h.$el.trigger("onAferAppendSlide.lg", [e]),
                            (s = h.$slide.eq(e).find(".lg-object")),
                            u && s.attr("sizes", u),
                            n &&
                                (s.attr("srcset", n),
                        ...
                        ".lg-sub-html" !== this.s.appendSubHtmlTo &&
                            h.addHtml(e),
                            h.$slide.eq(e).addClass("lg-loaded");
                    }
                    h.$slide
                        .eq(e)
                        .find(".lg-object")
                        .on("load.lg error.lg", function () {
                            var t = 0;
                            i && !g("body").hasClass("lg-from-hash") && (t = i),
                                setTimeout(function () {
                                    h.$slide.eq(e).addClass("lg-complete"),
                                        h.$el.trigger("onSlideItemLoad.lg", [
                                            e,
                                            i || 0,
                                        ]);
                                }, t);
                        ...
                        p &&
                            ...
                            h.$slide.eq(e).addClass("lg-complete"),
                        !0 === t &&
                            (h.$slide.eq(e).hasClass("lg-complete")
                                ? h.preload(e)
                                : h.$slide
                                      .eq(e)
                                      .find(".lg-object")
                ...
                (e.prototype.slide = function (t, e, i, s) {
                    var o,
                        ...
                        r,
                        l,
                        h = this.$outer.find(".lg-current").index(),
                        d = this;
                    (d.lGalleryOn && h === t) ||
                        ((o = this.$slide.length),
                        (n = d.lGalleryOn ? this.s.speed : 0),
                        d.lgBusy ||
                            (this.s.download &&
                                ((a = d.s.dynamic
                                    ? !1 !== d.s.dynamicEl[t].downloadUrl &&
                                      (d.s.dynamicEl[t].downloadUrl ||
                                          d.s.dynamicEl[t].src)
                                    : "false" !==
                                          d.$items
                                              .eq(t)
                                      ...
                                      (d.$items
                                          .eq(t)
                                          .attr("data-download-url") ||
                                          d.$items.eq(t).attr("href") ||
                                          d.$items.eq(t).attr("data-src")))
                                    ? (g("#lg-download").attr("href", a),
                                      d.$outer.removeClass("lg-hide-download"))
                                    : d.$outer.addClass("lg-hide-download")),
                            this.$el.trigger("onBeforeSlide.lg", [h, t, e, i]),
                            (d.lgBusy = !0),
                            ...
                            e
                                ? (this.$slide.removeClass(
                                  ...
                                  2 < o
                                      ...
                                      : ((r = 0), (l = 1)),
                                  "prev" === s
                                      ? d.$slide.eq(l).addClass("lg-next-slide")
                                      : d.$slide
                                            .eq(r)
                                            .addClass("lg-prev-slide"),
                                  d.$slide.eq(t).addClass("lg-current"))
                                : (d.$outer.addClass("lg-no-trans"),
                                  this.$slide.removeClass(
                                  ...
                                  "prev" === s
                                      ...
                                      : (this.$slide
                                        ...
                                        this.$slide
                                            ...
                                            .addClass("lg-prev-slide")),
                                  setTimeout(function () {
                                      d.$slide.removeClass("lg-current"),
                                          d.$slide.eq(t).addClass("lg-current"),
                                          d.$outer.removeClass("lg-no-trans");
                                  }, 50)),
                            d.lGalleryOn
                                ? (setTimeout(function () {
                                      d.loadContent(t, !0, 0);
                                ...
                                : (d.loadContent(t, !0, d.s.backdropDuration),
                                  (d.lgBusy = !1),
                                  d.$el.trigger("onAfterSlide.lg", [
                                      h,
                                      t,
                    ...
                    t && e.$slide.length < 3 && (i = !1),
                        e.lgBusy ||
                            (e.index + 1 < e.$slide.length
                                ? (e.index++,
                                  e.$el.trigger("onBeforeNextSlide.lg", [
                                      e.index,
                                  ]),
                ...
                (e.prototype.goToPrevSlide = function (t) {
                    ...
                    t && e.$slide.length < 3 && (i = !1),
                        e.lgBusy ||
                            (0 < e.index
                                ? (e.index--,
                                  e.$el.trigger("onBeforePrevSlide.lg", [
                                      e.index,
                                      t,
                                  ]),
                ...
                (e.prototype.keyPress = function () {
                    var e = this;
                    1 < this.$items.length &&
                        g(window).on("keyup.lg", function (t) {
                            1 < e.$items.length &&
                                (37 === t.keyCode &&
                    ...
                    e.s.enableDrag &&
                        ...
                        g(window).on("mouseup.lg", function (t) {
                            n
                                ? ((n = !1),
                                  e.touchEnd(s - i),
                                  e.$el.trigger("onDragend.lg"))
                                : (g(t.target).hasClass("lg-object") ||
                                      g(t.target).hasClass("lg-video-play")) &&
                                  e.$el.trigger("onSlideClick.lg"),
                                o &&
                                    ((o = !1),
                                    e.$outer
                    ...
                    this.$outer.find(".lg-close").on("click.lg", function () {
                        ...
                        e.s.closable &&
                            (e.$outer.on("mousedown.lg", function (t) {
                                i = !!(
                                    g(t.target).is(".lg-outer") ||
                                    g(t.target).is(".lg-item ") ||
                                    g(t.target).is(".lg-img-wrap")
                                );
                            }),
                ...
                (e.prototype.destroy = function (t) {
                    ...
                    t ||
                        ...
                        g(window).scrollTop(e.prevScrollTop)),
                        t &&
                            (e.s.dynamic ||
                                this.$items.off("click.lg click.lgcustom"),
                            g.removeData(e.el, "lightGallery")),
                        this.$el.off(".lg.tm"),
                        g.each(g.fn.lightGallery.modules, function (t) {
            ...
            (t.prototype.init = function () {
                ...
                t.core.s.autoplayControls && t.controls(),
                    ...
                    t.$el.on("onDragstart.lg.tm touchstart.lg.tm", function () {
                        t.interval &&
                            (t.cancelAuto(), (t.canceledOnTouch = !0));
                    }),
                    t.$el.on(
                        ...
                        t.core.$outer
                            ...
                            .on("click.lg", function () {
                                i(t.core.$outer).hasClass("lg-show-autoplay")
                                    ? (t.cancelAuto(),
                                      (t.core.s.fourceAutoplay = !1))
                                    : t.interval ||
                                      (t.startlAuto(),
                                      (t.core.s.fourceAutoplay =
                                          t.fourceAutoplayTemp));
                            });
                }),
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    ...
                    (this.$el = s(t)),
                    (this.core.s = s.extend({}, e, this.core.s)),
                    this.init(),
                    this
                );
            }
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                if (
                    ...
                    for (var n = 0; n < i.core.s.dynamicEl.length; n++)
                        o +=
                            '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                            i.core.s.dynamicEl[n].thumb +
                            '" /></div></span>';
                else
                    i.core.$items.each(function () {
                        i.core.s.exThumbImage
                            ? (o +=
                                  '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                                  a(this).attr(i.core.s.exThumbImage) +
                                  '" /></div></span>')
                            : (o +=
                                  '<span class="lg-pager-cont"> <span class="lg-pager"></span><div class="lg-pager-thumb-cont"><span class="lg-caret"></span> <img src="' +
                ...
                (t = i.core.$outer.find(".lg-pager-outer")).html(o),
                ...
                (t.prototype.destroy = function () {}),
                (a.fn.lightGallery.modules.pager = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                (t.prototype.build = function () {
                    ...
                    function e(t, e, i) {
                        var s,
                            t = o.core.isVideo(t, i) || {},
                            i = "";
                        t.youtube || t.vimeo || t.dailymotion
                            ? t.youtube
                                ? (s = o.core.s.loadYoutubeThumbnail
                                      ? "//img.youtube.com/vi/" +
                                        t.youtube[1] +
                                        "/" +
                                        o.core.s.youtubeThumbSize +
                                        ".jpg"
                                      : e)
                                : t.vimeo
                                ? o.core.s.loadVimeoThumbnail
                                    ? ((s =
                                    ...
                                    : (s = e)
                                : t.dailymotion &&
                                  (s = o.core.s.loadDailymotionThumbnail
                            ...
                            (n +=
                                ...
                                o.core.s.thumbWidth +
                                "px; height: " +
                                o.core.s.thumbHeight +
                                "; margin-right: " +
                                o.core.s.thumbMargin +
                                'px"><img src="' +
                                s +
                                '" /></div>'),
                            (i = "");
                    ...
                    if (
                        (o.core.$outer.addClass("lg-has-thumb"),
                        o.core.$outer
                            .find(".lg")
                            .append(
                        ...
                        this.core.s.animateThumb &&
                            o.$thumbOuter.css(
                                "height",
                                o.core.s.thumbContHeight + "px"
                            ),
                        o.core.s.dynamic)
                    )
                        for (var i = 0; i < o.core.s.dynamicEl.length; i++)
                            e(
                                o.core.s.dynamicEl[i].src,
                                o.core.s.dynamicEl[i].thumb,
                                i
                            );
                    else
                    ...
                    o.core.$outer.find(".lg-thumb").html(n),
                        (t = o.core.$outer.find(".lg-thumb-item")).each(
                            function () {
                                var e = r(this),
                        ...
                        t.on("click.lg touchend.lg", function () {
                            var t = r(this);
                            setTimeout(function () {
                                ((!o.thumbClickable || o.core.lgBusy) &&
                                    o.core.doCss()) ||
                                    ((o.core.index = t.index()),
                ...
                (t.prototype.enableThumbDrag = function () {
                    ...
                    e.$thumbOuter.addClass("lg-grab"),
                        ...
                        r(window).on("mousemove.lg.thumb", function (t) {
                            o &&
                                ((a = e.left),
                                (n = !0),
                                (s = t.pageX),
                                ...
                                (a -= s - i) >
                                    e.thumbTotalWidth - e.thumbOuterWidth &&
                                    (a = e.thumbTotalWidth - e.thumbOuterWidth),
                                a < 0 && (a = 0),
                                e.setTranslate(a));
                        }),
                        r(window).on("mouseup.lg.thumb", function () {
                            n
                                ? ((n = !1),
                    ...
                    e.core.$outer
                        ...
                        e.core.$outer
                            ...
                            .on("touchend.lg", function () {
                                e.thumbTotalWidth > e.thumbOuterWidth && o
                                    ? ((o = !1),
                                      e.$thumbOuter.removeClass("lg-dragging"),
                                      Math.abs(s - i) <
                                          e.core.s.swipeThreshold &&
                                          (e.thumbClickable = !0),
                                      (e.left = n))
                                    : (e.thumbClickable = !0);
                            });
                ...
                (t.prototype.thumbkeyPress = function () {
                    var e = this;
                    r(window).on("keydown.lg.thumb", function (t) {
                        38 === t.keyCode
                            ? (t.preventDefault(),
                ...
                (r.fn.lightGallery.modules.Thumbnail = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    (this.core = h(t).data("lightGallery")),
                    (this.$el = h(t)),
                    (this.core.s = h.extend({}, e, this.core.s)),
                    (this.videoLoaded = !1),
                    this.init(),
                    this
                );
            ...
            (t.prototype.init = function () {
                ...
                s.core.$el.on(
                    ...
                    function (t, e, i, s) {
                        ...
                        if (
                            (o.core.$slide
                                .eq(e)
                                .find(".lg-video")
                                .append(o.loadVideo(i, "lg-object", !0, e, s)),
                            s)
                        )
                            if (o.core.s.videojs)
                                try {
                                    videojs(
                                        o.core.$slide
                                            ...
                                            .find(".lg-html5")
                                            .get(0),
                                        o.core.s.videojsOptions,
                                        function () {
                                            !o.videoLoaded &&
                                                o.core.s.autoplayFirstVideo &&
                                                this.play();
                                        }
                                    );
                                } catch (t) {
                    ...
                    s.core.$el.on(
                        ...
                        function (t, e, i) {
                            ...
                            (i.youtube || i.vimeo || i.dailymotion || i.vk) &&
                ...
                (t.prototype.loadVideo = function (t, e, i, s, o) {
                    var n = this,
                        ...
                        n = n.core.s.dynamic
                            ? n.core.s.dynamicEl[n.core.index].title
                            : n.core.$items.eq(n.core.index).attr("title") ||
                              n.core.$items
                                  .eq(n.core.index)
                                  .find("img")
                                  .first()
                            ...
                            ? ((l =
                              ...
                              this.core.s.youtubePlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      h.param(this.core.s.youtubePlayerParams)),
                              (a =
                            ...
                            ? ((l = "?autoplay=" + r + "&api=1"),
                              this.core.s.vimeoPlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      h.param(this.core.s.vimeoPlayerParams)),
                              (a =
                            ...
                            : s.vk &&
                              ...
                              this.core.s.vkPlayerParams &&
                                  (l =
                                      l +
                                      "&" +
                                      h.param(this.core.s.vkPlayerParams)),
                              (a =
                ...
                (t.prototype.loadVideoOnclick = function (i) {
                    ...
                    if (
                        ...
                        if (i.hasClass("lg-has-video")) {
                            ...
                            s.core.s.dynamic
                                ? o(
                                      s.core.s.dynamicEl[s.core.index].src,
                ...
                (h.fn.lightGallery.modules.video = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
            ...
            function t(t) {
                return (
                    ...
                    this.core.s.zoom &&
                        ...
                        (this.pageY =
                            u(window).height() / 2 + u(window).scrollTop())),
                    this
                );
            }
            var e,
            ...
            (t.prototype.init = function () {
                ...
                n.core.s.actualSize &&
                    ...
                    n.core.s.useLeftForZoom
                        ? n.core.$outer.addClass("lg-use-left-for-zoom")
                        : n.core.$outer.addClass("lg-use-transition-for-zoom"),
                    ...
                    n.core.$el.on(
                        ...
                        function (t, e, i) {
                            ...
                            u("body").hasClass("lg-from-hash") && i
                                ...
                                (n.zoomabletimeout = setTimeout(function () {
                ...
                function a() {
                    1 < r ? n.core.$outer.addClass("lg-zoomed") : n.resetZoom(),
                        r < 1 && (r = 1),
                        e(r);
                }
                function s(t, e, i, s) {
                    var o = e.prop("offsetWidth"),
                        e = n.core.s.dynamic
                            ? n.core.s.dynamicEl[i].width ||
                              e[0].naturalWidth ||
                              o
                            : n.core.$items.eq(i).attr("data-width") ||
                              e[0].naturalWidth ||
                              o;
                ...
                n.core.$el.on("onAferAppendSlide.lg.tm.zoom", function (t, e) {
                    ...
                    u("#lg-zoom-out").on("click.lg", function () {
                        n.core.$outer.find(".lg-current .lg-image").length &&
                            ((r -= n.core.s.scale), a());
                    }),
                    ...
                    u("#lg-actual-size").on("click.lg", function (t) {
                        s(
                            t,
                            n.core.$slide.eq(n.core.index).find(".lg-image"),
                            n.core.index,
                            !0
                        );
                    }),
                ...
                (t.prototype.getPossibleDragCords = function (t, e) {
                    ...
                    return 90 === e
                        ? { minY: o, maxY: t, minX: i, maxX: s }
                        : { minY: i, maxY: s, minX: o, maxX: t };
                }),
                ...
                (t.prototype.zoomSwipe = function () {
                    ...
                    o.core.$slide.on("touchstart.lg", function (t) {
                        ...
                        o.core.$outer.hasClass("lg-zoomed") &&
                            ...
                            (d = o.getCurrentRotation(s)),
                            (e = o.getDragAllowedAxises(e, Math.abs(d))),
                            (h = e.allowY),
                            ((l = e.allowX) || h) &&
                                (t.preventDefault(),
                                (n = o.getSwipeCords(t, Math.abs(d)))));
                    }),
                        o.core.$slide.on("touchmove.lg", function (t) {
                            ...
                            o.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                t.preventDefault(),
                                (r = !0),
                                (a = o.getSwipeCords(t, Math.abs(d))),
                                o.core.$outer.addClass("lg-zoom-dragging"),
                                (i = h
                                    ? -Math.abs(e.attr("data-y")) +
                                      (a.y - n.y) * o.getModifier(d, "Y", s)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = l
                                    ? -Math.abs(e.attr("data-x")) +
                                      (a.x - n.x) * o.getModifier(d, "X", s)
                                    : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(a.x - n.x) ||
                                    15 < Math.abs(a.y - n.y)) &&
                ...
                (t.prototype.zoomDrag = function () {
                    ...
                    o.core.$slide.on("mousedown.lg.zoom", function (t) {
                        (s = o.core.$slide
                            .eq(o.core.index)
                            .find(".lg-img-rotate")[0]),
                            (c = o.getCurrentRotation(s));
                        var e = o.core.$slide
                                .eq(o.core.index)
                                .find(".lg-object"),
                            e = o.getDragAllowedAxises(e, Math.abs(c));
                        (d = e.allowY),
                            (h = e.allowX),
                            o.core.$outer.hasClass("lg-zoomed") &&
                        ...
                        u(window).on("mousemove.lg.zoom", function (t) {
                            ...
                            r &&
                                ((e = o.core.$slide
                                    ...
                                    .find(".lg-img-wrap")),
                                (l = !0),
                                (a = o.getDragCords(t, Math.abs(c))),
                                o.core.$outer.addClass("lg-zoom-dragging"),
                                (i = d
                                    ? -Math.abs(e.attr("data-y")) +
                                      (a.y - n.y) * o.getModifier(c, "Y", s)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = h
                                    ? -Math.abs(e.attr("data-x")) +
                                      (a.x - n.x) * o.getModifier(c, "X", s)
                                    : -Math.abs(e.attr("data-x"))),
                                o.core.s.useLeftForZoom
                                    ? e.css({ left: t + "px", top: i + "px" })
                                    : e.css(
                                          "transform",
                                          "translate3d(" +
                                              t +
                ...
                (t.prototype.touchendZoom = function (t, e, i, s, o) {
                    var n = this,
                        ...
                        l = n.core.$slide
                            ...
                            .find(".lg-img-rotate")[0],
                        h =
                            -Math.abs(a.attr("data-x")) +
                            (e.x - t.x) * n.getModifier(o, "X", l),
                        l =
                            -Math.abs(a.attr("data-y")) +
                            (e.y - t.y) * n.getModifier(o, "Y", l),
                        o = n.getPossibleDragCords(r, Math.abs(o));
                    (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
                        ...
                        i &&
                            (h <= -o.maxX
                                ...
                                : h >= -o.minX && (h = -o.minX)),
                        s
                            ? a.attr("data-y", Math.abs(l))
                            : (l = -Math.abs(a.attr("data-y"))),
                        i
                            ? a.attr("data-x", Math.abs(h))
                            : (h = -Math.abs(a.attr("data-x"))),
                        n.core.s.useLeftForZoom
                            ? a.css({ left: h + "px", top: l + "px" })
                            : a.css(
                                  "transform",
                                  "translate3d(" + h + "px, " + l + "px, 0)"
                              ));
                }),
                (t.prototype.destroy = function () {
                    var t = this;
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    (this.core = o(t).data("lightGallery")),
                    (this.core.s = o.extend({}, e, this.core.s)),
                ...
                (t += s.core.s.facebook
                    ...
                    o("#lg-dropdown-overlay").on("click.lg", function () {
                        s.core.$outer.removeClass("lg-dropdown-active"),
                            o("#lg-share").attr("aria-expanded", !1);
                    }),
                    s.core.$el.on("onAfterSlide.lg.tm", function (t, e, i) {
                        setTimeout(function () {
                    ...
                    var t = this.core.$slide
                        ...
                        t =
                            90 !== t && 270 !== t
                                ? "flipHorizontal"
                                : "flipVertical";
                    (this.rotateValuesList[this.core.index][t] *= -1),
                        this.applyStyles();
                }),
    ...
    (function (t) {
        ...
        function e(t) {
            ...
            if (
                ...
                "axis" in i &&
                    ...
                    ((n = -1 * a), (a = 0)),
                (o = 0 === a ? n : a),
                "deltaY" in i && (o = a = -1 * i.deltaY),
                "deltaX" in i && ((n = i.deltaX), 0 === a && (o = -1 * n)),
                0 !== a || 0 !== n)
            ) {
                1 === i.deltaMode
                    ? ((o *= e = d.data(this, "mousewheel-line-height")),
                      (a *= e),
                      (n *= e))
                    : 2 === i.deltaMode &&
                      ((o *= e = d.data(this, "mousewheel-page-height")),
                      (a *= e),
                      (n *= e));
                var r = Math.max(Math.abs(a), Math.abs(n));
                return (
                    (g && !(r < g)) || (u(i, (g = r)) && (g /= 40)),
                    u(i, r) && ((o /= 40), (n /= 40), (a /= 40)),
        ...
        if (d.event.fixHooks)
            for (var s = t.length; s; )
                d.event.fixHooks[t[--s]] = d.event.mouseHooks;
        var f = (d.event.special.mousewheel = {
            ...
            setup: function () {
                ...
                d.data(this, "mousewheel-line-height", f.getLineHeight(this)),
                    d.data(
                        this,
    ...
    function () {
        ...
        (d.prototype.extend = function (t, e) {
            ...
            (d.prototype.createEvent = function (t, e, i, s) {
                var o;
                return (
                    null == e && (e = !1),
                    null == i && (i = !1),
            ...
            (i =
                ...
                ((h.prototype.get = function (t) {
                    for (
                        var e, i, s = (e = 0), o = (i = this.keys).length;
                        e < o;
                        s = ++e
                    )
                ...
                (h.prototype.set = function (t, e) {
                    for (
                        var i, s, o = (i = 0), n = (s = this.keys).length;
                        i < n;
                        o = ++i
                    )
                        if (s[o] === t) return void (this.values[o] = e);
            ...
            (this.WOW =
                        ...
                        (this.boxes = function () {
                            for (
                                var t,
                                    e = [],
                                    i = 0,
                                    s = (t = this.element.querySelectorAll(
                ...
                (n.prototype.resetStyle = function () {
                    for (
                        var t, e, i = [], s = 0, o = (e = this.boxes).length;
                        s < o;
                        s++
                    )
                        (t = e[s]), i.push((t.style.visibility = "visible"));
                    return i;
                }),
                (n.prototype.resetAnimation = function (t) {
                    return 0 <= t.type.toLowerCase().indexOf("animationend")
                        ? ((t = t.target || t.srcElement).className =
                              t.className
                ...
                (n.prototype.vendorSet = function (o, t) {
                    var n,
                        a,
                        r,
                        e = [];
                ...
                (n.prototype.removeBox = function (t) {
                    t = this.boxes.indexOf(t);
                    -1 < t && this.boxes.splice(t, 1);
                }),
                n));
    }.call(this);
