                ...
                a.waypoint(
                    function () {
                        for (
                            ...
                            var l = parseInt((o / e) * n);
                            if (
                                (s && (l = parseFloat((o / e) * n).toFixed(r)),
                                i)
                            )
                                for (; /(\d+)(\d{3})/.test(l.toString()); )
                                    l = l
                                        .toString()
                                        .replace(/(\d+)(\d{3})/, "$1,$2");
                            t.unshift(l);
                        ...
                        a.data("counterup-func", function () {
                            a.text(a.data("counterup-nums").shift()),
                            ...
                            setTimeout(a.data("counterup-func"), d.delay),
                            this.destroy();
                    },
                    { offset: "100%" }
                );
        ...
        (o.prototype.add = function (t) {
            ...
            (o.prototype.createThrottledResizeHandler = function () {
                ...
                this.adapter.on("resize.waypoints", function () {
                    e.didResize ||
                        ((e.didResize = !0), g.requestAnimationFrame(t));
                });
            }),
            ...
            (o.prototype.handleScroll = function () {
                ...
                for (t in i) {
                    ...
                    for (s in this.waypoints[t]) {
                        var l,
                            a,
                            d = this.waypoints[t][s];
                        null !== d.triggerPoint &&
                            ((l = r.oldScroll < d.triggerPoint),
                            (a = r.newScroll >= d.triggerPoint),
                            ((l && a) || (!l && !a)) &&
                                (d.queueTrigger(n), (o[d.group.id] = d.group)));
                    }
                }
                ...
                (t = {
                    ...
                    for (r in this.waypoints[e]) {
                        ...
                        a.element !== a.element.window &&
                            (u = a.adapter.offset()[n.offsetProp]),
                            "function" == typeof d
                                ? (d = d.apply(a))
                                : "string" == typeof d &&
                                  ((d = parseFloat(d)),
                                  -1 < a.options.offset.indexOf("%") &&
                                      (d = Math.ceil(
                                          (n.contextDimension * d) / 100
                                      ))),
                            (l = n.contextScroll - n.contextOffset),
                            (a.triggerPoint = Math.floor(u + l - d)),
                            (l = c < n.oldScroll),
                            (d = a.triggerPoint >= n.oldScroll),
                            (c = !l && !d),
                            !h && l && d
                                ? (a.queueTrigger(n.backward),
                                  (s[a.group.id] = a.group))
                                : ((!h && c) ||
                                      (h && n.oldScroll >= a.triggerPoint)) &&
    ...
    (function (f, s, t, p) {
        ...
        (d.prototype = {
            ...
            _defineElements: function () {
                this.element === t.body && (this.element = s),
                    ...
                    (this.$viewportElement =
                        this.options.viewportElement !== p
            ...
            _defineSetters: function () {
                var r = this,
                    t = l[r.options.scrollProperty],
                    n = a[r.options.positionProperty],
                    e = t.setLeft,
                    o = t.setTop;
                (this._setScrollLeft =
                    "function" == typeof e
                            ...
                            .each(function (t) {
                                ...
                                if (a.data("stellar-elementIsActive")) {
                                    if (
                                        ...
                                        return;
                                } else a.data("stellar-elementIsActive", this);
                                g.options.showElement(a),
                                    ...
                                    (i =
                                        ...
                                        p
                                            ...
                                            : g.horizontalOffset),
                                    (s =
                                        a.data("stellar-vertical-offset") !== p
                                    ...
                                    g.particles.push({
                                        ...
                                        parentOffsetTop: c,
                                        stellarRatio:
                                            a.data("stellar-ratio") !== p
                                                ? a.data("stellar-ratio")
                                                : 1,
                            ...
                            r.data("stellar-backgroundStartingLeft")
                                ...
                                r.parents().each(function () {
                                    ...
                                    if (!0 === t.data("stellar-offset-parent"))
                                        return (l = d), (a = c), (s = t), !1;
                                    (d += t.position().left),
                                        (c += t.position().top);
                                }),
                                (t =
                                    r.data("stellar-horizontal-offset") !== p
                                        ...
                                        : u.horizontalOffset),
                                (e =
                                    r.data("stellar-vertical-offset") !== p
                                        ? r.data("stellar-vertical-offset")
                                        : s !== p &&
                                ...
                                u.backgrounds.push({
                                    ...
                                    parentOffsetTop: a,
                                    stellarRatio:
                                        r.data("stellar-background-ratio") === p
                                            ? 1
                                            : r.data(
                ...
                if (
                    ...
                    for (
                        ...
                        (e = (t = this.particles[d]).isFixed ? 1 : 0),
                            (l = this.options.horizontalScrolling
                                ? (r =
                                      (c +
                                          t.horizontalOffset +
                    ...
                    for (d = this.backgrounds.length - 1; 0 <= d; d--)
                        (e = (o = this.backgrounds[d]).isFixed ? 0 : 1),
            ...
            (f.fn[i] = function (e) {
                var o = arguments;
                return e === p || "object" == typeof e
                    ? this.each(function () {
                          f.data(this, "plugin_" + i) ||
                              f.data(this, "plugin_" + i, new d(this, e));
                      })
            ...
            (f[i].scrollProperty = l),
            (f[i].positionProperty = a),
            (s.Stellar = d);
                    ...
                    var i,
                        ...
                        h = d.s.dynamic
                            ? (d.s.dynamicEl[e].poster &&
                                  ((c = !0), (s = d.s.dynamicEl[e].poster)),
                              (n = d.s.dynamicEl[e].html),
                              (l = d.s.dynamicEl[e].src),
                              (a = d.s.dynamicEl[e].alt),
                              d.s.dynamicEl[e].responsive &&
                                  u(d.s.dynamicEl[e].responsive.split(",")),
                              (r = d.s.dynamicEl[e].srcset),
                              d.s.dynamicEl[e].sizes)
                            : ((g = d.$items.eq(e)).attr("data-poster") &&
                                  ((c = !0), (s = g.attr("data-poster"))),
                              (n = g.attr("data-html")),
                              (l = g.attr("href") || g.attr("data-src")),
                              (a =
                                  g.attr("title") ||
                                  g.find("img").first().attr("alt")),
                              g.attr("data-responsive") &&
                                  u(g.attr("data-responsive").split(",")),
                              (r = g.attr("data-srcset")),
                              g.attr("data-sizes")),
                        u = !1;
                    d.s.dynamic
                        ? d.s.dynamicEl[e].iframe && (u = !0)
                        : "true" === d.$items.eq(e).attr("data-iframe") &&
                          (u = !0);
                    var g = d.isVideo(l, e);
                        ...
                        if (
                            (u
                                ...
                                ? (d.$slide
                                  ...
                                  d.$el.trigger("hasVideo.lg", [e, l, n]))
                                : ((a = a ? 'alt="' + a + '"' : ""),
                                  d.$slide
                                      .eq(e)
                                      .prepend(
                            ...
                            o && !f("body").hasClass("lg-from-hash") && (t = o),
                                setTimeout(function () {
                                    d.$slide.eq(e).addClass("lg-complete"),
                                        d.$el.trigger("onSlideItemLoad.lg", [
                                            e,
                                            o || 0,
                                        ]);
                                }, t);
                ...
                (e.prototype.slide = function (t, e, o, i) {
                    ...
                    (c.lGalleryOn && d === t) ||
                        ...
                        c.lgBusy ||
                            ...
                            this.$el.trigger("onBeforeSlide.lg", [d, t, e, o]),
                            (c.lgBusy = !0),
                            ...
                            e
                                ? (this.$slide.removeClass(
                                  ...
                                  2 < s
                                      ...
                                      : ((l = 0), (a = 1)),
                                  "prev" === i
                                      ? c.$slide.eq(a).addClass("lg-next-slide")
                                      : c.$slide
                                            .eq(l)
            ...
            (t.prototype.init = function () {
                    ...
                    if (
                        ...
                        s.core.$items.each(function (t) {
                            s.core.s.exThumbImage
                                ? e(
                                      l(this).attr("href") ||
                                          l(this).attr("data-src"),
                                      l(this).attr(s.core.s.exThumbImage),
                                      t
                                  )
                                : e(
                                      l(this).attr("href") ||
                                          l(this).attr("data-src"),
                                      l(this).find("img").attr("src"),
                                      t
                                  );
                        });
                ...
                (t.prototype.enableThumbDrag = function () {
                    ...
                    e.$thumbOuter.addClass("lg-grab"),
                        ...
                        l(window).on("mousemove.lg.thumb", function (t) {
                            s &&
                                ((n = e.left),
                                (r = !0),
                                (i = t.pageX),
                        ...
                        l(window).on("mouseup.lg.thumb", function () {
                            r
                                ? ((r = !1),
                ...
                (t.prototype.thumbkeyPress = function () {
                    var e = this;
                    l(window).on("keydown.lg.thumb", function (t) {
                        38 === t.keyCode
                            ? (t.preventDefault(),
                ...
                (l.fn.lightGallery.modules.Thumbnail = t);
        })();
    }),
    (function (t, e) {
        "function" == typeof define && define.amd
        ...
        !(function () {
            ...
            function t(t) {
                return (
                    (this.core = d(t).data("lightGallery")),
                    (this.$el = d(t)),
                            ...
                            ? ((a =
                              ...
                              this.core.s.youtubePlayerParams &&
                                  (a =
                                      a +
                                      "&" +
                                      d.param(this.core.s.youtubePlayerParams)),
                              (n =
                            ...
                            ? ((a = "?autoplay=" + l + "&api=1"),
                              this.core.s.vimeoPlayerParams &&
                                  (a =
                                      a +
                                      "&" +
                                      d.param(this.core.s.vimeoPlayerParams)),
                              (n =
                            ...
                            : i.vk &&
                              ...
                              this.core.s.vkPlayerParams &&
                                  (a =
                                      a +
                                      "&" +
                                      d.param(this.core.s.vkPlayerParams)),
                              (n =
    ...
    (function (t, e) {
        ...
        !(function () {
            ...
            (t.prototype.init = function () {
                ...
                function n() {
                    1 < l ? r.core.$outer.addClass("lg-zoomed") : r.resetZoom(),
                        l < 1 && (l = 1),
                        e(l);
                }
                function i(t, e, o, i) {
                            ...
                            s.core.$outer.hasClass("lg-zoomed") &&
                                ...
                                (o = d
                                    ? -Math.abs(e.attr("data-y")) +
                                      (n.y - r.y) * s.getModifier(c, "Y", i)
                                    : -Math.abs(e.attr("data-y"))),
                                (t = a
                                    ? -Math.abs(e.attr("data-x")) +
                                      (n.x - r.x) * s.getModifier(c, "X", i)
                                    : -Math.abs(e.attr("data-x"))),
                                (15 < Math.abs(n.x - r.x) ||
                                    15 < Math.abs(n.y - r.y)) &&
                ...
                (t.prototype.touchendZoom = function (t, e, o, i, s) {
                    var r = this,
                        ...
                        d =
                            ...
                            (e.x - t.x) * r.getModifier(s, "X", a),
                        a =
                            -Math.abs(n.attr("data-y")) +
                            (e.y - t.y) * r.getModifier(s, "Y", a),
                        s = r.getPossibleDragCords(l, Math.abs(s));
                    (15 < Math.abs(e.x - t.x) || 15 < Math.abs(e.y - t.y)) &&
                        ...
                        o
                            ? n.attr("data-x", Math.abs(d))
                            : (d = -Math.abs(n.attr("data-x"))),
                        r.core.s.useLeftForZoom
                            ? n.css({ left: d + "px", top: a + "px" })
                            : n.css(
                                  "transform",
                                  "translate3d(" + d + "px, " + a + "px, 0)"
                              ));
                }),
                (t.prototype.destroy = function () {
                    var t = this;
    ...
    (function (t) {
        ...
        function e(t) {
            var e,
                ...
                d = 0;
            if (
                (((t = c.event.fix(o)).type = "mousewheel"),
                ...
                1 === o.deltaMode
                    ...
                    : 2 === o.deltaMode &&
                      ...
                      (n *= e),
                      (r *= e));
                var l = Math.max(Math.abs(n), Math.abs(r));
                return (
                    (f && !(l < f)) || (h(o, (f = l)) && (f /= 40)),
                    h(o, l) && ((s /= 40), (r /= 40), (n /= 40)),
        ...
        if (c.event.fixHooks)
            for (var i = t.length; i; )
                c.event.fixHooks[t[--i]] = c.event.mouseHooks;
