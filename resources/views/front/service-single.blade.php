        ...
        <section>
            <div class="container">
                <div class="row">
                    ...
                    <!-- right side section -->
                    <div class="col-lg-12 order-1 order-lg-2 mb-1-9 mb-lg-0">
                        <div class="services-single-right">
                            <h4 class="mb-4 h3">@if(isset($services->heading)){{$services->heading}}@endif</h4>
                            <div class="mb-1-9 mb-lg-2-3"><img src="{{asset('front/img/content/services/service-single.jpg')}}" class="border-radius-5 box-shadow-primary" alt="..."></div>
                            <p class="w-95 mb-4">{!! html_entity_decode($services->content) !!}</p>
                            <div class="row">
                                <div class="col-12">
