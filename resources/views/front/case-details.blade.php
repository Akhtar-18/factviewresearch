                    ...
                    <div class="col-lg-12 pe-xl-1-9 mb-1-9 mb-lg-0">
                        <div class="posts">
                            <div class="post">
                                <div class="post-img">
                                    <a href="#!" class="w-100">
                                        <img src="{{asset('case-studies')}}/{{$case->image}}" alt="@if(isset($case->image_alt)){{$case->image_alt}}@endif">
                                    </a>
                                </div>
                                <div class="content">
                                    <div class="post-meta">
                                        ...
                                        <ul class="meta ps-0">
                                            ...
                                            <li>
                                                <a href="#!">
                                                    <i class="fas fa-calendar-alt" aria-hidden="true"></i> {{date('D M Y',strtotime($case->created_at))}}
                                                </a>
                                            </li>
                                            <!-- <li>
                                                <a href="#!">
