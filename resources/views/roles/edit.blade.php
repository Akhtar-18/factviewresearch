                            ...
                            <div class="card">
                                ...
                                <div id="collapseReportCategory" class="collapse" aria-labelledby="headingReportCategory" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12 float-left mb-2">
                                            <input type="checkbox"  name="permission[{{ $permission->name }}]" {{ in_array($permission->name, $rolePermissions) ? 'checked': '' }} value="{{ $permission->name }}" class='admin'> {{ $permission->name }}
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
                            ...
                            <div class="card">
                                ...
                                <div id="collapsPayment" class="collapse" aria-labelledby="headingPayment" data-parent="#accordionExample">
                                    <div class="card-body">
                                        ...
                                        <div class="col-xl-6 col-md-6 col-12 float-left mb-2">
                                            <input type="checkbox"  name="permission[{{ $permission->name }}]" value="{{ $permission->name }}" {{ in_array($permission->name, $rolePermissions) ? 'checked': '' }} class='admin'> {{ $permission->name }}
                                        </div>
                                        @endforeach
                                    </div>
                                </div>
