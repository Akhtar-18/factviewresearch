                                ...
                                <div class="card card-info card-tabs">
                                    ...
                                    <div class="tab-content" id="custom-tabs-one-tabContent">
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-one-summery-details" role="tabpanel" aria-labelledby="custom-tabs-one-summery-details-tab">
                                             <div class="col-12 mb-2">
                                                @if (count($report->getReportSummaryDetails) > 0)
                                                @foreach ($report->getReportSummaryDetails as $key => $summer_details)
                                                <div class="row" id="rowsummary_details{{ $key }}">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label class="mb-2">Heading<span class="text-danger"></span></label>
                                                            <input type="hidden" name="summery_id[]" class="form-control" id="summery_id{{ $key }}" value="{{ $summer_details->id }}">
                                                            <input type="text" name="summery_heading[]" class="form-control" value="{{ $summer_details->heading }}">
                                                    ...
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            ...
                                                            <textarea type="text" class="form-control" name="summery_details[]">{{ $summer_details->details }}</textarea>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-2 mt-3">
                                                        <a onclick="addmoresummarydetails()" class="btn btn-success mt-3" style="width: 70px;"><i class="fa fa-plus-circle"></i></a>
                                                        <a onclick="removesummarydetails('{{ $key }}','{{ $summer_details->id }}')" data-id="{{ $summer_details->id }}" class="btn btn-danger mt-3" style="width: 70px;">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-5">
                                                        <div class="form-group">
                                                            <label class="mb-2">Heading<span class="text-danger"></span></label>
                                                            <input type="hidden" name="summery_id[]" class="form-control" id="" value="">
                                        ...
                                        <div class="tab-pane fade" id="custom-tabs-one-segmentation" role="tabpanel" aria-labelledby="custom-tabs-one-segmentation-tab">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="segment" rows="12">
                                                    @if (isset($report->segment)){{ $report->segment }}@endif
                                                </textarea>
                                            ...
                                            <div class="col-12 mb-2">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control" name="customized" rows="12">
                                                        @if (isset($report->customized)){{ $report->customized }}@endif
                                                    </textarea>
...
<script>
    ...
    function addmoresummarydetails() {
        var new_item = '<div class="row" id="rowsummary_details' + loopCountSummary + '">\
            <div class="col-md-5">\
                <div class="form-group">\
                        <label class="mb-2">Heading<span class="text-danger"></span></label>\
                        <input type="hidden" name="summery_id[]" class="form-control" value="">\
            ...
            <div class="col-md-2 mt-3">\
                    <a onclick="addmoresummarydetails()" class="btn btn-success mt-3" style="width: 70px;"><i class="fa fa-plus-circle"></i></a>&nbsp;\
                    <a onclick="removesummarydetails(' + loopCountSummary + ')" class="btn btn-danger mt-3" style="width: 70px;"><i class="fa fa-trash"></i></a>\
            </div>\
        </div>';
        $('#rows_summery').append(new_item);
        loopCountSummary++;
        tinymce.init({
            selector: 'textarea',
            plugins: 'print preview paste importcss searchreplace autolink autosave save directionality code visualblocks visualchars advcode fullscreen image link media template codesample table charmap powerpaste hr pagebreak nonbreaking anchor toc insertdatetime advlist lists wordcount imagetools textpattern noneditable help charmap quickbars emoticons',
    ...
    function removesummarydetails(ids,id='') {
        if(id)
        {
            $.ajax({
            type: "POST",
            url: "{{ url('admin/reports/TblSummaryDetailsDelete') }}",
            data: {
                id: id,
            },
            success: function(data) {
