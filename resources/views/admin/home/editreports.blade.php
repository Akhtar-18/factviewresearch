    ...
    <div class="container-fluid">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-md-12">
                        <form action="{{ url('admin/reports/update') }}/{{ $report->id }}" method="POST"
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter heading"
                                            ...
                                            id="heading" onkeyup="getSlug()" required>
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Url" name="url"
                                            id="slug"
                                            value="@if (isset($report->url)) {{ $report->url }} @endif" required>
                                        @if ($errors->has('url'))
                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter Page" name="pages"
                                            value="@if (isset($report->pages)) {{ $report->pages }} @endif" required>
                                        @if ($errors->has('pages'))
...
@endif
                                ...
                                <div class="col-md-12">
                                    <hr class="bg-info">
                                    <p><b>FAQ Section</b> <a onclick="addmore()" class="btn btn-success btn-sm mt-3"><i
                                                class="fa fa-plus"></i></a></p>
                                    @foreach ($report->getReportFaq as $key => $list)
                                        <div class="row">
                                            <div class="col-md-5">
                                                <div class="form-group">
                                                    <label class="mb-2">Question<span
                                                            class="text-danger"></span></label>
                                                    <input type="hidden" name="faq_id[]"
                                                        value="@if (isset($list->id)) {{ $list->id }} @endif">
...
@endif
                                                    ...
                                                    @if ($errors->has('question[]'))
                                                        <span
                                                            class="text-danger">{{ $errors->first('question[]') }}</span>
                                                    @endif
                                                </div>
                                            </div>
                                            <div class="col-md-5">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="hidden" name="cagr_id"
                                                    value="@if (isset($report->getReportCAGR->id)) {{ $report->getReportCAGR->id }} @endif">
                                                <input type="text" class="form-control" name="cagr"
                                                    placeholder="CAGR"
                                                    value="@if (isset($report->getReportCAGR->cagr)) {{ $report->getReportCAGR->cagr }} @endif">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    @if (count($report->getReportRegiongraph) > 0)
                                        @foreach ($report->getReportRegiongraph as $keyse => $region)
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="mb-2">Region Name<span
                                                                class="text-danger"></span></label>
                                                        <input type="hidden" name="region_id[]"
                                                            value="@if (isset($region->id)) {{ $region->id }} @endif">
                                    ...
                                    @if (count($report->getReportmarketsharegraph) > 0)
                                        @foreach ($report->getReportmarketsharegraph as $keyss => $res)
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <input type="hidden" name="marketshare_id[]"
                                                            value="@if (isset($res->id)) {{ $res->id }} @endif">
                                                        <label class="mb-2">Market<span
                                                                class="text-danger"></span></label>
                                                        <input type="text" class="form-control"
                                                            name="marketsharename[]" placeholder="Market"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label class="mb-2">Percentage<span
                                                                class="text-danger"></span></label>
                                                        <input type="text" class="form-control"
                                                            name="marketsharevalue[]" placeholder="Percentage"
