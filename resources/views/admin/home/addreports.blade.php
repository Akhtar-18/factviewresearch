                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="customized">{{ old('customized') }}</textarea>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="toc">{{ old('toc') }}</textarea>
                                @if ($errors->has('toc'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="segment">{{ old('segment') }}</textarea>
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <textarea class="form-control"  name="methodology">{{ old('methodology') }}</textarea>
                            ...
                            <br>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="cagr" placeholder="cagr" required>
                                    </div>
                                </div>
                            </div>
