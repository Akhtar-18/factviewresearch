...
class WhyChooseUsController extends Controller
{
  function __construct()
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
              ...
              ->addColumn('action', function($row){
                ...
                {
                  $editbtn='<a  href="'.url('admin/whychoose/edit/'.$row->id).'" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>';
                }
                else
                {
                  $editbtn='';
        ...
        aria-hidden="true">
        <form action="'.url('admin/whychoose/delete/').'/'.$row->id.'" method="post">
