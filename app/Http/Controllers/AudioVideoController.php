        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
              ...
              ->addColumn('action', function($row){
                  ...
                  $editbtn='<a  href="'.secure_url('admin/audio-video/edit/'.$row->id).'" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>';
                ...
                $btn = $editbtn.'|'.$deletebtn.'
                    ...
                    aria-hidden="true">
                    <form action="'.secure_url('admin/audio-video/delete/').'/'.$row->id.'" method="post">
