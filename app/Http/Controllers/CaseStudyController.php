        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
              ...
              ->addColumn('action', function($row){
                  ...
                  $editbtn='<a  href="'.secure_url('admin/admin-case-studies/edit/'.$row->id).'" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>';
                ...
                $btn = $editbtn.'|'.$deletebtn.'
                                ...
                                aria-hidden="true">
                                <form action="'.secure_url('admin/admin-case-studies/delete/').'/'.$row->id.'" method="post">
