...
class PressReleaseController extends Controller
{
    ...
    public function list(Request $request)
    {
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
              ...
              ->addColumn('action', function($row){
                  ...
                  $editbtn='<a  href="'.secure_url('admin/admin-press-releases/edit/'.$row->id).'" class="btn btn-info btn-sm"><i class="fa fa-edit"></i></a>';
        ...
        aria-hidden="true">
        <form action="'.secure_url('admin/admin-press-releases/delete/').'/'.$row->id.'" method="post">
