...
if (!function_exists('getSementGraph')) {
    function getSementGraph($segment_id)
    {
        $Segment = SegmentGraphicalModel::where('segment_types', $segment_id)->select(['segmentname', 'segmentvalue'])->get();
        return $Segment;
    }
}
